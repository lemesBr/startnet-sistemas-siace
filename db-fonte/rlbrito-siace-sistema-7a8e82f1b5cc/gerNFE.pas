...
uses
  ...
  IBQuery, CurrEdit, DBGrids, Math, uADStanIntf, uADStanOption,
  uADStanParam, uADStanError, uADDatSManager, uADPhysIntf, uADDAptIntf,
  uADStanAsync, uADDAptManager, uADCompDataSet, uADCompClient, RXCtrls,
  frxClass;
