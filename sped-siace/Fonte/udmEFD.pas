...
uses
  ...
  FireDAC.VCLUI.Error, FireDAC.VCLUI.Login, FireDAC.VCLUI.Async, IniFiles;
...
function TdmEFD.LeIni(sArqIni : string; sSecao : string; sVariavel : string) : string;
var ArqIni  : tIniFile;
    sString : string;
begin
...
VAR
Arquivo1: TIniFile{uses IniFiles};
begin
...
begin
  ...
  //  try
   ...
   {  Conexao.Connected := false;
     ...
     ShowMessage('ABRIU');
     Arquivo1:= TIniFile.Create(ExtractFilePath(Application.ExeName)+'siace.ini');
