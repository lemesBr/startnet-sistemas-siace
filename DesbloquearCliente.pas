...
type
  TFormDesbloquearCliente = class(TForm)
    ...
    qrClienteREMUNERACAO: TFMTBCDField;
    qrClienteVALOR_ALUGUEL: TFMTBCDField;
    qrClienteRENDA_CONJUGUE: TFMTBCDField;
    qrClienteLIMITE_DE_CREDITO: TFMTBCDField;
    qrClienteIE: TStringField;
    qrClientePARENTESCO_AUT1: TStringField;
    qrClientePARENTESCO_AUT2: TStringField;
    qrClientePARENTESCO_AUT3: TStringField;
    qrClientePOSSUE_LAUDO: TStringField;
    qrClienteVENCIMENTO_LAUDO: TDateField;
    qrClienteCAPITALSOCIAL: TFMTBCDField;
    qrClienteFATURAMENTOBRUTO: TFMTBCDField;
    qrClienteFUNC_SALARIO: TFMTBCDField;
