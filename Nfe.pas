...
begin
  ...
  with DM.ACBrNFe1.NotasFiscais.Add.NFe do
   begin
     ...
     Ide.cNF       := GerarCodigoDFe(DM.SDS_NFENr_nota.Value); // StrToInt(NumNFe); //Caso não seja preenchido será gerado um número aleatório pelo componente
    ...
    // Exemplo de pagamento integrado.
     ...
     Ide.verProc   := 'SIACE SISTEMAS 4.0'; //Versão do seu sistema
