object DMR: TDMR
  ...
  object RvRelatorios: TRvProject
    Engine = RvSystem1
    ProjectFile = 'C:\StartNet_Sistemas\Relatorios.rav'
    Left = 56
    Top = 1
  end
  ...
  object Rv_Parc_Venda: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = DMC.QRY_COND_PAGTO
    Left = 744
    Top = 424
  end
  object RvSaldoAnt: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = DMC2.CDS_SALDO_ANT
    Left = 760
    Top = 488
  end
  object RvSaldoAntcc: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = DMC2.cds_saldo_ant_cc
    Left = 648
    Top = 512
  end
end
