object DMC3: TDMC3
  ...
  object QryRelVendas_pedidos: TSQLQuery
    ...
    object QryRelVendas_pedidosCELULAR: TStringField
      FieldName = 'CELULAR'
      Size = 15
    end
    object QryRelVendas_pedidosPROD_RURAL: TStringField
      FieldName = 'PROD_RURAL'
      Size = 1
    end
    object QryRelVendas_pedidosIE_PRODUTOR: TStringField
      FieldName = 'IE_PRODUTOR'
      FixedChar = True
      Size = 15
    end
    object QryRelVendas_pedidosVLR_PIS: TFMTBCDField
      FieldName = 'VLR_PIS'
      Precision = 15
      Size = 2
    end
    object QryRelVendas_pedidosVLR_COFINS: TFMTBCDField
      FieldName = 'VLR_COFINS'
      Precision = 15
      Size = 2
    end
    object QryRelVendas_pedidosKM: TIntegerField
      FieldName = 'KM'
    end
    object QryRelVendas_pedidosCHAVE_FP: TStringField
      FieldName = 'CHAVE_FP'
      Size = 100
    end
    object QryRelVendas_pedidosCHAVE_FP_CANCEL: TStringField
      FieldName = 'CHAVE_FP_CANCEL'
      Size = 30
    end
    object QryRelVendas_pedidosCUPON_CANCELADO: TStringField
      FieldName = 'CUPON_CANCELADO'
      Size = 1
    end
    object QryRelVendas_pedidosCRZ: TIntegerField
      FieldName = 'CRZ'
    end
  end
  ...
  object Cds_RelVendas_pedidos: TClientDataSet
    ...
    object Cds_RelVendas_pedidosCELULAR: TStringField
      FieldName = 'CELULAR'
      Size = 15
    end
    object Cds_RelVendas_pedidosPROD_RURAL: TStringField
      FieldName = 'PROD_RURAL'
      Size = 1
    end
    object Cds_RelVendas_pedidosIE_PRODUTOR: TStringField
      FieldName = 'IE_PRODUTOR'
      FixedChar = True
      Size = 15
    end
    object Cds_RelVendas_pedidosVLR_PIS: TFMTBCDField
      FieldName = 'VLR_PIS'
      Precision = 15
      Size = 2
    end
    object Cds_RelVendas_pedidosVLR_COFINS: TFMTBCDField
      FieldName = 'VLR_COFINS'
      Precision = 15
      Size = 2
    end
    object Cds_RelVendas_pedidosKM: TIntegerField
      FieldName = 'KM'
    end
    object Cds_RelVendas_pedidosCHAVE_FP: TStringField
      FieldName = 'CHAVE_FP'
      Size = 100
    end
    object Cds_RelVendas_pedidosCHAVE_FP_CANCEL: TStringField
      FieldName = 'CHAVE_FP_CANCEL'
      Size = 30
    end
    object Cds_RelVendas_pedidosCUPON_CANCELADO: TStringField
      FieldName = 'CUPON_CANCELADO'
      Size = 1
    end
    object Cds_RelVendas_pedidosCRZ: TIntegerField
      FieldName = 'CRZ'
    end
  end
  ...
  object Sds_RelVendas_Itens: TSimpleDataSet
    ...
    object Sds_RelVendas_ItensIMPRIME: TStringField
      FieldName = 'IMPRIME'
      Size = 3
    end
    object Sds_RelVendas_ItensCOD_EMPRESA: TIntegerField
      FieldName = 'COD_EMPRESA'
      Required = True
    end
  end
  object qry_relVendas_produtos: TSQLQuery
    ...
    object qry_relVendas_produtosCODIGO_GRUPO: TIntegerField
