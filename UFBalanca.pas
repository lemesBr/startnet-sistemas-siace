...
uses
  ...
  Dialogs, acPNG, ExtCtrls, StdCtrls, sLabel, ACBrBase, ACBrBAL, jpeg;
...
type
  ...
  // procedure BalancaLePeso1(Peso: Double; Resposta: AnsiString);
...
//procedure TfrmBalanca.BalancaLePeso1(Peso: Double; Resposta: AnsiString);
procedure TfrmBalanca.BalancaLePeso(Peso: Double; Resposta: String);
var
  valid : integer;
begin
...
begin
  ...
  // Balanca.Device.Porta     := 'COM1' //+ IntToStr( iPorta );
