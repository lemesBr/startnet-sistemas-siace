...
uses
  ...
  Dialogs, ComCtrls, ExtCtrls, Grids, DBGrids, DB, StdCtrls, Buttons,
  AlignEdit, IBCustomDataSet, IBQuery, Mask,
  rxToolEdit, rxCurrEdit, UNovosComponentes, UNovoFormulario, ToolEdit,
  CurrEdit;
...
type
  TFrmConsValesFuncionario = class(UNovoFormulario.TForm)
    ...
    QConsVALOR_VALE: TIBBCDField;
    QConsAUTORIZADO_VALE: TIBStringField;
    QConsNOME_FUN: TIBStringField;
    Label1: TLabel;
...
uses UConsFunc, Udm, Ubibli1, UCadVales, UComercioSuper;
...
begin 
   if QConsDATA_PAGTO.IsNull then
      ...
      begin 
         showmessage('Vale pago, não pode ser alterado');
      end;
end;
