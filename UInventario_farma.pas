...
type
  TFormInventario_farma = class(TForm)
...
var
  FormInventario_farma: TFormInventario_farma;
...
procedure TFormInventario_farma.RLReport1PageStarting(Sender: TObject);
begin
if Tag = 0 then
begin
