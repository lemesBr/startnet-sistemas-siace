...
uses
  ...
  StdCtrls, SUIEdit, RXCtrls, DBCtrls, Mask, DB,
  DBClient, SimpleDS, XDBCtrls, sLabel;
...
IF ACHOU=FALSE THEN
ACHOU:=dm.Sds_produtos.Locate('PROCURA',EDIT1.Text,[]);
...
begin
 dm.Sds_produtos.Locate('PROCURA',EDIT1.Text,[loPartialKey, loCaseInsensitive]);
end else
if cbxpesquisa.ItemIndex = 0 then
begin
