...
uses
  ...
  Dialogs, ExtCtrls, Grids, XDBGrids, StdCtrls, SUIButton,
  FMTBcd, DB, SqlExpr, Mask,  rxToolEdit, DBCtrls, sMaskEdit,
...
uses Principal, ModulodeDados, Udmcob, Titulos, OnGuard, OgUtil,
  ModulodeDadosConsultas, ModuleDados1, ContaBancaria;
