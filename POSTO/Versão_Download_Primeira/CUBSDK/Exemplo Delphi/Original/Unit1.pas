...
var
    i : integer;
begin
    // Exemplo valido para tres posiçoes de abastecimento
    // de cuatro bicos de cada lado.
    CUBAbrirBomba( 1 );
    CUBAbrirBomba( 2 );
    CUBAbrirBomba( 3 );
    if CUBMapearProduto( 1, 1, 1) <> 0 then
    begin
       Application.MessageBox('Nao foi possível conectar com o CUB server.', 'Fechando o programa...', MB_OK );
       Application.Terminate;
    end;
    CUBMapearProduto( 1, 2, 2);
    CUBMapearProduto( 1, 3, 3);
    CUBMapearProduto( 1, 4, 4);
    CUBMapearProduto( 2, 1, 5);
    CUBMapearProduto( 2, 2, 6);
    CUBMapearProduto( 2, 3, 7);
    CUBMapearProduto( 2, 4, 8);
    CUBMapearProduto( 3, 1, 9);
    CUBMapearProduto( 3, 2, 10);
    CUBMapearProduto( 3, 3, 11);
    CUBMapearProduto( 3, 4, 12);
    // Programar o preço dos oitos produtos
    // Neste caso estou utilizando o codigo de produto para
    // codificar o numero do bico.
    // No Brasil só tem 1 preço ativo por bomba, nao usa-se
    // o kit de duplo preço. Entao o NivelDePreco deve ser
    // sempre 1.
    CUBProgramarPreco( 1, 1, 1111 );
    CUBProgramarPreco( 2, 1, 2222 );
    CUBProgramarPreco( 3, 1, 3333 );
    CUBProgramarPreco( 4, 1, 4444 );
    CUBProgramarPreco( 5, 1, 5555 );
    CUBProgramarPreco( 6, 1, 6666 );
    CUBProgramarPreco( 7, 1, 7777 );
    CUBProgramarPreco( 8, 1, 8888 );
    CUBProgramarPreco( 9, 1, 9999 );
    CUBProgramarPreco( 10, 1, 1234 );
    CUBProgramarPreco( 11, 1, 5678 );
    CUBProgramarPreco( 12, 1, 3579 );
