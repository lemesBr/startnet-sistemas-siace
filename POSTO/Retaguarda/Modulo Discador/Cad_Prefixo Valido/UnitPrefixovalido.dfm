object PrefixoValidoCadFrm: TPrefixoValidoCadFrm
  Left = 187
  Top = 120
  Width = 460
  Height = 430
  Caption = 'Cadastro :: Prefixo V'#225'lido'
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Height = 236
    Align = alClient
    DataSource = DtsDstPrefixoValido
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'MS Sans Serif'
    ...
    Columns = <
      item
        Expanded = False
        FieldName = 'PREFIXO'
        Title.Caption = 'Prefixos V'#225'lidos'
        Width = 432
        Visible = True
      end>
  end
  ...
  object DtsDstPrefixoValido: TDataSource
    DataSet = DM1.DstPrefixoValido
    Left = 48
    Top = 152
  end
  ...
  object FormStorage1: TFormStorage
    IniSection = 'PrefixoValidoCadFrm'
    Options = []
    StoredProps.Strings = (
      'GroupBox1.Caption'
      'Label2.Caption'
