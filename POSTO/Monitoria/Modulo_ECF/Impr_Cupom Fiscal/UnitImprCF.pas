...
begin
 ...
 label9.caption  := 'R$ ' + formatcurr('###,##0.000', CUB.Bomba[id_Bomba_Default - 1].Preco_UltimaVenda/1000);
 label10.caption := 'R$ ' + formatcurr('###,##0.00',  CUB.Bomba[id_Bomba_Default - 1].Mililitros_UltimaVenda/1000);
 label11.caption := 'R$ ' + formatcurr('###,##0.00',  CUB.Bomba[id_Bomba_Default - 1].Dinheiro_UltimaVenda/100);
end;
