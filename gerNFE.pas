...
type
  TFormGefaNFe = class(TForm)
    ...
    QBuscaItens1VALOR_DESC: TFMTBCDField;
    QBuscaItens1TOTAL_ITEM: TFMTBCDField;
    QBuscaItens1DATA: TDateField;
    QBuscaItens1BASE_ICMS: TFMTBCDField;
    QBuscaItens1VALOR_ICMS: TFMTBCDField;
    QBuscaItens1VALOR_IPI: TFMTBCDField;
    QBuscaItens1PERC_ICMS: TFMTBCDField;
    QBuscaItens1PERC_IPI: TFMTBCDField;
    QBuscaItens1PRECO_VENDA: TFMTBCDField;
    QBuscaItens1PRECO_VENDA2: TFMTBCDField;
    ...
    QBuscaItens1MARG_LUCRO: TFMTBCDField;
    QBuscaItens1ATIVO: TStringField;
    QBuscaItens1BASE_ICMS_ST: TFMTBCDField;
    QBuscaItens1ALIC_ICMS_ST: TFMTBCDField;
    QBuscaItens1VALOR_ICMS_ST: TFMTBCDField;
    ...
    QBuscaItens1SUBTOTAL: TFMTBCDField;
    QBuscaItens1DESCONTO_P: TFMTBCDField;
    QBuscaItens1ICMS_REDUCAO: TFMTBCDField;
    QBuscaItens1ICMS_VALORRETIDO: TFMTBCDField;
    QBuscaItens1ICMS_ISENTO: TFMTBCDField;
    QBuscaItens1ICMS_NAOTRIBUTADO: TFMTBCDField;
    QBuscaItens1IPI_TIPO: TStringField;
    QBuscaItens1TIPO: TIntegerField;
    QBuscaItens1FRETE: TFMTBCDField;
    QBuscaItens1OUTRAS: TFMTBCDField;
    QBuscaItens1SEGURO: TFMTBCDField;
    QBuscaItens1CLASSIFICACAO_FISCAL: TStringField;
    QBuscaItens1SUB_PRODUTOS: TFMTBCDField;
    QBuscaItens1ITEM_ESPECIAL_VALOR: TFMTBCDField;
    QBuscaItens1ICMS_OUTRAS: TFMTBCDField;
    QBuscaItens1ALTERA_ITEM: TIntegerField;
    QBuscaItens1CREDITO_ICMS: TFMTBCDField;
    QBuscaItens1CREDITO_ICMS_BASE: TFMTBCDField;
    QBuscaItens1PMARGEM: TSingleField;
    QBuscaItens1PRECO_CUSTO: TFMTBCDField;
    ...
    QBuscaItens1PERC_ICMS_ESTADUAL: TFMTBCDField;
    QBuscaItens1PERC_ICMS_INTER_ESTADUAL: TFMTBCDField;
    ...
    QBuscaItens1ALIC_ESTADUAL: TFMTBCDField;
    ...
    QBuscaItens1PESOBRUTO: TFMTBCDField;
    QBuscaItens1PESOLIQUIDO: TFMTBCDField;
    ...
    QBuscaItensCFOP_REV_EST: TStringField;
    QBuscaItensCFOP_REV_INTER: TStringField;
    QBuscaItensCFOP_EST_TRANSF: TStringField;
    QBuscaItensCFOP_INTER_EST_TRASNF: TStringField;
    ...
    QBuscaItensALIC_ESTADUAL: TFMTBCDField;
    ...
    QBuscaItensDESC_PROD_ANP: TStringField;
...
DM.sds_vendas.SQL.add('select * from pedidos where codigo =:venda');
DM.sds_vendas.parambyname('venda').text :=  formvendas.N_venda.Text;
DM.sds_vendas.open;
...
dm.SDS_NFECD_EMPRESA.asinteger       :=  iemp;
...
dm.sds_nfe_itens.Edit;
 ...
 begin
       IF QBuscaItensPROD_SERV.Text = 'S' then
        begin
          removeservico := True;
        end;
    ...
    BEGIN
      ...
      dm.sds_nfe_itensNR_SEQUENCIA.AsInteger       := NItem;
      ...
      dm.sds_nfe_itensVL_OUTROS.asfloat            := DM.sds_vendas_itensENC_FINANCEIRO.asfloat;
      ...
      dm.sds_nfe_itensVL_TOTAL.AsFloat             := DM.sds_vendas_itensPRECO_TOTAL.AsFloat;
      ...
      DM.sds_nfe_itensCFOP.Text                    := QBuscaItensCFOP_EST_VENDA.Text;
       ...
       if RxDBComboEdit2.Text = '5667' then
       begin
      DM.sds_nfe_itensCFOP.Text                    :=   '5667' ;
       end;
      ...
      dm.sds_nfe_itensVL_BASE_PIS.AsFloat            := DM.sds_vendas_itensPRECO_TOTAL.asfloat;
      dm.sds_nfe_itensVL_BASE_COFINS.AsFloat         := DM.sds_vendas_itensPRECO_TOTAL.asfloat;
...
DM.sds_nfeVl_total.AsFloat            :=  CurrencyEdit4.Value  - CurrencyEdit5.Value + CurrencyEdit1.value + CurrencyEdit2.value + CurrencyEdit3.value + icm_st + IPI + dm.sds_vendasENC_FINANCEIRO.asfloat;
...
if SDS_NFE1.Locate('N_NOTA_ENTRADA',dm.SDS_NotasFiscaisNUM_NOTA.Text, [loCaseInsensitive]) = True then
 BEGIN
  if Application.MESSAGEBOX('Já existe uma NF-E cadastrada com esta Venda !, Deseja substitui-la?', 'Confirmar', MB_ICONQUESTION + MB_YESNO + MB_DEFBUTTON1) = ID_YES then
 begin
  sds_nfe1.delete;
...
For E:=1 to Contador do
 begin
    with QBuscaItens1 do
      begin
         close;
         Parambyname('Cod_NOTA').AsInteger:= strtoint(dm.SDS_NotasFiscaisCODIGO_NOTA.text);
         Parambyname('codpro').AsInteger:= strtoint(dm.SDS_NotasFiscaisItensCODIGO_PRODUTO.Text);
         open;
         Last;
      end;
dm.sds_nfe_itens.Insert;
...
dm.sds_nfe_itenscd_atualizacao.text          := DM.SDS_NotasFiscaisItensCODIGO_NOTA.TEXT;
        ...
        BEGIN
        DM.sds_nfe_itensCOD_NCM.Text                 := QBuscaItens1NCM_SH.Text;
        end else
        IF QBuscaItens1NCM_SH_1.Text > '' THEN
        begin
        DM.sds_nfe_itensCOD_NCM.Text                 := QBuscaItens1NCM_SH_1.Text;
        end;
 DM.sds_nfe_itensCEST.Text   := QBuscaItens1cest.Text;
...
var
 ...
 // qrSQL: TFDQuery;
begin
        if ecompra = true then
        begin
        combobox2.itemIndex := 1;
        combobox2.Enabled := False;
        end;

  if ComboBox2.ItemIndex = 0 or 2 then
  begin
  ...
  if DM.SDS_CONFIGURACOESCFOP_CUPON.text > '' then
  begin
   RxDBComboEdit2.text :=DM.sds_configuracoescfop_cupon.text;
   RxDBComboEdit2Exit(Sender);
  end;
    DM.qrcfop.Active := true;
      if DM.SDS_EMPRESAREGIME.AsString = 'S' then
  begin
  ...
  DM.qConsulta.SQL.Text :=
    'SELECT CONSUMO_INTERNO FROM CLIENTES WHERE CODIGO=:CLI';
  DM.qConsulta.Params[0].Value := iCodigoCli;
  dM.qConsulta.Open;

  if dM.qConsulta.FieldByName('CONSUMO_INTERNO').text = 'T' then
  begin
    RxDBComboEdit2.Text :='5667';
    RxDBComboEdit2Exit(sender);
  end;
  end;
  ...
  begin
    ...
    with DM.ACBrNFe1.NotasFiscais.Items[n].NFe do
     ...
     // edit7.Text := procNFe.chNFe;
      edit7.Text := Copy(infNFe.ID,4,44);
     end;
    end;
end;
end;
