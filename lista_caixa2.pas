...
uses
  ...
  Buttons, DB, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param,
  FireDAC.Stan.Error, FireDAC.DatS, FireDAC.Phys.Intf, FireDAC.DApt.Intf,
  FireDAC.Stan.Async, FireDAC.DApt, IBX.IBCustomDataSet, FireDAC.Comp.DataSet,
  FireDAC.Comp.Client, frxDesgn, frxClass, frxDBSet, RxToolEdit, AdvGlowButton;
...
type
  Tfrmlista_caixa2 = class(TForm)
    ...
    qrcaixaSTATUS: TIntegerField;
    qrcaixaCOD_FECHAMENTO: TIntegerField;
  ...
  begin
   ...
   begin
     ...
     // qrcaixa.Params.ParamByName('tp').AsString := 'C';
      ...
      fxcAIXA.LoadFromFile('rel\RelatorioDeResumosPorPeriodo.fr3');
