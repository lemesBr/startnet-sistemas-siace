...
uses
  ...
  StdCtrls, Mask, SUIButton, SUIDlg, FMTBcd, DB,
  DBClient, Provider, SqlExpr, Menus, DBCtrls, Buttons,
  TaskDialog, RxCurrEdit, RxToolEdit, AdvGlowButton;
...
begin
    ...
    DMC2.QRY_SALDO_ANT_CX.Active:=False;
    DMC2.CDS_SALDO_A_CX.Active:=False;
    DMC2.QRY_SALDO_ANT_CX.Params[0].AsDate:=DateEdit1.Date;
    DMC2.QRY_SALDO_ANT_CX.Active:=True;
    DMC2.cds_saldo_a_cx.Active:=True;


SALDO1 := DMC2.cds_saldo_a_cxENTRADA.asfloat - DMC2.CDS_SALDO_A_CXSAIDA.asfloat;
...
CurrencyEdit10.VALUE := (CurrencyEdit7.VALUE + CurrencyEdit11.Value + CurrencyEdit8.VALUE + CurrencyEdit12.VALUE +  CurrencyEdit9.VALUE + CurrencyEdit2.VALUE - CurrencyEdit14.value);
