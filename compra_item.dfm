object frmcompra_item: Tfrmcompra_item
  ...
  object Panel1: TPanel
    ...
    object Label19: TLabel
      ...
      Height = 13
      Alignment = taCenter
      Caption = 'F5 | C'#243'd. do Fornecedor'
      Font.Charset = ANSI_CHARSET
      Font.Color = clInfoText
      Font.Height = -11
      Font.Name = 'Tahoma'
  ...
  object Button1: TButton
    ...
    Width = 105
    Height = 25
    Caption = 'atualiza valor na nota'
    TabOrder = 46
    Visible = False
    OnClick = Button1Click
  end
  object eunitario: TRxDBCalcEdit
    Left = 183
    Top = 203
    Width = 110
    Height = 21
  ...
  object qrgrade_entrada: TFDQuery
    ...
    Left = 392
    Top = 88
    object qrgrade_entradaCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
    end
    object qrgrade_entradaCODPRODUTO: TIntegerField
      FieldName = 'CODPRODUTO'
      Origin = 'CODPRODUTO'
    end
    object qrgrade_entradaLOTE: TStringField
      FieldName = 'LOTE'
      Origin = 'LOTE'
      Size = 30
    end
    object qrgrade_entradaCODCLIENTE: TIntegerField
    ...
    object qrgrade_entradaCLIENTE: TStringField
      FieldName = 'CLIENTE'
      Origin = 'CLIENTE'
      Size = 80
    end
    object qrgrade_entradaCODNOTA: TIntegerField
      FieldName = 'CODNOTA'
      Origin = 'CODNOTA'
    end
    object qrgrade_entradaCODITEM: TIntegerField
      FieldName = 'CODITEM'
      Origin = 'CODITEM'
    end
    ...
    object qrgrade_entradaNUMERONOTA: TStringField
      FieldName = 'NUMERONOTA'
      Origin = 'NUMERONOTA'
      Size = 15
    end
    object qrgrade_entradaCODFORNECEDOR: TIntegerField
      FieldName = 'CODFORNECEDOR'
      Origin = 'CODFORNECEDOR'
    end
    object qrgrade_entradaCODVENDA_ITEM: TIntegerField
    ...
    object qrgrade_entradaCODVENDA: TIntegerField
      FieldName = 'CODVENDA'
      Origin = 'CODVENDA'
    end
    object qrgrade_entradaESTOQUE: TFMTBCDField
      FieldName = 'ESTOQUE'
      Origin = 'ESTOQUE'
      Precision = 18
      Size = 2
    end
    object qrgrade_entradaPRECOCUSTO: TFMTBCDField
      FieldName = 'PRECOCUSTO'
      Origin = 'PRECOCUSTO'
      Precision = 18
      Size = 2
    end
    object qrgrade_entradaPRECOVENDA: TFMTBCDField
  ...
  object qrfiscal_cst: TFDQuery
    Connection = DM.Coneccao
    Left = 308
    Top = 88
  end
  object Qtributacao: TFDQuery
    Connection = DM.Coneccao
    SQL.Strings = (
      
        'select produtos.codigo, produtos.codigo_barras, grupo_tributacao' +
        '.* from produtos, grupo_tributacao where produtos.grupo_tributac' +
        'ao = grupo_tributacao.cod_grupo ;')
    Left = 240
    Top = 88
    ...
    object QtributacaoCODIGO_BARRAS: TStringField
    ...
    object QtributacaoCOD_GRUPO: TIntegerField
    ...
    object QtributacaoDESCRICAO: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'DESCRICAO'
      Origin = 'DESCRICAO'
      ProviderFlags = []
    ...
    object QtributacaoFLAG_SUBSTITUICAO_TRIB: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoPERC_SUBST_TRIBUTARIA: TFMTBCDField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoFLAG_SERVICO: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoPERC_ALIQUOTA_ISS: TFMTBCDField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoFLAG_FABRICACAO_PROPRIA: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoPERC_ALIQUOTA_IPI: TFMTBCDField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoFLAG_PIS_COFINS: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoPERC_ALIQUOTA_PIS: TFMTBCDField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoPERC_ALIQUOTA_COFINS: TFMTBCDField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoFLAG_ICMSGARANTIDO_INTEGRAL: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoPERC_ICMS_GARANTIDO_INTEGRAL: TFMTBCDField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCFOP_ESTADUAL_DEV: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCFOP_INTERESTADUAL_DEV: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCFOP_EST_COMPRA: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCFOP_INTER_COMPRA: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCFOP_EST_VENDA: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCFOP_INTER_VENDA: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCFOP_EST_TRANSF: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCFOP_INTER_EST_TRASNF: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCST_VENDA: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'CST_VENDA'
      Origin = 'CST_VENDA'
      ProviderFlags = []
    ...
    object QtributacaoCST_COMPRA: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoFLAG_ICMS: TStringField
      AutoGenerateValue = arDefault
      FieldName = 'FLAG_ICMS'
      Origin = 'FLAG_ICMS'
      ProviderFlags = []
    ...
    object QtributacaoPERC_ICMS_ESTADUAL: TFMTBCDField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoPERC_ICMS_INTER_ESTADUAL: TFMTBCDField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoSIT_PIS_VENDA_EST: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoSIT_COFINS_VENDA_EST: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoSIT_PIS_VENDA_INTER_EST: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoSIT_COFINS_VENDA_INTER_EST: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoSIT_PIS_COMPRA: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoSIT_COFINS_COMPRA: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCST_VENDA_INTER: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCST_COMPRA_INTER: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoPERC_RED_ICMS: TFMTBCDField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCST_IPI_ENTRADA: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCST_IPI_SAIDA: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCFOP_REV_EST: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCFOP_REV_INTER: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoPERC_LUCRO_ST: TFMTBCDField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCST_VENDA_NFCE: TStringField
      AutoGenerateValue = arDefault
    ...
    object QtributacaoCST_VENDA_INTER_NFCE: TSmallintField
      AutoGenerateValue = arDefault
