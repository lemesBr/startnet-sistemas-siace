object FNCM: TFNCM
      ...
      object Grid: TDBGrid
        ...
        Columns = <
          ...
          item
            Expanded = False
            FieldName = 'NUMEROATO'
            Title.Caption = 'Num. Ato'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'ANOATO'
            Title.Caption = 'Ano do Ato'
            Visible = True
          end>
      end
  ...
  object qrNCM: TFDQuery
    ...
    object qrNCMDATAINICIO: TDateField
      FieldName = 'DATAINICIO'
      Origin = 'DATAINICIO'
    end
    object qrNCMDATAFIM: TDateField
      FieldName = 'DATAFIM'
      Origin = 'DATAFIM'
    end
    object qrNCMTIPOATO: TStringField
      FieldName = 'TIPOATO'
      Origin = 'TIPOATO'
      Size = 50
    end
    object qrNCMNUMEROATO: TStringField
      FieldName = 'NUMEROATO'
      Origin = 'NUMEROATO'
      Size = 10
    end
    object qrNCMANOATO: TIntegerField
      FieldName = 'ANOATO'
    end
    ...
    object qrNCMALIC_NAC: TFMTBCDField
      FieldName = 'ALIC_NAC'
      Origin = 'ALIC_NAC'
      Precision = 18
      Size = 2
    end
    object qrNCMALIC_IMP: TFMTBCDField
      FieldName = 'ALIC_IMP'
      Origin = 'ALIC_IMP'
      Precision = 18
      Size = 2
    end
    object qrNCMALIC_ESTADUAL: TFMTBCDField
