object FormEtiquetas: TFormEtiquetas
  Left = 371
  Top = 170
  Caption = 'Gera'#231#227'o e Emiss'#227'o de Etiquetas para impressora Zebra/Bematech'
  ClientHeight = 416
  ClientWidth = 675
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    object myLabel3d1: TsLabelFX
      ...
      Width = 582
      Height = 33
      Caption = 'Emiss'#227'o de Etiquetas p/ Impressoras Zebra/Bematech'
      Color = clBtnFace
      ParentColor = False
      ParentFont = False
  ...
  object GroupBox2: TGroupBox
    ...
    object Modelo: TComboBox
      ...
      ItemIndex = 1
      TabOrder = 12
      Text = 'modelo II - 3 Carreira 3,3 x 2'
      Items.Strings = (
        'Modelo I - 1 Carreira 100x23'
        'modelo II - 3 Carreira 3,3 x 2'
        'Modelo III - 1 Carreira 90x30,5')
    end
