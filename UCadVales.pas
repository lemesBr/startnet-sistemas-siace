...
uses
  ...
  Dialogs, UCadNovo, ImgList, ComCtrls, ToolWin, ExtCtrls, Mask,
   Buttons, StdCtrls, AlignEdit, IBDatabase, IBSQL, MatrixPrinter,
  rxToolEdit, rxCurrEdit, frxClass, acAlphaImageList, UNovosComponentes, UNovoFormulario,
  ToolEdit, CurrEdit, FDvGlowButton, FDvPanel;

type
  TFrmCadVales = class(TFrmCadastroNovo)
    Label4: TLabel;
    EdtCodFun: TAlignedit;
    BtnConsFun: TSpeedButton;
    BtnAddFun: TSpeedButton;
    EdtNomeFun: TEdit;
    Label5: TLabel;
    Label1: TLabel;
    cod_vale: TAlignedit;
...
var
  FrmCadVales: TFrmCadVales;

implementation
Uses Udm, Ubibli1, UCadFunc, UConsFunc, UConsValesFuncionario, Ext, UDialog;
var sGrava : boolean;
