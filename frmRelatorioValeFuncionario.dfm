object FRelatorioValeFuncionario: TFRelatorioValeFuncionario
  Left = 989
  Top = 344
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Relat'#243'rio de Vales Funcion'#225'rios'
  ClientHeight = 154
  ClientWidth = 387
  Color = clBtnFace
  ...
  object qrRel: TFDQuery
    ...
    SQL.Strings = (
      ...
      '    WHERE FV.LANCAMENTO BETWEEN :DTINI AND :DTFIM')
    Left = 152
    ParamData = <
      item
        Name = 'DTINI'
    ...
    object qrRelLANCAMENTO: TDateField
    ...
    object qrRelFUNCIONARIO: TStringField
    ...
    object qrRelMOTIVO: TStringField
      FieldName = 'MOTIVO'
      Origin = 'MOTIVO'
      Size = 100
    end
    ...
    object qrRelVALOR: TFMTBCDField
      FieldName = 'VALOR'
      Precision = 18
      Size = 2
    end
