...
uses
  ...
  Buttons,   Menus, DBCtrls,  ImgList, FDvGlowButton,  ToolEdit, CurrEdit,
  FDvPanel, XDBGrids, RzEdit, RzBtnEdt, Ubibli1,
  FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS,
  FireDAC.Phys.Intf, FireDAC.DApt.Intf, FireDAC.Stan.Async, FireDAC.DApt, FireDAC.Comp.DataSet,
  FireDAC.Comp.Client, Wwkeycb;
...
uses contaspagar_ficha, contaspagar_fichaalteracao,
  ...
  Uincplcontas, contaspagar_Ext, xloc_fornecedor;
...
begin
  if FormPrincipal.Label3.Caption ='N'then
   begin
    ...
    if qrcontaspagar.FieldByName('situacao').ASINTEGER = 1 then
    begin
      texto := PAnsiChar('Confirma a Exclusão da Conta: ' + #13 + 'Fornecedor: '
