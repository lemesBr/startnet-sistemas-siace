...
uses
  ...
  ExtCtrls, Mask, rxToolEdit, IBSQL, DB, sBitBtn, FireDAC.Stan.Intf,
    ...
    try
     with SPC_VENDA do
        begin
           ...
           //if bGrava then
             //begin
                CommandText.Add('UPDATE PEDIDOS SET CODIGO_CLIENTE = :CODIGO_CLIENTE, NOME_CLIENTE = :NOME_CLIENTE, ENDERECO = :ENDERECO,'+
    ...
    try
     with SPC_VENDA do
        begin
           ...
           //if bGrava then
             //begin
                 CommandText.Add('UPDATE CREDIARIO SET CODIGO_CLIENTE = :CODIGO_CLIENTE WHERE (CODIGO = :VDA)');
