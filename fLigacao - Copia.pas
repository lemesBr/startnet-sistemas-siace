...
uses
  ...
  Dialogs, StdCtrls, Buttons, ComCtrls, ExtCtrls, Spin, Mask, ToolEdit,
  CurrEdit, Grids, DBGrids, DB;
...
Begin
  ...
  begin
    ...
    EdQtdMinuto.Value  := DM1.LigacaoLIG_MINFALADO.Value;
    EdVlrMinuto.Value  := DM1.LigacaoLIG_MINVALOR.Value;
