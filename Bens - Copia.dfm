  ...
  object pnfundo: TPanel
    ...
    object wwDBLookupComboDlg1: TwwDBLookupComboDlg
      ...
      Selected.Strings = (
        ...
        'IDENTIF_MERC'#9'1'#9'Id'#9'F'#9
        'DESC_BEM'#9'50'#9'Nome do Bem'#9'F'
        'COD_PRINCIPAL'#9'10'#9'Cod Bem Princ'#9'F'
        'COD_CONTA'#9'50'#9'Conta'#9'F'#9)
      LookupTable = DM1.Sds_bens
      LookupField = 'CODIGO'
