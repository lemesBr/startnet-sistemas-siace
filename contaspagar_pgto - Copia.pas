...
uses
  ...
  Buttons, Menus, DBCtrls,  FDvGlowButton, ToolEdit, CurrEdit,
  FDvPanel, FDvGroupBox, XDBGrids, FireDAC.Stan.Intf, FireDAC.Stan.Option,
     ...
     qrcontaspagar.first;
      ...
      begin
        ...
        qrcontaspagar.post;
         ...
         Qrypagto.Params.ParamByName('SEQ').AsInteger := 0;
         Qrypagto.Params.ParamByName('COD_PAGAR').AsInteger := qrcontaspagar.FieldByName('codigo').asinteger;
         Qrypagto.Params.ParamByName('VALOR_PAGO').AsFloat := qrcontaspagar.FieldByName('liquido').AsFloat;
         Qrypagto.Params.ParamByName('DATA_PAGTO').AsDate := Date;
         Qrypagto.ExecSQL;
        qrcontaspagar.next;
      end;
