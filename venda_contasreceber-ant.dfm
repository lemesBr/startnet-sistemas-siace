object frmHotel_contasreceber: TfrmHotel_contasreceber
  Left = 652
  Top = 224
  Width = 509
  Height = 382
  ...
  object FlatPanel1: TFlatPanel
    ...
    object combocondpgto: TRzDBLookupComboBox
      Left = 48
      Top = 12
      Width = 265
      Height = 21
      ...
      KeyField = 'CODIGO'
      ListField = 'DESCRICAO'
      ListSource = DTS_PAGTO
      TabOrder = 1
      OnExit = combocondpgtoExit
      FlatButtonColor = 16776176
    end
  end
  ...
  object ClientDataSet11: TClientDataSet
    ...
    Left = 333
    Top = 137
    object ClientDataSet11CodigoCliente: TIntegerField
      FieldName = 'CodigoCliente'
    end
    object ClientDataSet11CodigoCompra: TIntegerField
      FieldName = 'CodigoCompra'
    end
    object ClientDataSet11Vendedor: TStringField
      FieldName = 'Vendedor'
    end
    object ClientDataSet11Historico: TStringField
      FieldName = 'Historico'
      Size = 50
    end
    object ClientDataSet11DataCompra: TDateField
      FieldName = 'DataCompra'
      EditMask = '!99/99/0000;1;_'
    end
    object ClientDataSet11Parcela: TStringField
      FieldName = 'Parcela'
      Size = 10
    end
    object ClientDataSet11DataVencimento: TDateField
      FieldName = 'DataVencimento'
      EditMask = '!99/99/0000;1;_'
    end
    object ClientDataSet11Comissao: TCurrencyField
      FieldName = 'Comissao'
    end
    object ClientDataSet11ValorParcela: TFMTBCDField
      FieldName = 'ValorParcela'
      currency = True
      Precision = 15
      Size = 2
  ...
  object SPC_CREDIARIO: TSQLStoredProc
    ...
    SQLConnection = DM.SQLC
    StoredProcName = 'SP_CREDIARIO_HOTEL'
    Left = 268
    Top = 20
  end
