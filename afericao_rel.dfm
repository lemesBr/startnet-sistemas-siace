object FormRelAfercao: TFormRelAfercao
  Left = 321
  Top = 193
  Caption = 'SIACE .:: AFERI'#199#213'ES DO SISTEMA ::.'
  ClientHeight = 443
  ClientWidth = 758
  Color = clBtnFace
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Height = 365
    Selected.Strings = (
      'CODIGO'#9'8'#9'Seq.'#9'F'
      'DATA'#9'12'#9'Data'#9'F'
      'USERCAD'#9'20'#9'Usu'#225'rio'#9'F'
      'DESCRICAO'#9'40'#9'Descri'#231#227'o'#9'F'
      'QUANTIDADE'#9'10'#9'Qtde Litros'#9'F'
      'VALOR_UNITARIO'#9'10'#9'Unit'#225'rio'#9'F'
      'VALOR_TOTAL'#9'10'#9'Total'#9'F')
  ...
  object QRLOG: TFDQuery
    ...
    SQL.Strings = (
      ...
      'PRODUTOS'
      'WHERE'
      'AFERICAO.USERCAD = :USUARIO AND'
      'AFERICAO.CODIGO_PROD = PRODUTOS.CODIGO')
    Left = 352
    Top = 168
    ParamData = <
      item
    ...
    object QRLOGCODIGO_PROD: TIntegerField
      FieldName = 'CODIGO_PROD'
      Origin = 'AFERICAO.CODIGO_PROD'
    end
    object QRLOGQUANTIDADE: TIBBCDField
      FieldName = 'QUANTIDADE'
      Origin = 'AFERICAO.QUANTIDADE'
      Precision = 18
      Size = 4
    end
    object QRLOGVALOR_UNITARIO: TFMTBCDField
      FieldName = 'VALOR_UNITARIO'
      Origin = 'VALOR_UNITARIO'
      Precision = 18
      Size = 2
    end
    object QRLOGVALOR_TOTAL: TFMTBCDField
      FieldName = 'VALOR_TOTAL'
      Origin = 'VALOR_TOTAL'
      Precision = 18
      Size = 2
    end
    object QRLOGCOD_TANQUE: TIntegerField
      FieldName = 'COD_TANQUE'
      Origin = 'COD_TANQUE'
    end
    object QRLOGCOD_BOMBA: TIntegerField
      FieldName = 'COD_BOMBA'
      Origin = 'COD_BOMBA'
    end
    object QRLOGID_BICO: TStringField
      FieldName = 'ID_BICO'
      Origin = 'ID_BICO'
      Size = 2
    end
    object QRLOGUSERCAD: TStringField
      FieldName = 'USERCAD'
      Origin = 'USERCAD'
    end
    object QRLOGDATACAD: TDateField
      FieldName = 'DATACAD'
      Origin = 'DATACAD'
    end
    object QRLOGCOD_USUARIO: TIntegerField
      FieldName = 'COD_USUARIO'
      Origin = 'COD_USUARIO'
    end
    object QRLOGDESCRICAO: TStringField
