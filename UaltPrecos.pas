...
uses
  ...
  AlignEdit, Grids, XDBGrids, RxToolEdit, sLabel;
...
begin
 ...
 try
  ...
  if dm.IBTransaction.Active then
   ...
   DM.Sds_produtos.sql.add('select * from PRODUTOS where DESCRICAO like ' + #39 + '%' + Edit2.Text + '%' + #39+'' +'ORDER BY DESCRICAO');
  ...
  if dm.IBTransaction.Active then
   ...
   dm.SDS_PRODUTOS.Active := false;
   DM.Sds_produtos.sql.clear;
   DM.Sds_produtos.sql.add('select * from PRODUTOS WHERE CODIGO_GRUPO = ' + QuotedStr(Grupo.Text)+ ' ORDER BY DESCRICAO');
   dm.SDS_PRODUTOS.Active := True;
 end else
  ...
  if dm.IBTransaction.Active then
   ...
   dm.SDS_PRODUTOS.Active := false;
   DM.Sds_produtos.sql.clear;
   DM.Sds_produtos.sql.add('select * from PRODUTOS WHERE codigo_subgrupo = ' + QuotedStr(SubGrupo.Text) + ' ORDER BY DESCRICAO');
   dm.SDS_PRODUTOS.Active := True;
  end else
  ...
  if dm.IBTransaction.Active then
   ...
   dm.SDS_PRODUTOS.Active := false;
   DM.Sds_produtos.sql.clear;
   DM.Sds_produtos.sql.add('select * from PRODUTOS WHERE codigo_MARCA = ' + QuotedStr(marca.Text) + ' ORDER BY DESCRICAO');
   dm.SDS_PRODUTOS.Active := True;
  end else
  ...
  if dm.IBTransaction.Active then
   ...
   dm.SDS_PRODUTOS.Active := false;
   DM.Sds_produtos.sql.clear;
   DM.Sds_produtos.sql.add('select * from PRODUTOS WHERE codigo_fornecedores = ' + QuotedStr(Fornecedor.Text) + ' ORDER BY DESCRICAO');
   dm.SDS_PRODUTOS.Active := True;
  ...
  if dm.IBTransaction.Active then
   ...
   dm.SDS_PRODUTOS.Active := false;
   DM.Sds_produtos.sql.clear;
   DM.Sds_produtos.sql.add('select * from PRODUTOS WHERE categoria = ' + QuotedStr(Categoria.Text) + ' ORDER BY DESCRICAO');
   dm.SDS_PRODUTOS.Active := True;
  ...
  if dm.IBTransaction.Active then
   ...
   dm.SDS_PRODUTOS.Active := false;
   DM.Sds_produtos.sql.clear;
   DM.Sds_produtos.sql.add('select * from PRODUTOS WHERE seccao = ' + QuotedStr(Seccao.Text) + ' ORDER BY DESCRICAO');
   dm.SDS_PRODUTOS.Active := True;
  ...
  if dm.IBTransaction.Active then
   ...
   dm.SDS_PRODUTOS.Active := false;
   DM.Sds_produtos.sql.clear;
   DM.Sds_produtos.sql.add('select * from PRODUTOS WHERE codigo_local_estoque = ' + QuotedStr(Lestoque.Text) + ' ORDER BY DESCRICAO');
   dm.SDS_PRODUTOS.Active := True;
