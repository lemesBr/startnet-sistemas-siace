...
uses
  ...
  frxDBSet, DBCtrls, RxToolEdit, IBX.IBCustomDataSet, IBX.IBQuery,
...
type
  TFormRelAfercao = class(TForm)
    ...
    QRLOGVALOR_UNITARIO: TFMTBCDField;
    QRLOGVALOR_TOTAL: TFMTBCDField;
    QRLOGCOD_TANQUE: TIntegerField;
    QRLOGCOD_BOMBA: TIntegerField;
    QRLOGID_BICO: TStringField;
    QRLOGUSERCAD: TStringField;
    QRLOGDATACAD: TDateField;
    QRLOGCOD_USUARIO: TIntegerField;
    QRLOGDESCRICAO: TStringField;
