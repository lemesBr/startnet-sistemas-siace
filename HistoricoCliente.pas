...
uses
  ...
  Dialogs, SUIPageControl, SUITabControl, StdCtrls, Mask,
  RXCtrls, ExtCtrls, grids, DBGrids, SUIDBCtrls, SUIEdit,
  DBCtrls, SUIDlg, DB, DBClient, SimpleDS, SUIMemo,
  ACBrBase, sMemo, sDBEdit, sPanel, sDBNavigator, acDBGrid, ComCtrls,
  sPageControl, RxToolEdit, sLabel;
...
type
  TFormHistoricoCliente = class(TForm)
    ...
    RxLabel24: TRxLabel;
    suiDBEdit5: TsDBEdit;
    suiDBEdit13: TsDBEdit;
    suiDBEdit14: TsDBEdit;
    suiDBEdit15: TsDBEdit;
    suiDBEdit12: TsDBEdit;
    suiDBEdit16: TsDBEdit;
    ...
    suiDBNavigator4: TsDBNavigator;
    suiDBNavigator6: TsDBNavigator;
    suiDBNavigator7: TsDBNavigator;
    suiDBNavigator8: TsDBNavigator;
    suiDBNavigator9: TsDBNavigator;
    suiDBNavigator10: TsDBNavigator;
    suiMemo1: TsMemo;
    suiMemo3: TsMemo;
    suiMemo4: TsMemo;
    suiMemo6: TsMemo;
