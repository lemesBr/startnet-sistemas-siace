...
uses
  ...
  IBDatabase, IBSQL, DB, IBCustomDataSet, IBQuery, ImgList, ToolWin, Mask,
  Grids, DBGrids, rxToolEdit, rxCurrEdit, acPNG, FDvGlowButton;

type
  TFrmCadCaixa = class(TFrmCadastroNovo)
    IBSQLCaixa: TIBSQL;
    IBTRCaixa: TIBTransaction;
    QBuscaCod: TIBQuery;
    ...
    TabSheet3: TTabSheet;
    Label32: TLabel;
    EdtCodGrp: TAlignEdit;
    BtnConsGRP: TSpeedButton;
    EdtNomeGrp: TEdit;
    Label33: TLabel;
    Label34: TLabel;
    ...
    QItensAliquotas: TIBQuery;
    QItensAliquotasCOD_CAI: TIntegerField;
    QItensAliquotasCOD_EMP: TIntegerField;
    QItensAliquotasCOD_GRP: TIntegerField;
    QItensAliquotasINDICE_ECF: TIBStringField;
    QItensAliquotasINDICE_R03: TIBStringField;
    QItensAliquotasNOME_GRP: TIBStringField;
    TabSheet4: TTabSheet;
    Label15: TLabel;
    EdtIndiceOS: TEdit;
    Label16: TLabel;
    ...
    TabSheet5: TTabSheet;
    Label14: TLabel;
    EdtCodForma: TAlignEdit;
    BtnConsForma: TSpeedButton;
    EdtNomeForma: TEdit;
    Label52: TLabel;
    Label53: TLabel;
    ...
    QItensFormasINDICE: TIBStringField;
    QItensFormasDESCRICAO: TIBStringField;
    Label54: TLabel;
    EdtDescECF: TEdit;
    QItensFormasDESCRICAO_ECF: TIBStringField;
    Label55: TLabel;
    Label56: TLabel;
...
implementation
Uses Udm, Ubibli1, UConsCaixa, UConsGRP, UConsFormasPagamento;
var  bGrava : boolean;
...
begin
  ...
  try
    try
           ...
           if bGrava then
              ...
              begin
                 sql.Add('UPDATE CAIXA SET TAMANHO_DESC_CUPOM = :4, PORTA_IMP = :5, DESC_CAI = :7, INDICE_GAVETA = :8,             ' +
                         ...
                         'DIAS_ATUALIZACAO_PAF = :66 WHERE COD_CAI = :1 AND COD_EMP = :2');
              end;
      ...
      IBTRCaixa.Rollback;
      showmessage('Erro ao Gravar o Caixa');
    end;
  finally
    IBSQLCaixa.Close;
     ...
     begin
        ...
        try
          try
            ...
            showmessage('Erro ao Excluir o Caixa');
          end;
        finally
          dm.Consulta.Close;
        end;
...
begin
  inherited;
  if ComboBalanca.ItemIndex = 11 then
     begin
...
begin
  ...
  if trim(EdtIndiceECF.Text) = '' then
      begin
         showmessage('Digite o Índice ECF');
         EdtIndiceECF.SetFocus;
         exit;
      end;
   ...
   if trim(EdtIndiceR03.Text) = '' then
      begin
         showmessage('Digite o Índice R03');
  ...
  if dm.IBTransaction.Active then
   ...
   try
     try
       ...
       dm.IBTransaction.Rollback;
       showmessage('Erro ao buscar a Forma de Pagamento');
     end;
   finally
     dm.QConsulta.close;
   end;
...
begin
  ...
  if trim(EdtIndiceForma.Text) = '' then
      begin
         showmessage('Digite o Índice da Forma no ECF');
  ...
  if trim(EdtDescECF.Text) = '' then
      begin
         showmessage('Digite a Descrição no ECF');
         EdtDescECF.SetFocus;
         exit;
      end;
