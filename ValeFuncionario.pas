...
uses
  ...
  frxDBSet, RxCurrEdit, RxToolEdit, RxDBCtrl, ACBrBase, ACBrEnterTab;
...
begin
  ...
  begin
    ...
    begin
      application.messagebox('Impossível prosseguir com pagamento relacionado com o Banco sem informar o numero do documento!', 'Atenção', mb_ok + MB_ICONWARNING);
  ...
  begin
    ...
    qrcaixa_mov.parambyname('historico').asstring := 'Adiantamento de Funcionário '+ edtMotivo.text;
  ...
  begin
     frxReport.LoadFromFile('rel\ValeFuncionario.fr3');
...
procedure TFrmValeFuncionario.SpeedButton3Click(Sender: TObject);
begin
  FormConsContaBancaria := tFormConsContaBancaria.create(self);
  FormConsContaBancaria.showmodal;
  edtNomeContaPgto.text := dm.SDS_Conta_BancariaCONTA.asstring;
  edtCodigoContaPgto.text     := dm.SDS_Conta_BancariaCODIGO.asstring;
...
begin
  ...
  begin
    ...
    lblNomeFuncionarioPgto.Caption:= dsGrid.DataSet.fieldbyname('FUNCIONARIO').AsString;
  end;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      qrcaixa_mov.parambyname('cod_plano').AsInteger := 54;
      qrcaixa_mov.parambyname('tipo_mov').asINTEGER := 26; // cheques  emitidos
      qrcaixa_mov.parambyname('historico').asstring := 'Pagto salário do funcionario: '+ lblNomeFuncionarioPgto.Caption;
      qrcaixa_mov.parambyname('tipo').AsString  := 'B';
      qrcaixa_mov.parambyname('ORIGEM').AsString  := 'PAG';
      qrcaixa_mov.parambyname('CODIGO_CC').asINTEGER:= DM.SDS_Conta_BancariaCODIGO.AsInteger;
      qrcaixa_mov.parambyname('NUMERO_CC').AsString:= DM.SDS_Conta_BancariaCONTA.AsString;
