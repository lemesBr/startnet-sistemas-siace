object formlista_frete: Tformlista_frete
  Left = 202
  Top = 186
  BorderIcons = []
  ...
  object combo_relatorio: TComboBox
    ...
    Items.Strings = (
      'RELA'#199#195'O FRETES POR VE'#205'CULO'
      'RELA'#199#195'O FRETES POR MOTORISTA'
      'RELA'#199#195'O FRETES POR PAGADOR DO FRETE'
      '')
  end
  ...
  object fxnota: TfrxReport
    ...
    ReportOptions.LastChange = 42052.941194907400000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo5: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fsfrete."NOME_VEICULO"] & -& [fsfrete."PLACA"]')
          ParentFont = False
        end
      ...
      object Footer1: TfrxFooter
        ...
        object Memo13: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<fsfrete."VALOR_FRETE">,MasterData1)]')
          ParentFont = False
        end
  ...
  object qrfrete: TFDQuery
    ...
    SQL.Strings = (
      ...
      'clientes cliente'
      'where'
      'frete.COD_PAGADOR = transp.codigo'
      'and'
    ...
    object qrfreteNOME_PAGADOR: TStringField
