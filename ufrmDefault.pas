...
var
  ALength: Integer;
begin
  TJvDBMaskEdit(Sender).EditText := uffuncoes.FormatarCNPJ
...
var
  ALength: Integer;
begin
  TJvDBMaskEdit(Sender).EditText := uffuncoes.FormatarCPF
    (ACBrUtil.OnlyNumber(TJvDBMaskEdit(Sender).Text));
  ALength := Length(Trim(TJvDBMaskEdit(Sender).EditText));
...
var
  ALength: Integer;
begin
  TJvDBMaskEdit(Sender).EditText := uffuncoes.FormatarCEP
    (ACBrUtil.OnlyNumber(TJvDBMaskEdit(Sender).Text));
  ALength := Length(Trim(TJvDBMaskEdit(Sender).EditText));
...
begin
  ...
  if ALength <= 11 then
  begin
    TJvDBMaskEdit(Sender).Text := uffuncoes.FormatarCPF
      (ACBrUtil.OnlyNumber(TJvDBMaskEdit(Sender).Text));
    ALength := Length(Trim(OnlyNumber(TJvDBMaskEdit(Sender).Text)));
...
var
  ALength: Integer;
begin
  TJvDBMaskEdit(Sender).Text := uffuncoes.FormatarCEST
    (ACBrUtil.OnlyNumber(TJvDBMaskEdit(Sender).Text));
  ALength := Length(Trim(OnlyNumber(TJvDBMaskEdit(Sender).Text)));
...
var
  ALength: Integer;
begin
  TJvDBMaskEdit(Sender).Text := uffuncoes.FormatarNCM
    (ACBrUtil.OnlyNumber(TJvDBMaskEdit(Sender).Text));
  ALength := Length(Trim(OnlyNumber(TJvDBMaskEdit(Sender).Text)));
...
begin
  TJvDBMaskEdit(Sender).EditText := uffuncoes.FormatarFone
    (ACBrUtil.OnlyNumber(TJvDBMaskEdit(Sender).Text));
