...
uses
  ...
  ComCtrls, Buttons, ExtDlgs, SUIGroupBox, Formata_CPF_CNPJ, defs, TaskDialog, sDBNavigator, sBitBtn, sPanel,
  sCustomComboEdit, sTooledit, sDBDateEdit, sDBEdit, sGroupBox, sMaskEdit,
  sComboBox, sEdit, acDBGrid, sLabel,  FireDAC.Stan.Intf,
  FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS, FireDAC.Phys.Intf,
  FireDAC.DApt.Intf, FireDAC.Stan.Async, FireDAC.DApt, FireDAC.Comp.DataSet, FireDAC.Comp.Client,
  RxCurrEdit, RxToolEdit, AdvSmoothMessageDialog, Ubibli1, AdvGlowButton;
type
...
uses UDMCob, ModulodeDadosBaixas,  Z_RotinasGerais, ModulodeDados, ConsClientes,
  Titulos, Principal, ModulodeDadosConsultas, OnGuard, OgUtil, ContaBancaria;
...
//      MarcaDagua.LoadFromFile('C:\SIAC\imagens\marca.jpg');
     ...
     // **** desativado ver essa função

      IF DMCOB.cds_titulosCOM_REGISTRO.AsInteger = 1 then
      GBTitulo1.Registro := '1'      //com registro   protesto
      else
      Registro := '3';      //sem registro sem protesto
...
begin
    ...
    TRY
      ...
      frmTitulos.Tag := 1;
       ...
       dm.sds_vendas.SQL.add('select * from PEDIDOS where num_nota > 0' +'');
       if DMCOB.cds_titulosCODIGO_COMPRA.text > '' then
       dm.sds_vendas.SQL.add('and codigo ='+(DMCOB.cds_titulosCODIGO_COMPRA.text)+'');
       dm.sds_vendas.Open;
