...
uses
  ...
  Buttons, Menus,  ImgList, DBGrids, DBCtrls, aDvToolBar, aDvGlowButton,
  aDvShapeButton, rxToolEdit, rxCurrEdit, NxPageControl, IBCustomDataSet,
...
type
  Tfrmcaixa = class(TForm)
    ...
    qrcaixa_mov1HISTORICO: TStringField;
    qrcaixa_mov1USUARIO: TStringField;
    qrcaixa_mov1TIPO: TStringField;
    qrcaixa_mov1NUMERO_CC: TStringField;
    qrcaixa_mov1ORIGEM: TStringField;
    qrcaixa_mov1N_CHEQUE: TStringField;
    qrcaixa_mov1NOMINAL: TStringField;
    qrcaixa_mov1COMPENSADO: TStringField;
    qrcaixa_mov1DOCUMENTO_LANC: TStringField;
    qrcaixa_mov1DB_CR: TStringField;
    qrcaixa_mov1STATUS: TIntegerField;
    qrcaixa_mov1COD_FECHAMENTO: TIntegerField;
    qrcaixa_mov1VALOR_ENTRADA: TFMTBCDField;
    qrcaixa_mov1VALOR_SAIDA: TFMTBCDField;
    qrcaixa_mov1VALOR: TFMTBCDField;
...
begin
    try
    FormCaixa_Ficha := TFormCaixa_Ficha.CREATE(SELF);
    FormCaixa_Ficha.SHOWMODAL;
  finally
    FreeAndNil(FormCaixa_Ficha);
  end;
