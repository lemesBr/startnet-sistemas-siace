...
uses
  ...
  ACBrBase, ACBrSocket, IBSQL, RzPrgres, ComCtrls, FireDAC.Stan.Intf,
        ...
        begin
         ...
         try
          try
           SQLVendas.Close;
           SQLVendas.SQL.Clear;
           SQLVendas.SQL.Add('update tabela_ncm set tabela_ncm.alic_nac =:alic_nac, tabela_ncm.alic_imp =:alic_imp, ALIC_ESTADUAL =:alic_estadual, tabela =:tab  where codigo_ncm =:cod_ncm');
           SQLVendas.ParamByName('alic_nac').AsFloat := tmpCadastroAliqFedNacional.AsFloat;
           SQLVendas.ParamByName('alic_imp').AsFloat := tmpCadastroAliqFedImportado.AsFloat;
           SQLVendas.ParamByName('alic_estadual').AsFloat := tmpCadastroAliqEstadual.AsFloat;
           SQLVendas.ParamByName('tab').AsString     := IntToStr(tmpCadastroTabela.Asinteger);
           SQLVendas.ParamByName('COD_NCM').AsString := tmpCadastroNCM.AsString;
           SQLVendas.Prepare;
           SQLVendas.ExecSQL;
           tmpCadastro.Next;
