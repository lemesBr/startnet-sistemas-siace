...
uses SysUtils, Forms, StdCtrls, Dialogs, Controls, IB, IBDatabase, DB, IBQuery,
     IBSQL, Mask, AlignEdit, Windows, ComCtrls, ExtCtrls, Grids, ExtDlgs,
     DateUtils, rxCurrEdit, XDBGrids, DBGrids, RXCtrls, rxToolEdit;
...
procedure Excluir(form : Tform; Tabela : string; campo : TAlignEdit; ibsql: Tibsql; transaction : Tibtransaction);
