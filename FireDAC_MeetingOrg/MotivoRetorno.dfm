object FormMotivoRetorno: TFormMotivoRetorno
  Left = 267
  Top = 272
  BorderIcons = [biSystemMenu]
  Caption = 'Cadastro de Motivo de Retorno de Cheques'
  ClientHeight = 125
  ClientWidth = 692
  Color = 15921906
  ...
  object Pnldados: TPanel
    ...
    object DBEditDescricao: TDBEdit
      ...
      ParentFont = False
      TabOrder = 1
      OnEnter = DBEditDescricaoEnter
      OnExit = DBEditDescricaoExit
    end
  end
