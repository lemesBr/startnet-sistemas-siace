...
uses
  ...
  Dialogs, SUIDBCtrls, StdCtrls, Mylabel, DBCtrls,
...
var
  ...
  entrada : Real;
  Parcela : integer;
  valor, Encargos, enc, juros, venda, total_venda, desc, desc_m, desconto2: Real;
...
uses ModulodeDados, ACBrECF, Principal, ModulodeDadosConsultas,
  ModulodeDadosRelatorios, ModulodeDadosConsultas5, boletos, BoletosBanc,
  ...
  lecheque_frente_cx, ACBrECFClass, ACBrUtil, Ubibli1, Libera_Venda, Nfe,
