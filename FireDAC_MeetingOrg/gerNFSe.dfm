object FormGeraNFSe: TFormGeraNFSe
  Left = 681
  Top = 187
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Gera'#231#227'o de NFS-e'
  ClientHeight = 476
  ClientWidth = 750
  Color = clBtnFace
  ...
  object GroupBox1: TGroupBox
    ...
    object myLabel3d2: TmyLabel3d
      ...
      Width = 337
      Height = 33
      Caption = 'SIACE-Gera'#231#227'o de NFS-e'
      Color = clWindow
  ...
  object SDS_NFE1: TSimpleDataSet
    ...
    DataSet.CommandText = 
      ...
      'TUS_CANCELADO, nr_recibo_nfe from NFSE_NOTA'
