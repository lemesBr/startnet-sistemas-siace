...
uses
 Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, ToolEdit, RXDBCtrl, RXCtrls, SUIEdit, DBCtrls,
  StdCtrls, Mask, EDBTime, SUIDBCtrls, SUIButton, ExtCtrls, SUIPageControl,
  SUITabControl, DBXpress, SUIGroupBox, Buttons, ExtDlgs, RxDBComb,
  DB, DBTables, SUIDlg, AppEvnts, FormPadrai, SUIImagePanel,
  SUIRadioGroup, EDBNum, TaskDialog, sDBNavigator, sBitBtn, sPanel,
  sCheckBox, sDBCheckBox, sDBMemo, sDBComboBox, sDBLookupComboBox,
  sGroupBox, sDBRadioGroup, sDBEdit, sLabel, RzEdit, CurrEdit, RzDBEdit,
...
uses ModulodeDados, Z_RotinasGerais, principal, ConsLyBancos;
