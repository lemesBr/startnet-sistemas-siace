...
type
  Tfrmimporta_nfe = class(TForm)
    ...
    QryCadastraProdutoPRECO_CUSTO: TBCDField;
    QryCadastraProdutoMARGEM_LUCRO: TBCDField;
    QryCadastraProdutoCOMISSAO: TBCDField;
    QryCadastraProdutoUNIDADE: TIntegerField;
    QryCadastraProdutoFRETE: TBCDField;
    QryCadastraProdutoICMS: TBCDField;
    QryCadastraProdutoIPI_IRPJ: TBCDField;
    QryCadastraProdutoOUTROS_IMPOSTOS: TBCDField;
    QryCadastraProdutoDESCONTOS: TBCDField;
    QryCadastraProdutoCLASS_FISCAL: TStringField;
    QryCadastraProdutoSIT_TRIBUTARIA: TStringField;
    QryCadastraProdutoCUSTO_MEDIO: TBCDField;
    QryCadastraProdutoPRECO_VENDA: TBCDField;
    QryCadastraProdutoDESCONTO_MAXIMO: TBCDField;
    ...
    QryCadastraProdutoESTOQUE_VENDIDO: TBCDField;
    ...
    QryCadastraProdutoPESOBRUTO: TBCDField;
    QryCadastraProdutoPESOLIQUIDO: TBCDField;
    QryCadastraProdutoFONETICO: TStringField;
    QryCadastraProdutoDATAULTALTERACAO: TDateField;
    QryCadastraProdutoCUSTOREPOSICAO: TBCDField;
    QryCadastraProdutoPRECO_ANT: TBCDField;
    QryCadastraProdutoPRECO_PROMOCAO: TBCDField;
    ...
    QryCadastraProdutoQTD_FRACIONADA: TBCDField;
    ...
    QryCadastraProdutoPRECO_VENDA2: TBCDField;
    QryCadastraProdutoMARGEM_LUCRO2: TBCDField;
    ...
    QryCadastraProdutoML_QUANT_BEB: TBCDField;
    ...
    qritemSUBTOTAL: TBCDField;
    qritemDESCONTO_P: TBCDField;
    qritemICMS_REDUCAO: TBCDField;
    qritemICMS_VALORRETIDO: TBCDField;
    qritemICMS_ISENTO: TBCDField;
    qritemICMS_NAOTRIBUTADO: TBCDField;
    qritemIPI_TIPO: TStringField;
    qritemTIPO: TIntegerField;
    qritemFRETE: TBCDField;
    qritemOUTRAS: TBCDField;
    qritemSEGURO: TBCDField;
    qritemCLASSIFICACAO_FISCAL: TStringField;
    qritemSUB_PRODUTOS: TBCDField;
    qritemITEM_ESPECIAL_VALOR: TBCDField;
    qritemICMS_OUTRAS: TBCDField;
    qritemALTERA_ITEM: TIntegerField;
    qritemCREDITO_ICMS: TBCDField;
    qritemCREDITO_ICMS_BASE: TBCDField;
    qritemPMARGEM: TFloatField;
    qritemPRECO_CUSTO: TBCDField;
    ...
    qritem1VALOR_DESC: TBCDField;
    qritem1TOTAL_ITEM: TBCDField;
    qritem1DATA: TDateField;
    qritem1BASE_ICMS: TBCDField;
    qritem1VALOR_ICMS: TBCDField;
    qritem1VALOR_IPI: TBCDField;
    qritem1PERC_ICMS: TBCDField;
    qritem1PERC_IPI: TBCDField;
    qritem1PRECO_VENDA: TBCDField;
    qritem1PRECO_VENDA2: TBCDField;
    ...
    qritem1MARG_LUCRO: TBCDField;
    qritem1ATIVO: TStringField;
    qritem1BASE_ICMS_ST: TBCDField;
    qritem1ALIC_ICMS_ST: TBCDField;
    qritem1VALOR_ICMS_ST: TBCDField;
    qritem1COD_EMPRESA: TIntegerField;
    qritem1IMOBILZ: TStringField;
    qritem1BASE_PIS: TBCDField;
    qritem1PERC_PIS: TBCDField;
    qritem1VALOR_PIS: TBCDField;
    qritem1BASE_COFINS: TBCDField;
    qritem1PERC_COFINS: TBCDField;
    qritem1VALOR_COFINS: TBCDField;
    qritem1BASE_IPI: TBCDField;
    ...
    qritem1SUBTOTAL: TBCDField;
    qritem1DESCONTO_P: TBCDField;
    qritem1ICMS_REDUCAO: TBCDField;
    qritem1ICMS_VALORRETIDO: TBCDField;
    qritem1ICMS_ISENTO: TBCDField;
    qritem1ICMS_NAOTRIBUTADO: TBCDField;
    qritem1IPI_TIPO: TStringField;
    qritem1TIPO: TIntegerField;
    qritem1FRETE: TBCDField;
    qritem1OUTRAS: TBCDField;
    qritem1SEGURO: TBCDField;
    qritem1CLASSIFICACAO_FISCAL: TStringField;
    qritem1SUB_PRODUTOS: TBCDField;
    qritem1ITEM_ESPECIAL_VALOR: TBCDField;
    qritem1ICMS_OUTRAS: TBCDField;
    qritem1ALTERA_ITEM: TIntegerField;
    qritem1CREDITO_ICMS: TBCDField;
    qritem1CREDITO_ICMS_BASE: TBCDField;
    qritem1PMARGEM: TFloatField;
    qritem1PRECO_CUSTO: TBCDField;
    Label53: TLabel;
    ...
    qrprodutoPERC_SUBST_TRIBUTARIA: TBCDField;
    qrprodutoFLAG_SERVICO: TStringField;
    qrprodutoPERC_ALIQUOTA_ISS: TBCDField;
    qrprodutoFLAG_FABRICACAO_PROPRIA: TStringField;
    qrprodutoPERC_ALIQUOTA_IPI: TBCDField;
    qrprodutoFLAG_PIS_COFINS: TStringField;
    qrprodutoPERC_ALIQUOTA_PIS: TBCDField;
    qrprodutoPERC_ALIQUOTA_COFINS: TBCDField;
    qrprodutoFLAG_ICMSGARANTIDO_INTEGRAL: TStringField;
    qrprodutoPERC_ICMS_GARANTIDO_INTEGRAL: TBCDField;
    ...
    qrprodutoPERC_ICMS_ESTADUAL: TBCDField;
    qrprodutoPERC_ICMS_INTER_ESTADUAL: TBCDField;
    ...
    qrprodutoPERC_RED_ICMS: TBCDField;
    ...
    qrprodutoPERC_LUCRO_ST: TBCDField;
    ...
    qrProdutoHistoricoVALOR_DESC: TBCDField;
    qrProdutoHistoricoTOTAL_ITEM: TBCDField;
    qrProdutoHistoricoDATA: TDateField;
    qrProdutoHistoricoBASE_ICMS: TBCDField;
    qrProdutoHistoricoVALOR_ICMS: TBCDField;
    qrProdutoHistoricoVALOR_IPI: TBCDField;
    qrProdutoHistoricoPERC_ICMS: TBCDField;
    qrProdutoHistoricoPERC_IPI: TBCDField;
    qrProdutoHistoricoPRECO_VENDA: TBCDField;
    qrProdutoHistoricoPRECO_VENDA2: TBCDField;
    ...
    qrProdutoHistoricoMARG_LUCRO: TBCDField;
    qrProdutoHistoricoATIVO: TStringField;
    qrProdutoHistoricoBASE_ICMS_ST: TBCDField;
    qrProdutoHistoricoALIC_ICMS_ST: TBCDField;
    qrProdutoHistoricoVALOR_ICMS_ST: TBCDField;
    qrProdutoHistoricoCOD_EMPRESA: TIntegerField;
    qrProdutoHistoricoIMOBILZ: TStringField;
    qrProdutoHistoricoBASE_PIS: TBCDField;
    qrProdutoHistoricoPERC_PIS: TBCDField;
    qrProdutoHistoricoVALOR_PIS: TBCDField;
    qrProdutoHistoricoBASE_COFINS: TBCDField;
    qrProdutoHistoricoPERC_COFINS: TBCDField;
    qrProdutoHistoricoVALOR_COFINS: TBCDField;
    qrProdutoHistoricoBASE_IPI: TBCDField;
    ...
    qrProdutoHistoricoSUBTOTAL: TBCDField;
    qrProdutoHistoricoDESCONTO_P: TBCDField;
    qrProdutoHistoricoICMS_REDUCAO: TBCDField;
    qrProdutoHistoricoICMS_VALORRETIDO: TBCDField;
    qrProdutoHistoricoICMS_ISENTO: TBCDField;
    qrProdutoHistoricoICMS_NAOTRIBUTADO: TBCDField;
    qrProdutoHistoricoIPI_TIPO: TStringField;
    qrProdutoHistoricoTIPO: TIntegerField;
    qrProdutoHistoricoFRETE: TBCDField;
    qrProdutoHistoricoOUTRAS: TBCDField;
    qrProdutoHistoricoSEGURO: TBCDField;
    qrProdutoHistoricoCLASSIFICACAO_FISCAL: TStringField;
    qrProdutoHistoricoSUB_PRODUTOS: TBCDField;
    qrProdutoHistoricoITEM_ESPECIAL_VALOR: TBCDField;
    qrProdutoHistoricoICMS_OUTRAS: TBCDField;
    qrProdutoHistoricoALTERA_ITEM: TIntegerField;
    qrProdutoHistoricoCREDITO_ICMS: TBCDField;
    qrProdutoHistoricoCREDITO_ICMS_BASE: TBCDField;
    qrProdutoHistoricoPMARGEM: TFloatField;
    qrProdutoHistoricoPRECO_CUSTO: TBCDField;
...
var
  ...
  MargemLucroCalc,PrecoVendaCalc: Integer;
...
uses ACBrNFeNotasFiscais, pcnNFe, MaskUtils, Ubibli1, principal, UFuncoes,
  ...
  uDMMovimentacao, loc_centrocusto, ufrmNfeImportar;
...
begin
  ...
  begin
    ...
    OpenDialog1.InitialDir:= 'C:\Siace\XMLs_A_Importar';
  end;
  ...
  begin
    ...
    try
      if vfImportar then
        ACBrNFe1.NotasFiscais.LoadFromFile(vfPath)
      else
    ...
    begin
     ...
     begin
      ...
      then
       ...
       if (ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x].Prod.CFOP = '5656') or (ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x].Prod.CFOP = '5655') then
        qritemCFOP.AsString := '1652'
       else
       if (ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x].Prod.CFOP = '6656') or (ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x].Prod.CFOP = '6655') then
      ...
      qritemALIC_ICMS_ST.ASFLOAT := ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items
        [x].Imposto.ICMS.pMVAST;
      qritemBASE_ICMS_ST.ASFLOAT := ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x]
        .Imposto.ICMS.vBCST;
      qritemVALOR_ICMS_ST.ASFLOAT := ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x]
        .Imposto.ICMS.vICMSST;
      qritemSUB_PRODUTOS.ASFLOAT := 0;

      qritemIPI_TIPO.ASFLOAT := 0;
      qritemPERC_IPI.ASFLOAT := ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items
        [x].Imposto.IPI.pIPI;
      qritemBASE_IPI.ASFLOAT := ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x]
        .Imposto.IPI.vBC;
      qritemVALOR_IPI.ASFLOAT := ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x]
        .Imposto.IPI.vIPI;
      ...
      qritemBASE_PIS.ASFLOAT := ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x]
        .Imposto.PIS.vBC;
      qritemVALOR_PIS.ASFLOAT := ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x]
        .Imposto.PIS.vPIS;
      qritemBASE_COFINS.ASFLOAT := ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items
        [x].Imposto.COFINS.vBC;
      qritemVALOR_COFINS.ASFLOAT := ACBrNFe1.NotasFiscais.Items[0].NFe.Det.Items[x]
...
begin
 ...
 { qrproduto_mov.Close;
  ...
  // **-- gravação da nota  --***//
  qrnotaCOD_EMPRESA.AsString := ecod_destinatario.Text;
 ...
 formprincipal.log(codigo_usuario,'NOTAFISCAL',qrnotaNUM_NOTA.Text,'INCLUIU','INCLUSÃO DO NOTA FISCAL Nº '+qrnotaNUM_NOTA.Text +' FORNECEDOR: '+ qrnotaFORNECEDOR.Text);
...
begin
  ...
  DM.SDS_FornecedoresCODIGO.Value := 1; //formprincipal.codifica('000009');
...
begin
  ...
  qrpagar.Close;
  qrpagar.sql.Clear;
  qrpagar.sql.add('DELETE FROM Contas_apagar WHERE CODNOTA = ''' + enota.Text + '''');
  qrpagar.execsql;

  qrpagar.sql.Clear;
  qrpagar.sql.add('SELECT * FROM Contas_apagar WHERE CODNOTA = ''' + enota.Text +
    ''' ORDER BY DATA_VENCIMENTO');
  qrpagar.open;
...
begin
 ...
 // frmfornecedor_codigo.Lproduto.Caption := qrprodutoCODIGO.AsString + '-' +  qrprodutoPRODUTO.AsString;
  ...
  DM.Sds_produtos.DataSet.CommandText:= 'select * from PRODUTOS where CODIGO = ' + #39  + RESULTADO_PESQUISA1 + #39+'ORDER BY DESCRICAO';
