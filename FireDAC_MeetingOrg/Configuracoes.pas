...
uses
  ...
  Mylabel,  RXDBCtrl, Menus, RzPanel, RzTabs, AlignEdit, wwdblook,
  Wwdbdlg, IniFiles, aDvGlowButton, RxToolEdit;
...
begin
  try
    ...
    if UpperCase(Trim(TBiblioteca.LerIni('SIACE.INI', 'DADOS', 'DATABASE'))) = 'C:\SIACE\SIACE.GDB' then
    begin
