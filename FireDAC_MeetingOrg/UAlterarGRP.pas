...
uses
  ...
  Dialogs, StdCtrls, AlignEdit, Buttons, ExtCtrls, ComCtrls, Mask,
  ToolEdit, CurrEdit;

type
  TFrmAlterarGRP = class(TForm)
    ...
    GroupBox3: TGroupBox;
    BtnConsICMSContEST: TSpeedButton;
    Label32: TLabel;
    Label33: TLabel;
    BtnConsICMSCFEST: TSpeedButton;
    Label34: TLabel;
    Label35: TLabel;
    BtnConsCFOPVEstCont: TSpeedButton;
    Label51: TLabel;
    Label52: TLabel;
    BtnConsCFOPVEstCF: TSpeedButton;
    EdtICMSContEst: TAlignEdit;
    EdtNomeICMSContEST: TEdit;
    EdtICMSCFEst: TAlignEdit;
    EdtNomeICMSCFEST: TEdit;
    EdtCSTContEst: TEdit;
    EdtCSTCFEst: TEdit;
    EdtCFOPVEstCont: TAlignEdit;
    EdtNomeCFOPVEstCont: TEdit;
    EdtCFOPVEstCF: TAlignEdit;
    EdtNomeCFOPVEstCF: TEdit;
    GroupBox4: TGroupBox;
    Label36: TLabel;
    BtnConsICMSContFORA: TSpeedButton;
    Label37: TLabel;
    Label38: TLabel;
    BtnConsICMSPFFORA: TSpeedButton;
    Label39: TLabel;
    Label53: TLabel;
    BtnConsCFOPVForaCF: TSpeedButton;
    Label54: TLabel;
    BtnConsCFOPVForaCont: TSpeedButton;
    EdtICMSContFora: TAlignEdit;
    EdtNomeICMSContFORA: TEdit;
    EdtCSTContFora: TEdit;
    EdtICMSCFFora: TAlignEdit;
    EdtNomeICMSCFFORA: TEdit;
    EdtCSTCFFora: TEdit;
    EdtCFOPVForaCF: TAlignEdit;
    EdtNomeCFOPVForaCF: TEdit;
    EdtCFOPVForaCont: TAlignEdit;
...
implementation
Uses ModulodeDados, Ubibli1, UAlteraPreco, UConsGRP;
                  ...
                  begin
                     if FrmAlteraPreco.DBGrid.SelectedRows.CurrentRowSelected then
                        begin
                           ...
                           dm.QConsulta.ParamByName('7').AsInteger := FrmAlteraPreco.QConsProdCODIGO.AsInteger;
...
begin
   if (trim(EdtICMSContEst.Text) = '')   or
      ...
      (trim(EdtCSTCFFora.Text) = '')     then
          begin
             showmessage('Verifique se os campos, tem que preencher todos');
                  ...
                  begin
                     if FrmAlteraPreco.DBGrid.SelectedRows.CurrentRowSelected then
                        begin
                           ...
                           dm.QConsulta.ParamByName('13').AsInteger:= FrmAlteraPreco.QConsProdCODIGO.AsInteger;
                           dm.QConsulta.ExecSQL;
                        end;
                     next;
                  end;
...
begin
   Application.CreateForm(TFormConsCFOP, FormConsCFOP);
   FormConsCFOP.Tag:= 13;
