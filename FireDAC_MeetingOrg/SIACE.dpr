...
uses
  ...
  Func in 'Func.pas',
  U_Principal in 'BaixarXMLNFeDLL\Código Fonte do Exemplo de Uso\U_Principal.pas' {F_downloadnfe},
  U_Carregando in 'BaixarXMLNFeDLL\Código Fonte do Exemplo de Uso\U_Carregando.pas' {F_Carregando},
  UDownloadXMLNFeDLL in 'BaixarXMLNFeDLL\Código Fonte do Exemplo de Uso\UDownloadXMLNFeDLL.pas',
  UTDownloadXMLNFeDLL in 'BaixarXMLNFeDLL\Código Fonte do Exemplo de Uso\UTDownloadXMLNFeDLL.pas',
  utils in 'BaixarXMLNFeDLL\Código Fonte do Exemplo de Uso\utils.pas',
...
//    end;
    ...
    Application.Title := 'SIACE - Sistema Integrado de Automação Comercial';
