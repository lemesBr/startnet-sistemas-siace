...
type
  Tfrmlista_pagar2 = class(TForm)
    ...
    qrcontaspagarPL_CONTAS: TStringField;
    ...
    QrContasPagasVALOR_PAGO: TBCDField;
...
begin
  ...
  qrcontaspagar.SQL.Add('select * from v_contas_a_pagar where ' + Periodo + Fornecedor + Conta + Situacao + ' order by ' + Ordem);
  ...
  fxcontaspagar.LoadFromFile('\siace\rel\f000063.fr3');
