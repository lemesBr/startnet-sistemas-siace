...
uses
  ...
  Provider, Dialogs,  IniFiles, Forms, IBDatabase, Graphics, StrUtils,
  IBCustomDataSet, IBQuery, IBSQL, TypInfo, ComCtrls,
  ...
  FireDAC.Phys.IB, FireDAC.Comp.Client, IBUpdateSQL, DB, ACBrEAD, ACBrNFeDANFEFR,
  frxExportHTML, frxExportXLS, frxExportRTF, frxExportImage, frxExportText,
  frxClass, frxExportPDF, frxDBSet, FireDAC.Comp.DataSet, frxExportMail, jpeg,
  ACBrUtil,  XMLIntf, XMLDoc, zlib, ShellAPI, pcnConversao, pcnConversaoNFe, ACBrDFeUtil,
  acAlphaImageList, ACBrECFClass, ACBrNFeDANFEClass,  ACBrNFe,
  Data.DBXInterBase, FireDAC.Phys.IBDef, ACBrDFeReport, ACBrDFeDANFeReport,
  FireDAC.Phys.IBBase, FireDAC.Phys.FB, FireDAC.Phys.FBDef, Data.DBXFirebird,
  frxExportBaseDialog ;
...
type
    ...
    QCaixaPORTA_IMP: TIBStringField;
    QCaixaDESC_CAI: TIBStringField;
    ...
    QCaixaTRUNCAR_CAI: TIBStringField;
    QCaixaIMPRIMIR_COMPROVANTE_ECF: TIBStringField;
    QCaixaECF_MFD: TIBStringField;
    QCaixaIP_SERVIDOR_TEF: TIBStringField;
    QCaixaID_LOJA_TEF: TIBStringField;
    QCaixaID_TERMINAL_TEF: TIBStringField;
    QCaixaTEF_CAI: TIBStringField;
    QCaixaCAMINHO_BANCO: TIBStringField;
    QCaixaEXPORTAR_DADOS: TIBStringField;
    QCaixaR01_MF_ADICIONAL: TIBStringField;
    QCaixaR01_TIPO_ECF: TIBStringField;
    QCaixaR01_MARCA_ECF: TIBStringField;
    QCaixaR01_MODELO_ECF: TIBStringField;
    QCaixaR01_VERSAO_SB: TIBStringField;
    QCaixaR01_CNPJ_USUARIO: TIBStringField;
    QCaixaR01_IE_USUARIO: TIBStringField;
    QCaixaR01_NUMERO_SERIE: TIBStringField;
    QCaixaLINHA1: TIBStringField;
    QCaixaLINHA2: TIBStringField;
    QCaixaLINHA3: TIBStringField;
    QCaixaINDICE_GER_OS: TIBStringField;
    QCaixaINDICE_GER_ORCAMENTO: TIBStringField;
    QCaixaINDICE_GER_MESA: TIBStringField;
    QCaixaR01_NUMERO_USUARIO: TIntegerField;
    QCaixaCODIGO_NACIONAL_IDENTIFICACAO: TIBStringField;
    QCaixaR01_DATAHORA_SB: TDateTimeField;
    ...
    QConvNOME_CON: TIBStringField;
    QConvEND_CON: TIBStringField;
    QConvBAI_CON: TIBStringField;
    QConvCID_CON: TIBStringField;
    QConvCEP_CON: TIBStringField;
    QConvTEL_CON: TIBStringField;
    QConvFAX_CON: TIBStringField;
    QConvATIVO_CON: TIBStringField;
    QConvRESPONSAVEL_CON: TIBStringField;
    QConvCNPJ_CON: TIBStringField;
    QConvINSC_CON: TIBStringField;
    QConvEST_CON: TIBStringField;
    QConvOBS_AUTORIZACAO_CON: TIBStringField;
    QConvDIA_REFERENCIA_CON: TIntegerField;
    QConvDESCONTO_CON: TIBBCDField;
    DSConv: TDataSource;
    ...
    QNotasManifestoCHAVE_NOTA: TIBStringField;
    QNotasManifestoDATA_ENTRADA: TDateField;
    QNotasManifestoEMITENTE: TIBStringField;
    QNotasManifestoCNPJ_EMI: TIBStringField;
    QNotasManifestoIE_EMI: TIBStringField;
    QNotasManifestoVALOR_NF: TIBBCDField;
    QNotasManifestoTIPO_NF: TIBStringField;
    QNotasManifestoSIT_NF: TIBStringField;
    QNotasManifestoSIT_CONF: TIBStringField;
    ...
    SDS_NFCEVL_ACRESCIMOS: TBCDField;
    SDS_NFCEVL_DESCONTOS: TBCDField;
    SDS_NFCEVL_MERCADORIAS: TBCDField;
    SDS_NFCEVL_SERVICOS: TBCDField;
    SDS_NFCEVL_TOTAL: TBCDField;
    SDS_NFCECOD_PGTO: TIntegerField;
    SDS_NFCEVL_AVISTA: TBCDField;
    SDS_NFCEVL_PRAZO: TBCDField;
    SDS_NFCEPESO_TOTAL: TBCDField;
    ...
    SDS_NFCEPESO_LIQUIDO: TBCDField;
    SDS_NFCEVL_FRETE: TBCDField;
    SDS_NFCEVL_SEGURO: TBCDField;
    SDS_NFCEVL_BASE_ICM: TBCDField;
    SDS_NFCEVL_ICM: TBCDField;
    SDS_NFCEVL_BASE_ICM_SUBST: TBCDField;
    SDS_NFCEVL_ICM_SUBST: TBCDField;
    SDS_NFCEVL_IPI: TBCDField;
    SDS_NFCEVL_ISS: TBCDField;
    ...
    SDS_NFCEVL_OUTROS: TBCDField;
    SDS_NFCENR_PEDIDO: TIntegerField;
    SDS_NFCEVL_BASE_PIS: TBCDField;
    SDS_NFCEVL_PIS: TBCDField;
    SDS_NFCEVL_BASE_COFINS: TBCDField;
    SDS_NFCEVL_COFINS: TBCDField;
    SDS_NFCEVL_BASE_IPI: TBCDField;
    SDS_NFCEVL_BASE_ISS: TBCDField;
    SDS_NFCEVL_DESCONTO_ITEM: TBCDField;
    SDS_NFCEVL_ISENTO_ITENS: TBCDField;
    SDS_NFCEVL_OUTROS_ITENS: TBCDField;
    ...
    SDS_NFCEVL_FRETE_CONHECIMENTO: TBCDField;
    SDS_NFCEVL_ST_CONHECIMENTO: TBCDField;
    SDS_NFCEVL_ICM_CONHECIMENTO: TBCDField;
    SDS_NFCEBASE_ICM_PROPRIO_ST: TBCDField;
    SDS_NFCEVL_ICM_PROPRIO_ST: TBCDField;
    SDS_NFCEVL_BASE_ICM_SUBST_REAL: TBCDField;
    SDS_NFCEVL_ICM_SUBST_REAL: TBCDField;
    ...
    SDS_NFCEVL_TROCO: TBCDField;
    SDS_NFCEBXML: TBlobField;
    sds_vendasCODIGO: TIntegerField;
    sds_vendasVALOR_ITENS: TBCDField;
    sds_vendasENC_FINANCEIRO: TBCDField;
    sds_vendasVALOR_DESCONTO: TBCDField;
    sds_vendasVALOR_TOTAL: TBCDField;
    sds_vendasVALOR_COMISSAO: TBCDField;
    ...
    sds_vendasVALOR_ACRESCIMOS: TBCDField;
    ...
    sds_vendasVALOR_AVISTA: TBCDField;
    sds_vendasVALOR_PRAZO: TBCDField;
    ...
    sds_vendasVALOR_PAGO: TBCDField;
    sds_vendasVALOR_TROCO: TBCDField;
    ...
    sds_vendasVLR_PIS: TBCDField;
    sds_vendasVLR_COFINS: TBCDField;
    ...
    Sds_Vendas_itensDESCONTO: TBCDField;
    Sds_Vendas_itensQUANTIDADE: TBCDField;
    Sds_Vendas_itensPRECO_TOTAL: TBCDField;
    Sds_Vendas_itensCOMISSAO: TBCDField;
    Sds_Vendas_itensDEV: TStringField;
    Sds_Vendas_itensQNT_DEV: TBCDField;
    Sds_Vendas_itensVAL_DEV: TBCDField;
    Sds_Vendas_itensENC_FINANCEIRO: TBCDField;
    ...
    Sds_Vendas_itensPERC_ISS: TBCDField;
    Sds_Vendas_itensBASE_ISS: TBCDField;
    Sds_Vendas_itensVL_ISS: TBCDField;
    Sds_Vendas_itensPERC_ICM: TBCDField;
    Sds_Vendas_itensBASE_ICMS: TBCDField;
    Sds_Vendas_itensVL_ICM: TBCDField;
    Sds_Vendas_itensPERC_IPI: TBCDField;
    Sds_Vendas_itensBASE_IPI: TBCDField;
    Sds_Vendas_itensVL_IPI: TBCDField;
    Sds_Vendas_itensPERC_COFINS: TBCDField;
    Sds_Vendas_itensBASE_COFINS: TBCDField;
    Sds_Vendas_itensVL_COFINS: TBCDField;
    Sds_Vendas_itensPERC_ICMS_SUBST: TBCDField;
    Sds_Vendas_itensBASE_ICMS_SUBST: TBCDField;
    Sds_Vendas_itensVL_ICMS_SUBST: TBCDField;
    Sds_Vendas_itensPERC_PIS: TBCDField;
    Sds_Vendas_itensBASE_PIS: TBCDField;
    Sds_Vendas_itensVL_PIS: TBCDField;
    ...
    SDS_FornecedoresVALOR_LEITE: TBCDField;
    qrgrade_produtoPRECO_VENDA_GRADE: TBCDField;
    qrserial_produtoESTOQUE: TBCDField;
    qrserial_produtoPRECOCUSTO: TBCDField;
    qrserial_produtoPRECOVENDA: TBCDField;
    ...
    SDS_NotasFiscaisTOTAL_NOTA: TBCDField;
    ...
    SDS_NotasFiscaisBASE_CALCULO_ICMS: TBCDField;
    SDS_NotasFiscaisVALOR_ICMS: TBCDField;
    SDS_NotasFiscaisBASE_CALC_ICMS_SUBST: TBCDField;
    SDS_NotasFiscaisVALOR_ICMS_SUBST: TBCDField;
    SDS_NotasFiscaisVALOR_FRETE: TBCDField;
    SDS_NotasFiscaisVALOR_SEGURO: TBCDField;
    SDS_NotasFiscaisVALOR_DESCONTO: TBCDField;
    SDS_NotasFiscaisVALOR_OUTRAS_DESPESAS: TBCDField;
    SDS_NotasFiscaisVALOR_IPI: TBCDField;
    SDS_NotasFiscaisVALOR_TOTAL_PRODUTOS: TBCDField;
    SDS_NotasFiscaisVALOR_TOTAL_ITENS_NOTA: TBCDField;
    SDS_NotasFiscaisVLR_ICMS_GARANTIDO: TBCDField;
    ...
    SDS_NotasFiscaisVALOR_AVISTA: TBCDField;
    SDS_NotasFiscaisVALOR_PRAZO: TBCDField;
    SDS_NotasFiscaispagamento: TStringField;
    SDS_NotasFiscaisMODELO: TStringField;
    SDS_NotasFiscaisEMITENTE: TStringField;
    SDS_NotasFiscaisVALOR_COFINS: TBCDField;
    SDS_NotasFiscaisVALOR_PIS: TBCDField;
    SDS_NotasFiscaisVALOR_PIS_ST: TBCDField;
    SDS_NotasFiscaisVALOR_COFIS_ST: TBCDField;
    SDS_NotasFiscaisPERC_ICMS: TBCDField;
    ...
    qrprecoCUSTO_COMPRA: TBCDField;
    qrprecoVALOR_ULTIMA_COMPRA: TBCDField;
    qrprecoFRETE_IPI_OUTRAS: TBCDField;
    qrprecoICMS_ENTRADA: TBCDField;
    qrprecoICMS_SAIDA: TBCDField;
    qrprecoCUSTO_OPERACIONAL: TBCDField;
    qrprecoOUTROS_IMPOSTOS: TBCDField;
    qrprecoCOMISSAO: TBCDField;
    qrprecoLUCRO: TBCDField;
    qrprecoPRECO_VENDA: TBCDField;
    qrprecoICMS_ENTRADA_P: TBCDField;
    qrprecoICMS_SAIDA_P: TBCDField;
    qrprecoCUSTO_OPERACIONAL_P: TBCDField;
    qrprecoOUTROS_IMPOSTOS_P: TBCDField;
    qrprecoCOMISSAO_P: TBCDField;
    qrprecoLUCRO_P: TBCDField;
    qrprecoTOTAL_CUSTO: TBCDField;
    qrprecoTOTAL_CUSTO_P: TBCDField;
    qrprecoPRECO_AUTOMATICO: TIntegerField;
    qrprecoALTERA_AUTOMATICO: TIntegerField;
    qrprecoNOVO_PRECO_VENDA: TBCDField;
    qrprecoNOVO_PRECO_CUSTO: TBCDField;
    qrprecoDESCONTO: TBCDField;
    qrprecoFRETE: TBCDField;
    qrprecoSEGURO: TBCDField;
    qrprecoOUTRAS_DESPESAS: TBCDField;
    qrprecoIPI_P: TBCDField;
    qrprecoIPI: TBCDField;
    qrprecoPIS_P: TBCDField;
    qrprecoPIS: TBCDField;
    qrprecoCOFINS_P: TBCDField;
    qrprecoCOFINS: TBCDField;
    qrprecoCONTRIBUICAO_SOCIAL_P: TBCDField;
    qrprecoCONTRIBUICAO_SOCIAL: TBCDField;
    qrprecoPIS_ENTRADA_P: TBCDField;
    qrprecoPIS_ENTRADA: TBCDField;
    qrprecoCOFINS_ENTRADA_P: TBCDField;
    qrprecoCOFINS_ENTRADA: TBCDField;
    qrprecoCONTRIBUICAO_SOCIAL_ENTRADA_P: TBCDField;
    qrprecoSUBSTITUICAO_TRIBUTARIA: TBCDField;
    ...
    qrcfopVALOR1: TBCDField;
    qrcfopVALOR2: TBCDField;
    qrcfopVALOR3: TBCDField;
    qrcfopVALOR4: TBCDField;
    qrcfopVALOR5: TBCDField;
    qrcfopVALOR6: TBCDField;
    qrcfopVALOR7: TBCDField;
    qrcfopVALOR8: TBCDField;
    qrcfopVALOR9: TBCDField;
    qrcfopVALOR10: TBCDField;
    qrcfopST: TStringField;
    qrcfopCLASSIFICACAO_FISCAL: TStringField;
    qrcfopREDUCAO_ICMS: TBCDField;
    qrcfopMARGEM_AGREGADA: TBCDField;
    ...
    SDS_ClientesREMUNERACAO: TBCDField;
    ...
    SDS_ClientesVALOR_ALUGUEL: TBCDField;
    ...
    SDS_ClientesRENDA_CONJUGUE: TBCDField;
    ...
    SDS_ClientesLIMITE_DE_CREDITO: TBCDField;
    ...
    SDS_ClientesFUNC_SALARIO: TBCDField;
    ...
    Sds_Vendas_itensPRECO_UNITARIO: TBCDField;
    ...
    procedure SDS_NotasFiscaisItensAfterPost(DataSet: TDataSet);
...
var
  ...
  xprod_escolh, xprod_escolh2, VENDA :string;
  PODEFECHAR : Boolean;
  ...
  serial_entrada: Boolean;
   ...
   mascara_valor, mascara_qtde, N_CUPOM, PREVENDA: string;
...
uses Uerro, Vendas, ufrmStatus, Ubibli1, UDialog, clientes, wcrypt2;
...
//   try
  ...
  {   IBDatabase.ConnectionName := '';
     IBDatabase.ConnectionName := trim(LeINI('siace.ini', 'DADOS', 'DATABASE') );
  ...
  {   Conexao.Database := '';
     Conexao.Database := trim(LeINI('Siace.ini', 'DADOS', 'DATABASE') );
  ...
  //   Coneccao.Params.Values['DATABASE'] := trim(LeINI('siace.ini', 'DADOS', 'DATABASE'));
    // Coneccao.Connected    := true;
     ...
     caminho_fotos_clientes := 'C:\StartNet_Sistemas\imagens';
...
procedure TDM.SDS_NotasFiscaisItensAfterPost(DataSet: TDataSet);
begin
