...
uses
  ...
  rxToolEdit, rxCurrEdit, DBCtrls, ActnList, System.Actions;
...
type
  TFormProdutosCaixa = class(TForm)
    ...
    QProdCODIGO_BARRAS: TIBStringField;
    QProdQUANT_VENDA: TIntegerField;
    QProdVALOR_VENDA: TIBBCDField;
    QProdDESCRICAO: TIBStringField;
    QProdUNID: TIBStringField;
...
begin
  ...
  begin
    ...
    EdtPreco.Text:= FloatToStr(QProdVALOR_VENDA.value);
  end;
end;
