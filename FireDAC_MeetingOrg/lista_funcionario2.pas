...
type
  Tfrmlista_funcionario2 = class(TForm)
    ...
    qrfuncionarioREMUNERACAO: TBCDField;
    ...
    qrfuncionarioVALOR_ALUGUEL: TBCDField;
    ...
    qrfuncionarioRENDA_CONJUGUE: TBCDField;
    ...
    qrfuncionarioLIMITE_DE_CREDITO: TBCDField;
    ...
    qrfuncionarioCAPITALSOCIAL: TBCDField;
    qrfuncionarioFATURAMENTOBRUTO: TBCDField;
    ...
    qrfuncionarioFUNC_SALARIO: TBCDField;
...
begin
  ...
  if combo_FUNCIONARIO.Text = 'TODOS' then FUNCIONARIO := '' else begin FUNCIONARIO := ' and codIGO = ''' + copy(combo_FUNCIONARIO.text, 1, 6) + ''''; dm.qrrelatorio.fieldbyname('LINHA3').asstring := 'FUNCIONÁRIO: ' + COMBO_FUNCIONARIO.TEXT; end;
  ...
  begin
    ...
    FXFUNCIONARIO.LoadFromFile('\siace\rel\f000007.fr3');
  ...
  begin
    ...
    FXFUNCIONARIO.LoadFromFile('\siace\rel\f000008.fr3');
    FXFUNCIONARIO.ShowReport;
  end;
