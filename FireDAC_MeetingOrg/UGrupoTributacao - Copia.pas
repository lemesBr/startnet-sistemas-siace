...
uses
  ...
  Mask, ToolEdit, CurrEdit, DB, EDBNum, wwdblook, Wwdbdlg, FDvGroupBox,
  FDvOfficePager;
...
Try
   ...
   dm.Sds_grupo_tribCOD_GRUPO.Text:= inttostr(prxcod('grupo_tributacao', 'cod_grupo', dm.IBTransaction, dm.ibsqlcod));
   HabilitaPanel;
   AtualizaManutencao;
  // dezabilitaNovo;
