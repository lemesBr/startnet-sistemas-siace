...
uses
  ...
  SqlExpr, Mask,  AppEvnts, IniFiles, ShellApi,  RzEdit, DBGrids,
  IBCustomDataSet, IBQuery,  RDprint, Printers,
  AdvGlowButton, RxToolEdit, RxCurrEdit, System.SysUtils;
...
type
  TfrmFarmaciaPopular = class(TForm)
    ...
    procedure FDvGlowButton9Click(Sender: TObject);
  private
      ...
      begin
       ...
       //
        ...
        begin
          ...
          begin
          Printer.Title := 'COMPROVANTE FARMACIA POPULAR'; 
          ImprimirMemoComCanvas(Memo3);
          end else
 ...
 { if DataSource1.DataSet.IsEmpty then
  ...
  begin
    ...
    WSDLLocation          :=  '';
     ...
     while not DM.Sds_Vendas_itens.eof do
     begin
     ...
     If formprincipal.NFCE = 'S' then
     ClientDataSet1N_CUPON.TEXT         := N_CUPOM
     else
...
procedure TfrmFarmaciaPopular.FDvGlowButton9Click(Sender: TObject);
begin
Printer.Title := 'COMPROVANTE FARMACIA POPULAR';
ImprimirMemoComCanvas(Memo3);
end;
