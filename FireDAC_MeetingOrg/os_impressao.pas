...
type
  Tfrmos_impressao = class(TForm)
    ...
    qrreceberVALOR_COMPRA: TBCDField;
    qrreceberVALOR_JUROS: TBCDField;
    qrreceberVALOR_ACRESCIMO: TBCDField;
    qrreceberVALOR_DESCONTO: TBCDField;
    qrreceberVALOR_PAGAR: TBCDField;
    qrreceberVALOR_PAGO: TBCDField;
    qrreceberVALOR_TOTAL: TBCDField;
...
begin
    ...
    qros_servico.Open;
                    ...
                    begin
                    fxos.LoadFromFile('\siace\rel\f000067.fr3');
                    //fxos.LoadFromFile('\Athenas\server\rel\relatorio.rav');
                    fxos.ShowReport;
                    end;
...
begin
   { frmmodulo.qrcontasreceber.close;
    ...
    fxos.LoadFromFile('\siace\rel\f000066.fr3');
    //fxos.LoadFromFile('\Athenas\server\rel\relatorio.rav');
    fxos.ShowReport;
//  end;
 { if RAMO = 3 then
...
begin
  ...
  frmmodulo.qrcontasreceber.open;   }
    ...
    fxos.LoadFromFile('\siace\rel\f000065.fr3');
    fxos.ShowReport;
end;
