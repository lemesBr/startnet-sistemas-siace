object FormMovComb: TFormMovComb
  Left = 392
  Top = 272
  Caption = 'Movimento de Abastecidas por Ve'#237'culo'
  ClientHeight = 228
  ClientWidth = 660
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object DBAdvGlowButton1: TDBAdvGlowButton
      ...
      AutoDisable = True
      ConfirmAction = False
      DataSource = DM1.Dts_Abastecimentos
  ...
  object pficha: TFlatPanel
    ...
    object DBAdvSpinEdit1: TRxDBCalcEdit
      Left = 103
      Top = 116
      Width = 121
      Height = 21
  ...
  object QBuscaItens: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT * FROM veiculo_abast WHERE COD_VEI =:COD_VEI order by seq' +
        ' asc')
    Left = 32
    Top = 72
    ParamData = <
    ...
    object QBuscaItensSEQ: TIntegerField
      FieldName = 'SEQ'
      Origin = '"VEICULO_ABAST"."SEQ"'
      Required = True
    end
    object QBuscaItensCOD_PRO: TIntegerField
      FieldName = 'COD_PRO'
      Origin = '"VEICULO_ABAST"."COD_PRO"'
    end
    object QBuscaItensCOD_FOR: TIntegerField
      FieldName = 'COD_FOR'
      Origin = '"VEICULO_ABAST"."COD_FOR"'
    end
    object QBuscaItensCOD_VEI: TIntegerField
      FieldName = 'COD_VEI'
      Origin = '"VEICULO_ABAST"."COD_VEI"'
      Required = True
    end
    object QBuscaItensDATA: TDateField
      FieldName = 'DATA'
      Origin = '"VEICULO_ABAST"."DATA"'
    end
    object QBuscaItensQUANT: TIBBCDField
      FieldName = 'QUANT'
      Origin = '"VEICULO_ABAST"."QUANT"'
      Precision = 18
      Size = 4
    end
    object QBuscaItensV_TOTAL: TIBBCDField
      FieldName = 'V_TOTAL'
      Origin = '"VEICULO_ABAST"."V_TOTAL"'
      Precision = 18
      Size = 2
    end
    object QBuscaItensKM_VEIC: TIntegerField
      FieldName = 'KM_VEIC'
      Origin = '"VEICULO_ABAST"."KM_VEIC"'
    end
    object QBuscaItensOBS: TIBStringField
      FieldName = 'OBS'
      Origin = '"VEICULO_ABAST"."OBS"'
      Size = 200
    end
    object QBuscaItensV_UNIT: TFMTBCDField
      FieldKind = fkInternalCalc
      FieldName = 'V_UNIT'
      Origin = '"VEICULO_ABAST"."V_UNIT"'
      ProviderFlags = []
      ReadOnly = True
      Precision = 18
      Size = 6
    end
    object QBuscaItensKM_L: TIBBCDField
      FieldName = 'KM_L'
      Origin = '"VEICULO_ABAST"."KM_L"'
      Precision = 18
      Size = 2
    end
    object QBuscaItensKM_ROD: TIntegerField
      FieldName = 'KM_ROD'
      Origin = '"VEICULO_ABAST"."KM_ROD"'
    end
  end
