...
uses
  ...
  Dialogs, DBCtrls, StdCtrls, RXDBCtrl, Mask,  Mylabel,
  Grids, DBGrids, ExtCtrls,  SUIDBCtrls,  RXCtrls,
  SUIButton, FMTBcd, DB, DBClient, SqlExpr, SUIDlg, sPanel,
  sDBNavigator, Buttons, sBitBtn, acDBGrid, sMaskEdit, sCustomComboEdit,
  sTooledit, RxToolEdit, RxCurrEdit;
                    ...
                    if DM.IBTransaction.Active then
                     ...
                     with DM.IBSQL do
                      begin
                         Close;
                         SQL.Clear;
                         SQL.Add('UPDATE crediario set SITUACAO=''P'' where codigo =:cod');
                         ParamByName('cod').AsInteger := dmcob.CDS_Cobranca1codigo.asinteger;
                         ExecQuery;
                     end;
