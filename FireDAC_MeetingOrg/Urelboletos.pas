...
CLI :=Cliente.Text;
    ...
    dmcob.qrycobranca1.SQL.add('select * from CREDIARIO where BANCO_PORTADOR > 0 and DATA_VENCIMENTO >='+QuotedStr(FormatDateTime('mm/dd/yyyy',StrToDate(VCLI1)))+' and DATA_VENCIMENTO <='+QuotedStr(FormatDateTime('mm/dd/yyyy',StrToDate(VCLI2)))+'');
    if port > '' then
