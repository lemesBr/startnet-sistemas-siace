...
uses
  ...
  RLRichFilter, RLHTMLFilter, XDBGrids, TaskDialog, sDBNavigator, sBitBtn,
  sPanel, sMaskEdit, sComboBox, sEdit, sLabel, FDvSmoothMessageDialog,
  CurrEdit, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error,
