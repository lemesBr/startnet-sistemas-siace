...
uses
  ...
  Dialogs, StdCtrls, Grids, DB, DBClient, Provider, ExtCtrls, SUITitleBar;

const
  ActionStr: array[TReconcileAction] of string = ('Pular', 'Abortar', 'Juntar',
    'Corrigir', 'Cancelar', 'Atualizar');
  UpdateKindStr: array[TUpdateKind] of string = ('Modificando', 'Inserindo',
    'Deletando');
  SCaption = 'Erros - %s';
...
procedure TReconcileErrorForm.FDjustColumnWidths;
var
  NewWidth, I: integer;
begin
  with UpdateData do
