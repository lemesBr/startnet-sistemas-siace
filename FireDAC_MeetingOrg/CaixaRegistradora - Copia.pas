...
uses
  ...
  ToolEdit, Grids, DBGrids,  DB, DBClient, SimpleDS, DBCtrls,
  RXDBCtrl, DBXpress, FMTBcd, Provider, SqlExpr, Buttons, acDBGrid,
  sSpeedButton, sDBEdit, sPanel, sDBNavigator, sMaskEdit, sCustomComboEdit,
  sTooledit, sDBDateEdit, sBitBtn,  TaskDialog, RXCtrls;
...
uses Principal, BancoAnalitico, BancoEspecifico, DepositosBanco,
