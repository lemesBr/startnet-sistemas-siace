...
type
  TForminventario = class(TForm)
    ...
    QrysaldoESTOQUE_ANTERIOR: TBCDField;
    QrysaldoQUANTIDADE: TBCDField;
    QrysaldoESTOQUE_POSTERIOR: TBCDField;
         ...
         TRY
            ...
            //  SPC_Inv.Params[7].text  := dm1.SDS_V_INVENTARIODESCRICAO.Text;
             ...
             // SPC_Inv.Params[9].text  :=  dm1.SDS_V_INVENTARIOCOD_BARRAS.Text;
              ...
              DM.Sds_produtos.DataSet.CommandText:= 'select * from PRODUTOS ORDER BY CODIGO ASC';
