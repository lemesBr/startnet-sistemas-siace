...
type
  TFrmGerenciamentoNFce = class(TForm)
    ...
    QConsNfeTP: TIBStringField;
    QConsNfeSERIE_NF: TIBStringField;
    QConsNfeCD_EMPRESA: TIntegerField;
    QConsNfeFL_IMPRESSO: TIBStringField;
    QConsNfeCD_CFOP: TIntegerField;
    QConsNfeDT_LANCAMENTO: TDateField;
    QConsNfeVL_ACRESCIMOS: TIBBCDField;
    QConsNfeVL_DESCONTOS: TIBBCDField;
    QConsNfeVL_MERCADORIAS: TIBBCDField;
    QConsNfeVL_SERVICOS: TIBBCDField;
    QConsNfeCOD_PGTO: TIntegerField;
    QConsNfeVL_AVISTA: TIBBCDField;
    QConsNfeVL_PRAZO: TIBBCDField;
    QConsNfePESO_TOTAL: TIBBCDField;
    QConsNfeQT_PECAS: TIBBCDField;
    QConsNfeCFOP_DESC: TIBStringField;
    QConsNfeCD_TRANSPORTADORA: TIntegerField;
    QConsNfeUF_ORIGEM: TIBStringField;
    QConsNfeUF_DESTINO: TIBStringField;
    QConsNfePESO_LIQUIDO: TIBBCDField;
    QConsNfeVL_FRETE: TIBBCDField;
    QConsNfeVL_SEGURO: TIBBCDField;
    QConsNfeVL_BASE_ICM: TIBBCDField;
    QConsNfeVL_ICM: TIBBCDField;
    QConsNfeVL_BASE_ICM_SUBST: TIBBCDField;
    QConsNfeVL_ICM_SUBST: TIBBCDField;
    QConsNfeVL_IPI: TIBBCDField;
    QConsNfeVL_ISS: TIBBCDField;
    QConsNfeTP_FRETE: TIBStringField;
    QConsNfeQT_VOLUMES: TIBBCDField;
    QConsNfeESPECIE_VOLUMES: TIBStringField;
    QConsNfeMARCA_VOLUMES: TIBStringField;
    ...
    QConsNfePLACA_TRANSP: TIBStringField;
    QConsNfeUF_PLACA_TRANSP: TIBStringField;
    QConsNfeVL_OUTROS: TIBBCDField;
    QConsNfeNR_PEDIDO: TIntegerField;
    QConsNfeVL_BASE_PIS: TIBBCDField;
    QConsNfeVL_PIS: TIBBCDField;
    QConsNfeVL_BASE_COFINS: TIBBCDField;
    QConsNfeVL_COFINS: TIBBCDField;
    QConsNfeVL_BASE_IPI: TIBBCDField;
    QConsNfeVL_BASE_ISS: TIBBCDField;
    QConsNfeVL_DESCONTO_ITEM: TIBBCDField;
    QConsNfeVL_ISENTO_ITENS: TIBBCDField;
    QConsNfeVL_OUTROS_ITENS: TIBBCDField;
    QConsNfeDT_PROCESSAMENTO_NFE: TDateField;
    QConsNfeNR_LOTE_NFE: TIBStringField;
    QConsNfeVL_FRETE_CONHECIMENTO: TIBBCDField;
    QConsNfeVL_ST_CONHECIMENTO: TIBBCDField;
    QConsNfeVL_ICM_CONHECIMENTO: TIBBCDField;
    QConsNfeBASE_ICM_PROPRIO_ST: TIBBCDField;
    QConsNfeVL_ICM_PROPRIO_ST: TIBBCDField;
    QConsNfeVL_BASE_ICM_SUBST_REAL: TIBBCDField;
    QConsNfeVL_ICM_SUBST_REAL: TIBBCDField;
    QConsNfeCNPJ_TRANSP: TIBStringField;
    QConsNfeNOME_TRANSP: TIBStringField;
    QConsNfeIE_TRANSP: TIBStringField;
    QConsNfeEND_TRANSPORTADOR: TIBStringField;
    QConsNfeCIDADE_TRANSP: TIBStringField;
    QConsNfeUF_TRANSP: TIBStringField;
    QConsNfeN_NOTA_ENTRADA: TIBStringField;
    QConsNfeCPF_CNPJ_CLIENTE_FORN: TIBStringField;
    QConsNfeIE_CLIENTE_FORN: TIBStringField;
    QConsNfeENDERECO_CLI_FORN: TIBStringField;
    QConsNfeEND_NUM_CLIENTE: TIBStringField;
    QConsNfeCOD_IBGE: TIBStringField;
    QConsNfeCEP_CLIENTE_FORN: TIBStringField;
    QConsNfeBAIRRO_CLIENTE_FORN: TIBStringField;
    QConsNfeTIPO_PESSOA: TIBStringField;
    QConsNfeTELEFONE: TIBStringField;
    QConsNfeCIDADE_CLIENTE_FORN: TIBStringField;
    QConsNfeUF_CLIENTE_FORN: TIBStringField;
    QConsNfeIE_PRODUTOR: TIBStringField;
    QConsNfePRODUTOR_RURAL: TIBStringField;
    QConsNfePAGAMENTO: TIBStringField;
    QConsNfeSTATUS_RETORNO: TIBStringField;
    QConsNfeJUSTIFICATIVA_CANCEL_INUTIL: TIBStringField;
    QConsNfeMODELO: TIBStringField;
    ...
    Image12: TImage;
    Label3: TLabel;
    TRVendasoff: TIBTransaction;
    QVendasOFFLINE: TIBQuery;
...
begin
  ...
  memo1.lines.add('Serviço......');
  memo1.lines.add('Status: ' + dm.acbrnfe1.webservices.statusservico.xmotivo);
end;
          ...
          with Det.Items[I] do
           begin
             ...
             // codigo:= prod.cEAN;
              ...
              DM.Sds_produtos.DataSet.CommandText:= 'select * from PRODUTOS where Codigo =' + prod.cProd + 'ORDER BY DESCRICAO';
