...
uses
  ...
  AlignEdit, RxPlacemnt, RxToolEdit, RxCurrEdit;
...
type
  TFrmAlteraPreco = class(TForm)
    ...
    QConsProdCODIGO_BARRAS: TIBStringField;
    QConsProdATIVO: TIBStringField;
    QConsProdDESCRICAO: TIBStringField;
    ...
    QConsProdPRECO_VENDA: TIBBCDField;
    QConsProdPRECO_PROMOCAO: TIBBCDField;
    QConsProdESTOQUE_MINIMO: TIntegerField;
    QConsProdVALIDADE: TDateField;
    QConsProdICMS: TIBBCDField;
    QConsProdMARGEM_LUCRO2: TIBBCDField;
    QConsProdIPI_IRPJ: TIBBCDField;
    QConsProdSIT_TRIBUTARIA: TIBStringField;
    QConsProdOUTROS_IMPOSTOS: TIBBCDField;
    QConsProdPRECO_CUSTO: TIBBCDField;
    QConsProdMARGEM_LUCRO: TIBBCDField;
    QConsProdPRECO_VENDA2: TIBBCDField;
    QConsProdVALIDADE_PRODUTO: TIBStringField;
    QConsProdDESC_SECCAO: TIBStringField;
    QConsProdDESC_GRUPO_TRIBUTACAO: TIBStringField;
    QConsProdUNIDADE: TIBStringField;
    QConsProdDESC_LOCAL_ESTOQUE: TIBStringField;
    QConsProdESTOQUE: TIBBCDField;
    QConsProdNOME_GRUPO: TIBStringField;
    QConsProdNOME_SUBGRUPO: TIBStringField;
    QConsProdPERC_ALIQUOTA_PIS: TIBBCDField;
    QConsProdPERC_ALIQUOTA_COFINS: TIBBCDField;
    QConsProdFLAG_PIS_COFINS: TIBStringField;
    QConsProdCALC_PIS_COFINS: TStringField;
    QConsProdREFERENCIA: TIBStringField;
    QConsProdNCM_SH: TIBStringField;
...
uses ModulodeDados, Ubibli1, UAltPreco, UUltimaCompra, UAlterarSecaoGrupo, UProdutosComposicao,
     UConsLab,
     UFormacaoPreco, UConsGRP, UConsLocaisEstoque, ConsGrupos,
...
begin
   sScript:=  'SELECT P.CODIGO, P.CODIGO_BARRAS, P.ATIVO, P.DESCRICAO, P.ESTOQUE, P.SECCAO, P.CODIGO_GRUPO, P.CODIGO_SUBGRUPO, P.CODIGO_LOCAL_ESTOQUE, P.PRECO_VENDA, ' +
              'P.PRECO_PROMOCAO, P.ESTOQUE_MINIMO, P.VALIDADE, P.ICMS, P.MARGEM_LUCRO2, P.REFERENCIA, ' +
      ...
      begin
       ...
       {  sql.Text:= 'SELECT * ' +
        ...
        // Parambyname('datafin').AsDate   := date;
         sql.Text:= sScript;
         Parambyname('codemp').AsInteger := dm.SDS_EmpresaCODIGO.AsInteger;
         open;
