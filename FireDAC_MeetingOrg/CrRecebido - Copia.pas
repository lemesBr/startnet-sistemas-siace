...
uses
  ...
  Dialogs, Grids, XDBGrids, ExtCtrls, StdCtrls, Mask, ToolEdit,
  Mylabel, SUIButton, FMTBcd, DB, SqlExpr, sPanel, Buttons, sBitBtn,
...
begin
    ...
    begin
    Spc_crediario_Recebido.Params[0].AsInteger := DMB.Cds_crediario_RecebidoCOD_CREDIAIRIO.Value;
    Spc_crediario_Recebido.Params[1].Value     := 0;
    Spc_crediario_Recebido.Params[2].Value     := 0;
    Spc_crediario_Recebido.Params[3].Value     := DMB.Cds_crediario_RecebidoVALOR_PAGO.Text;
