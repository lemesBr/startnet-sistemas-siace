...
uses
  ...
  Dialogs, Menus, StdCtrls, Buttons, Mask, ExtCtrls,
  RpDefine, RpCon, RpConDS, DB, ZAbstractRODataset, ZAbstractDataset,
  ZDataset, rxToolEdit, NxCollection, ToolEdit;

type
  TFrmlista_caixa = class(TForm)
    Panel1: TPanel;
    ViewSplit2: TNxSplitter;
    HeaderView1: TNxHeaderPanel;
    FlipView1: TNxFlipPanel;
    rfolha: TRadioButton;
