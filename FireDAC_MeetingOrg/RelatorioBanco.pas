...
uses
  ...
  FireDAC.DApt, DB, FireDAC.Comp.DataSet, FireDAC.Comp.Client, Mylabel,
  AdvGlowButton, RxToolEdit, AdvReflectionImage;
...
DMR.RvRelatorios.Execute;
 ...
 begin
  ...
  dm.qrrelatorio.fieldbyname('LINHA2').asstring := 'PERÍODO DO EXTRATO BANCÁRIO: ' + DATEEDIT3.TEXT + ' A ' + DATEEDIT4.TEXT;
    ...
    fxcontacorrente.LoadFromFile('\siace\rel\EXTRATO.fr3');
