object FormLancPlcontas: TFormLancPlcontas
  Left = 400
  Top = 241
  BorderStyle = bsDialog
  Caption = 'Lan'#231'amento no Plano de Contas'
  ClientHeight = 233
  ClientWidth = 625
  Color = clBtnFace
  ...
  object FDvPanel1: TAdvPanel
    ...
    object RxCalcEdit1: TRxCalcEdit
      ...
      NumGlyphs = 1
      TabOrder = 3
      OnKeyPress = RxCalcEdit1KeyPress
    end
  ...
  object qrcontaspagar: TFDQuery
    ...
    SQL.Strings = (
      'select * from CONTAS_APAGAR_PLANO  where CODIGO_ID = :ID ')
    Left = 328
    Top = 130
    ParamData = <
      item
    ...
    object qrcontaspagarSEQ: TIntegerField
      FieldName = 'SEQ'
      Origin = 'SEQ'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object qrcontaspagarCODPLANO: TIntegerField
      FieldName = 'CODPLANO'
      Origin = 'CODPLANO'
      Required = True
    end
    object qrcontaspagarCODIGO_ID: TIntegerField
      FieldName = 'CODIGO_ID'
      Origin = 'CODIGO_ID'
      Required = True
    end
  ...
  object FDvPopupMenu1: TAdvPopupMenu
    Version = '2.6.2.1'
    Left = 304
    Top = 96
    object a1: TMenuItem
