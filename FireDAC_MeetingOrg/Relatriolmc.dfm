object FormrelatLmc: TFormrelatLmc
  ...
  object QryMaster: TIBQuery
    ...
    object QryMasterENCERRANTE: TIntegerField
      ...
      Origin = '"LMC"."ENCERRANTE"'
    end
    object QryMasterCOMBUSTIVEL: TIntegerField
      FieldName = 'COMBUSTIVEL'
      Origin = '"LMC"."COMBUSTIVEL"'
    end
    object QryMasterDATA: TDateField
      FieldName = 'DATA'
      Origin = '"LMC"."DATA"'
    end
    object QryMasterPRECO: TIBBCDField
      FieldName = 'PRECO'
      Origin = '"LMC"."PRECO"'
      Precision = 18
      Size = 3
    end
    object QryMasterQUANTIDADE: TIBBCDField
      FieldName = 'QUANTIDADE'
      Origin = '"LMC"."QUANTIDADE"'
      Precision = 18
      Size = 3
    end
    object QryMasterTOTAL: TIBBCDField
      FieldName = 'TOTAL'
      Origin = '"LMC"."TOTAL"'
      Precision = 18
      Size = 3
    ...
    object QryMasterNOTAFISCAL1: TIBStringField
      FieldName = 'NOTAFISCAL1'
      Origin = '"LMC"."NOTAFISCAL1"'
      Size = 10
    end
    object QryMasterNOTAFISCAL2: TIBStringField
      FieldName = 'NOTAFISCAL2'
      Origin = '"LMC"."NOTAFISCAL2"'
      Size = 10
    end
    object QryMasterNOTAFISCAL3: TIBStringField
      FieldName = 'NOTAFISCAL3'
      Origin = '"LMC"."NOTAFISCAL3"'
      Size = 10
    end
    object QryMasterNOTAFISCAL4: TIBStringField
      FieldName = 'NOTAFISCAL4'
      Origin = '"LMC"."NOTAFISCAL4"'
      Size = 10
    end
    ...
    object QryMasterID_BICO1: TIBStringField
      FieldName = 'ID_BICO1'
      Origin = '"LMC"."ID_BICO1"'
      Size = 2
    end
    object QryMasterID_BICO2: TIBStringField
      FieldName = 'ID_BICO2'
      Origin = '"LMC"."ID_BICO2"'
      Size = 2
    end
    object QryMasterID_BICO3: TIBStringField
      FieldName = 'ID_BICO3'
      Origin = '"LMC"."ID_BICO3"'
      Size = 2
    end
    object QryMasterID_BICO4: TIBStringField
      FieldName = 'ID_BICO4'
      Origin = '"LMC"."ID_BICO4"'
      Size = 2
    end
    object QryMasterID_BICO5: TIBStringField
      FieldName = 'ID_BICO5'
      Origin = '"LMC"."ID_BICO5"'
      Size = 2
    end
    object QryMasterID_BICO6: TIBStringField
      FieldName = 'ID_BICO6'
      Origin = '"LMC"."ID_BICO6"'
      Size = 2
    end
    object QryMasterID_BICO7: TIBStringField
      FieldName = 'ID_BICO7'
      Origin = '"LMC"."ID_BICO7"'
      Size = 2
    end
    object QryMasterID_BICO8: TIBStringField
      FieldName = 'ID_BICO8'
      Origin = '"LMC"."ID_BICO8"'
      Size = 2
    end
    ...
    object QryMasterDISPONIVEL_DIA: TLargeintField
      ...
      Origin = '"LMC"."DISPONIVEL_DIA"'
      ProviderFlags = []
      ReadOnly = True
    end
    object QryMasterTOTALVENDAS_DIA: TIBBCDField
      FieldKind = fkInternalCalc
      FieldName = 'TOTALVENDAS_DIA'
      Origin = '"LMC"."TOTALVENDAS_DIA"'
      ProviderFlags = []
      ReadOnly = True
      Precision = 18
      Size = 3
    end
    object QryMasterTOTALVENDAS_ACU: TIBBCDField
      FieldName = 'TOTALVENDAS_ACU'
      Origin = '"LMC"."TOTALVENDAS_ACU"'
      Precision = 18
      Size = 3
    end
  end
  ...
  object Qry_abert: TIBQuery
    ...
    object Qry_abertCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = '"LMC_ABERFECH"."CODIGO"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object Qry_abertCOD_FILIAL: TIBStringField
      FieldName = 'COD_FILIAL'
      Origin = '"LMC_ABERFECH"."COD_FILIAL"'
      Size = 6
    end
    object Qry_abertFILIAL: TIBStringField
      FieldName = 'FILIAL'
      Origin = '"LMC_ABERFECH"."FILIAL"'
      Size = 50
    end
    object Qry_abertENDERECO: TIBStringField
      FieldName = 'ENDERECO'
      Origin = '"LMC_ABERFECH"."ENDERECO"'
      Size = 60
    end
    object Qry_abertBAIRRO: TIBStringField
      FieldName = 'BAIRRO'
      Origin = '"LMC_ABERFECH"."BAIRRO"'
      Size = 30
    end
    object Qry_abertCEP: TIBStringField
      FieldName = 'CEP'
      Origin = '"LMC_ABERFECH"."CEP"'
      Size = 9
    end
    object Qry_abertCIDADE: TIBStringField
      FieldName = 'CIDADE'
      Origin = '"LMC_ABERFECH"."CIDADE"'
      Size = 30
    end
    object Qry_abertUF: TIBStringField
      FieldName = 'UF'
      Origin = '"LMC_ABERFECH"."UF"'
      Size = 2
    end
    object Qry_abertIE: TIBStringField
      FieldName = 'IE'
      Origin = '"LMC_ABERFECH"."IE"'
      Size = 14
    end
    object Qry_abertCNPJ: TIBStringField
      FieldName = 'CNPJ'
      Origin = '"LMC_ABERFECH"."CNPJ"'
      Size = 25
    end
    object Qry_abertIM: TIBStringField
      FieldName = 'IM'
      Origin = '"LMC_ABERFECH"."IM"'
    end
    object Qry_abertDISTRIBUIDORA: TIBStringField
      FieldName = 'DISTRIBUIDORA'
      Origin = '"LMC_ABERFECH"."DISTRIBUIDORA"'
      Size = 50
    end
    object Qry_abertCAPACIDADE: TIntegerField
      FieldName = 'CAPACIDADE'
      Origin = '"LMC_ABERFECH"."CAPACIDADE"'
    end
    object Qry_abertCOD_COMBUSTIVEL: TIntegerField
      FieldName = 'COD_COMBUSTIVEL'
      Origin = '"LMC_ABERFECH"."COD_COMBUSTIVEL"'
    end
    object Qry_abertNOME_COMBUSTIVEL: TIBStringField
      FieldName = 'NOME_COMBUSTIVEL'
      Origin = '"LMC_ABERFECH"."NOME_COMBUSTIVEL"'
      Size = 30
    end
    object Qry_abertNUMERO: TIBStringField
      FieldName = 'NUMERO'
      Origin = '"LMC_ABERFECH"."NUMERO"'
      Size = 10
    end
    object Qry_abertNUMERO_JUNTACOM: TIBStringField
      FieldName = 'NUMERO_JUNTACOM'
      Origin = '"LMC_ABERFECH"."NUMERO_JUNTACOM"'
      Size = 10
    end
    object Qry_abertDATA_ABERTURA: TDateField
      FieldName = 'DATA_ABERTURA'
      Origin = '"LMC_ABERFECH"."DATA_ABERTURA"'
    end
    object Qry_abertNUMERO_ORDEM: TIntegerField
      FieldName = 'NUMERO_ORDEM'
      Origin = '"LMC_ABERFECH"."NUMERO_ORDEM"'
    end
    object Qry_abertPAGINA_ATUAL: TIntegerField
      FieldName = 'PAGINA_ATUAL'
      Origin = '"LMC_ABERFECH"."PAGINA_ATUAL"'
    end
  end
