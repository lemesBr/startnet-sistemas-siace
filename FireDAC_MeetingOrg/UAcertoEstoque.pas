...
uses
  ...
  rxToolEdit, rxCurrEdit, SUIButton, aDvGlowButton, Mylabel, acPNG, acDBGrid,
  aDvPanel;
...
begin
   ...
   with dm.QConsulta do
      begin
         close;
         sql.Clear;
         sql.Text:= 'UPDATE PRODUTOS SET VALIDADE = :DATA, PRECO_CUSTO =:CUSTO, PRECO_VENDA = :VENDA, PRECO_VENDA2 = :VENDA2 ' +
                    'WHERE CODIGO = :CODPRO';
