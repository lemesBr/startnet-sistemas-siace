...
uses
  ...
  SUIButton, ExtCtrls, StdCtrls, Mylabel, RpRenderText, Mask, sMaskEdit,
...
type
  TFormInv = class(TForm)
    ...
    qrinventarioPRECO_CUSTO: TBCDField;
    qrinventarioPRECO_VENDA: TBCDField;
    ...
    qrinventarioCUSTO_MEDIO: TBCDField;
    ...
    QRINVENTARIO31QTD_ITEN: TBCDField;
    QRINVENTARIO31VLR_UNIT: TBCDField;
    QRINVENTARIO31VL_ITEM_TOTAL: TBCDField;
