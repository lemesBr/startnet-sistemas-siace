...
uses
  ...
  ZDataset, Menus, frxClass, frxDBSet, frxDesgn, frxBarcode,
  ComCtrls, wwdbedit, FDvGlowButton, RzEdit, ToolEdit, NxCollection,
...
type
  Tfrmetiquetador = class(TForm)
    ...
    pimprimir: TNxHeaderPanel;
    HeaderView2: TNxHeaderPanel;
    ComboBox1: TComboBox;
    Label8: TLabel;
    Label9: TLabel;
    ...
    Pimport: TNxHeaderPanel;
    HeaderView3: TNxHeaderPanel;
    bar: TProgressBar;
    ...
    qrremarcados: TFDQuery;
    pperiodo: TNxHeaderPanel;
    HeaderView4: TNxHeaderPanel;
    Label11: TLabel;
    Label1: TLabel;
    Label2: TLabel;
    DateEdit1: TDateEdit;
    ...
    Bevel1: TBevel;
    bok: TAdvGlowButton;
    pdesconto: TNxHeaderPanel;
    HeaderView5: TNxHeaderPanel;
...
begin
 ...
 begin
    ...
    ASSIGNFILE(F,'c:\siace\etiqueta.prn');
    REWRITE(F);
    WRITELN(F,'c0000');
    WRITELN(F,'KI503');
    WRITELN(F,'O0220');
...
//        qa := qa + 1;
      ...
      assignfile(txt,'c:\siace\etiqueta.prn');
      reset(txt);
...
//        qa := qa + 1;
  ...
  begin
    ...
    if combobox1.ItemIndex = 2 then
    begin
      fXproduto.LoadFromFile('\siscom\server\rel\f000077.fr3');
...
begin
    ...
    IF dm.sds_produtos.LOCATE('CODBARRA',COMBOCODIGO.TEXT,[loCaseInsensitive]) THEN
    BEGIN
...
begin
  if combobox1.ItemIndex = 2 then
  begin
    fXproduto.LoadFromFile('\siace\rel\f000077.fr3');
...
begin
  ...
  IF resultado_pesquisa1 <> '' THEN
    BEGIN
      ...
      Query.SQL.add('notasfiscais_itens e,c000025 p where e.notafiscal = '''+RESULTADO_PESQUISA1+''' and');
