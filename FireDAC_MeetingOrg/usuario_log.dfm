object frmusuario_log: Tfrmusuario_log
  Left = 463
  Top = 184
  Caption = 'SIACE .:: LOG DE ACESSO AO SISTEMA ::.'
  ClientHeight = 443
  ClientWidth = 758
  Color = clBtnFace
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Selected.Strings = (
      ...
      'HORA'#9'7'#9'HORA'#9#9
      'CODUSUARIO'#9'11'#9'C'#211'DIGO'#9'F'
      'USUARIO'#9'20'#9'USU'#193'RIO'#9'F'
  ...
  object FXLOG: TfrxReport
    ...
    ReportOptions.LastChange = 41496.625154583340000000
  ...
  object QRLOG: TIBQuery
    ...
    SQL.Strings = (
      'SELECT '
      'log.*,'
      'USUARIOS.CODIGO, USUARIOS.USUARIO'
      'FROM'
      'LOG,'
      'USUARIOS'
      'WHERE'
      'LOG.CODUSUARIO = USUARIOS.CODIGO')
    Left = 352
    Top = 168
    ...
    object QRLOGHORA: TIBStringField
      FieldName = 'HORA'
      Origin = 'LOG.HORA'
      Size = 10
    end
    object QRLOGCODUSUARIO: TIntegerField
      FieldName = 'CODUSUARIO'
      Origin = 'LOG.CODUSUARIO'
    end
    object QRLOGTABELA: TIBStringField
      FieldName = 'TABELA'
      Origin = 'LOG.TABELA'
      Size = 10
    end
    object QRLOGCODREGISTRO: TIBStringField
      FieldName = 'CODREGISTRO'
      Origin = 'LOG.CODREGISTRO'
      Size = 10
    end
    object QRLOGFUNCAO: TIBStringField
      FieldName = 'FUNCAO'
      Origin = 'LOG.FUNCAO'
      Size = 10
    end
    object QRLOGHISTORICO: TIBStringField
      FieldName = 'HISTORICO'
      Origin = 'LOG.HISTORICO'
      Size = 150
    end
    object QRLOGCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'USUARIOS.CODIGO'
      Required = True
    end
    object QRLOGUSUARIO: TIBStringField
      FieldName = 'USUARIO'
