...
type
  TFormRelCaixaEsp = class(TForm)
    ...
    procedure RLLabel87AfterPrint(Sender: TObject);
...
procedure TFormRelCaixaEsp.RLLabel87AfterPrint(Sender: TObject);
begin
RLLabel87.Caption:= FormatFloat('R$: ##,##0.00',FormCaixaEspecifico.CurrencyEdit13.Value);

end;

procedure TFormRelCaixaEsp.RLReport1PageStarting(Sender: TObject);
begin
 saldo_atual.Caption:= FormatFloat('R$: ##,##0.00',FormCaixaEspecifico.CurrencyEdit7.Value);
 inicial.Caption := FormatFloat('R$: ##,##0.00',FormCaixaEspecifico.SALDO_INI);
 entradas.Caption := FormatFloat('R$: ##,##0.00',FormCaixaEspecifico.ENTRADA);
 saidas.Caption := FormatFloat('R$: ##,##0.00',FormCaixaEspecifico.saida);
end;
