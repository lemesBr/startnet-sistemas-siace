...
uses
  ...
  AlignEdit, IBDatabase, IBSQL, Mask, Grids, DBGrids,
  DB, IBCustomDataSet, IBQuery, pngimage, RxToolEdit, RxCurrEdit, AdvGlowButton,
  AdvPanel;
...
type
  TFrmCadAdmCartaoCredito = class(TFrmCadastroNovo)
    ...
    Label4: TLabel;
    EdtDiasCredito: TAlignEdit;
    Label7: TLabel;
    EdtDiasDebito: TAlignEdit;
    Label30: TLabel;
    Label9: TLabel;
    ...
    QBandeirasDESCRICAO: TIBStringField;
    QBandeirasATIVO: TIBStringField;
    QBandeirasDIAS_CREDITO: TIntegerField;
    QBandeirasDIAS_DEBITO: TIntegerField;
    QBandeirasTIPO_CARTAO: TIBStringField;
    QBandeirasCALC_TIPO: TStringField;
    EdtCodTEFBandeira: TEdit;
    QBandeirasCODIGO_TEF: TIBStringField;
    Image1: TImage;
    Panel5: TPanel;
    Label2: TLabel;
    Label1: TLabel;
    ...
    EdtNome: TEdit;
    EdtCodTEF: TEdit;
    QBandeirasTAXA_CREDITO: TFloatField;
    QBandeirasTAXA_DEBITO: TFloatField;
...
begin
  ...
  try
    try
      ...
      IBTRAdm.Rollback;
      showmessage('Erro ao Gravar a Administradora');
    end;
  finally
    IBSQLAdm.Close;
    LimpaBandeiras;
...
begin
  ...
  try
    try
      ...
      IBTRAdm.Rollback;
      showmessage('Erro ao Gravar a Bandeira');
    end;
  finally
    IBSQLAdm.Close;
  end;
