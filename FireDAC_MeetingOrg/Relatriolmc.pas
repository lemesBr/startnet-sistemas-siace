...
uses
  ...
  SimpleDS, Data.DBXFirebird, RxToolEdit;
...
type
  TFormrelatLmc = class(TForm)
    ...
    QryMasterPRECO: TIBBCDField;
    QryMasterQUANTIDADE: TIBBCDField;
    QryMasterTOTAL: TIBBCDField;
    QryMasterSITUACAO: TIntegerField;
    QryMasterNR_NOTA: TIntegerField;
    QryMasterNOTAFISCAL1: TIBStringField;
    QryMasterNOTAFISCAL2: TIBStringField;
    QryMasterNOTAFISCAL3: TIBStringField;
    QryMasterNOTAFISCAL4: TIBStringField;
    ...
    QryMasterTOTALVEND_1: TIBBCDField;
    QryMasterTOTALVEND_2: TIBBCDField;
    QryMasterTOTALVEND_3: TIBBCDField;
    QryMasterTOTALVEND_4: TIBBCDField;
    QryMasterTOTALVEND_5: TIBBCDField;
    QryMasterTOTALVEND_6: TIBBCDField;
    QryMasterTOTALVEND_7: TIBBCDField;
    QryMasterTOTALVEND_8: TIBBCDField;
    ...
    QryMasterOBSERVACAO: TIBStringField;
    QryMasterPAGINA: TIntegerField;
    QryMasterID_BICO1: TIBStringField;
    QryMasterID_BICO2: TIBStringField;
    QryMasterID_BICO3: TIBStringField;
    QryMasterID_BICO4: TIBStringField;
    QryMasterID_BICO5: TIBStringField;
    QryMasterID_BICO6: TIBStringField;
    QryMasterID_BICO7: TIBStringField;
    QryMasterID_BICO8: TIBStringField;
    QryMasterVENDAS_DIA: TLargeintField;
    QryMasterRECEBIDO_DIA: TLargeintField;
    QryMasterDISPONIVEL_DIA: TLargeintField;
    QryMasterTOTALVENDAS_DIA: TIBBCDField;
    QryMasterTOTALVENDAS_ACU: TIBBCDField;
    Qry_abert: TIBQuery;
    DataSource1: TDataSource;
    Qry_abertCODIGO: TIntegerField;
    Qry_abertCOD_FILIAL: TIBStringField;
    Qry_abertFILIAL: TIBStringField;
    Qry_abertENDERECO: TIBStringField;
    Qry_abertBAIRRO: TIBStringField;
    Qry_abertCEP: TIBStringField;
    Qry_abertCIDADE: TIBStringField;
    Qry_abertUF: TIBStringField;
    Qry_abertIE: TIBStringField;
    Qry_abertCNPJ: TIBStringField;
    Qry_abertIM: TIBStringField;
    Qry_abertDISTRIBUIDORA: TIBStringField;
    Qry_abertCAPACIDADE: TIntegerField;
    Qry_abertCOD_COMBUSTIVEL: TIntegerField;
    Qry_abertNOME_COMBUSTIVEL: TIBStringField;
    Qry_abertNUMERO: TIBStringField;
    Qry_abertNUMERO_JUNTACOM: TIBStringField;
