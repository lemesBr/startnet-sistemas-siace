object frmlista_Contabil: Tfrmlista_Contabil
  Left = 439
  Top = 233
  BorderIcons = [biSystemMenu]
  BorderStyle = bsToolWindow
  Caption = 'Cont'#225'bil | Relat'#243'rios'
  ClientHeight = 158
  ClientWidth = 398
  Color = clBtnFace
  ...
  object combo_relatorio: TComboBox
    ...
    ItemIndex = 1
    TabOrder = 0
    Text = 'RELA'#199#195'O SINT'#201'TICA - PLANO CONTAS'
    Items.Strings = (
      'RELA'#199#195'O ANALITICA - PLANO CONTAS'
      'RELA'#199#195'O SINT'#201'TICA - PLANO CONTAS')
  end
  ...
  object fxcontabil: TfrxReport
    ...
    ReportOptions.LastChange = 42476.742621527780000000
    ...
    object Page1: TfrxReportPage
      ...
      object DetailData1: TfrxDetailData
        ...
        object Memo1: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[fscontabil1."COD_COMPLETO"] - [fscontabil1."NOME"]')
          ParentFont = False
          Formats = <
            item
            end
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo9: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<fsContabil1."ENTRADA">,DetailData1)]')
          ParentFont = False
        end
        object Memo10: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[SUM(<fsContabil1."SAIDA">,DetailData1)]')
          ParentFont = False
        end
        ...
        object Memo12: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[SUM(<fsContabil1."ENTRADA">,DetailData1) - SUM(<fsContabil1."SA' +
              'IDA">,DetailData1)]')
          ParentFont = False
          Formats = <
            item
  ...
  object qrcontabil: TFDQuery
    Active = True
    Connection = DM.Coneccao
    SQL.Strings = (
      'select * from SP_PLANO_SINTETICO(:datai, :dataf)')
    Left = 24
    Top = 72
    ParamData = <
      item
    ...
    object qrcontabilCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'CODIGO'
    end
    object qrcontabilNOME: TStringField
      FieldName = 'NOME'
      Origin = 'NOME'
      Size = 70
    end
    object qrcontabilCOD_COMPLETO: TStringField
      FieldName = 'COD_COMPLETO'
      Origin = 'COD_COMPLETO'
    end
    object qrcontabilENTRADA: TBCDField
      FieldName = 'ENTRADA'
      Origin = 'ENTRADA'
      currency = True
      Precision = 18
    ...
    object qrcontabilSAIDA: TBCDField
      FieldName = 'SAIDA'
      Origin = 'SAIDA'
      currency = True
      Precision = 18
    ...
    object qrcontabilVALOR: TBCDField
      FieldName = 'VALOR'
      Origin = 'VALOR'
      currency = True
      Precision = 18
  ...
  object qrnivel1: TFDQuery
    ...
    object qrnivel1ENTRADA: TBCDField
      FieldName = 'ENTRADA'
      Origin = 'ENTRADA'
      currency = True
      Precision = 18
    ...
    object qrnivel1SAIDA: TBCDField
      FieldName = 'SAIDA'
      Origin = 'SAIDA'
      currency = True
      Precision = 18
    ...
    object qrnivel1DATA: TDateField
      FieldName = 'DATA'
      Origin = '"DATA"'
    end
    object qrnivel1VALOR: TBCDField
      FieldName = 'VALOR'
      Origin = 'VALOR'
      currency = True
      Precision = 18
