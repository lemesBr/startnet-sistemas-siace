...
uses
  ...
  FDvOfficeStatusBar, wwdblook, RzEdit,
  RzDBEdit, RzDBBnEd, RXDBCtrl, RzLabel, FDvGlowButton,
  FDvToolBar, FDvToolBarStylers, FDvPreviewMenu,
  Grids, Wwdbigrd, Wwdbgrid, ImgList, RzPanel, RzCmboBx, ACBrNFe, pcnConversao, pcnConversaoNFe,
  pcnNFeRTXT, ACBrBase, DB,ACBrNFeNotasFiscais, DateUtils, FDvOfficeStatusBarStylers
...
{$ENDIF}
{$IFDEF VER180}
    , XPMan, DB, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error,
  FireDAC.DatS, FireDAC.Phys.Intf, FireDAC.DApt.Intf, FireDAC.Stan.Async, FireDAC.DApt,
  FireDAC.Comp.DataSet, FireDAC.Comp.Client, FDvMenus, FDvMenuStylers,
  FDvPreviewMenuStylers, FDvShapeButton, sDBEdit, sEdit, ToolEdit, sLabel,
  RzDBSpin, RzDBCmbo, PageView,
{$ENDIF},
  FDvPreviewMenuStylers, RzDBCmbo, FDvMenus, FDvMenuStylers,
  BaseGrid, FDvGrid, DBAdvGrid, Menus, PageView, FDvShapeButton, RzSpnEdt,
  RzBtnEdt, RzDBSpin, ToolEdit, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param,
  FireDAC.Stan.Error, FireDAC.DatS, FireDAC.Phys.Intf, FireDAC.DApt.Intf, FireDAC.Stan.Async,
  FireDAC.DApt, FireDAC.Comp.DataSet, FireDAC.Comp.Client, sEdit, sLabel, sDBEdit;
