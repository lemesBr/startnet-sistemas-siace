...
uses
  ...
  SUIDlg, RXDBCtrl, DBXpress, sButton, sDBEdit, Buttons, sBitBtn;
...
suiDBEdit4.Color:= clWindow;
   Except
   FormPrincipal.MsgInformacao.HTMLText.Text:= 'Não Foi Possivel Gravar o Registro !!!';
  FormPrincipal.MsgInformacao.Execute;
...
If  ComboEdit1.Text= '' then
    Begin
     FormPrincipal.MsgInformacao.HTMLText.Text:= 'Digite algo para localizar o Registro !!!';
     FormPrincipal.MsgInformacao.Execute;
