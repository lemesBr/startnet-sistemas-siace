object FormConsultaChequesBaixados: TFormConsultaChequesBaixados
  Left = 302
  Top = 164
  ...
  object pc: TsuiPageControl
    ...
    object TabSheet1: TsuiTabSheet
      ...
      Height = 380
      PageIndex = 1
      Caption = 'Cheques Baixados por Nome (Titular da Conta Corrente):'
      TabVisible = True
      ImageIndex = -1
      Color = clWhite
      Enabled = False
      ...
      object Panel3: TPanel
        ...
        object suiDBNavigator1: TsuiDBNavigator
          ...
          Cursor = crDefault
          UIStyle = WinXP
          DataSource = DMC2.DTS_ChequesBaixadosTitular
    ...
    object TBCPP: TsuiTabSheet
      ...
      Height = 380
      PageIndex = 0
      Caption = 'Cheques Baixados por Per'#237'odo (Data da Baixa):'
      TabVisible = True
      ImageIndex = -1
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      ...
      object pnpesq: TPanel
        ...
        object Navigator: TsuiDBNavigator
          ...
          Cursor = crDefault
          UIStyle = WinXP
          DataSource = DMC2.DTS_ChequesBaixadosPeriodo
          VisibleButtons = [nbFirst, nbPrior, nbNext, nbLast]
          TabOrder = 3
        end
      end
