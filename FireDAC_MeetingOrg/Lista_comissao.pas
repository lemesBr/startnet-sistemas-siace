...
type
  TFormComissaoCategoria = class(TForm)
    ...
    queryPERC_AVISTA: TBCDField;
    queryPERC_PRAZO: TBCDField;
    ...
    queryPRECO_TOTAL: TBCDField;
    queryDESCONTO: TBCDField;
    querySUB_TOTAL: TBCDField;
...
{  dm.qrrelatorio.FIELDBYNAME('LINHA1').ASSTRING :=
  ...
  relABC.LoadFromFile('\siace\rel\comissoes_vendedor.fr3');
  relABC.ShowReport;
