...
uses Forms, Classes, SysUtils, Buttons, IBDataBase,DBCtrls, Dialogs,
...
const
        ...
        __SYS_EMAIL   = 'startnetinfo@gmail.com.br';
        __SYS_HOMEPAGE= 'www.startetprovedor.com.br';
        __SYS_VERSAO  = '1.0.0.0';
        __SYS_EMPRESA = 'StartNet Provedor Informática Ltda';
        __SYS_TELEFONE= '(66) 3555-1453';
        __SYS_SISTEMA = 'StartNet Sistemas';
