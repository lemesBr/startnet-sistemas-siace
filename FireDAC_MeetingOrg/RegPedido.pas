...
type
  TFormCupomFiscal = class(TForm)
    ...
    Qpromo: TFDQuery;
    QpromoPRECO_PROMOCAO: TBCDField;
    DBGrid1: TDBAdvGrid;
    Edit7: TEdit;
    qrcaixa: TFDQuery;
    ...
    qrcaixaQUANT_VENDA: TIntegerField;
    qrcaixaVALOR_VENDA: TBCDField;
    qrcaixaDESCRICAO: TStringField;
    qrcaixaUNID: TStringField;
    qrcaixaABREVIADO: TStringField;
    qrcaixaPRECO_CUSTO: TBCDField;
    qrcaixaMARGEM_LUCRO: TBCDField;
    qrcaixaCOMISSAO: TBCDField;
    qrcaixaUNIDADE: TIntegerField;
    qrcaixaFRETE: TBCDField;
    qrcaixaICMS: TBCDField;
    qrcaixaIPI_IRPJ: TBCDField;
    qrcaixaOUTROS_IMPOSTOS: TBCDField;
    qrcaixaDESCONTOS: TBCDField;
    qrcaixaCLASS_FISCAL: TStringField;
    qrcaixaSIT_TRIBUTARIA: TStringField;
    qrcaixaCUSTO_MEDIO: TBCDField;
    qrcaixaPRECO_VENDA: TBCDField;
    qrcaixaDESCONTO_MAXIMO: TBCDField;
    ...
    qrcaixaPESOBRUTO: TBCDField;
    qrcaixaPESOLIQUIDO: TBCDField;
    qrcaixaFONETICO: TStringField;
    qrcaixaDATAULTALTERACAO: TDateField;
    qrcaixaCUSTOREPOSICAO: TBCDField;
    qrcaixaPRECO_ANT: TBCDField;
    qrcaixaPRECO_PROMOCAO: TBCDField;
    ...
    qrcaixaQTD_FRACIONADA: TBCDField;
    ...
    qrcaixaPRECO_VENDA2: TBCDField;
    qrcaixaMARGEM_LUCRO2: TBCDField;
 ...
 BEGIN
  Edit1.Text:= Trim(Edit1.Text);
   ...
   begin
    ...
    dm.SDS_PRODUTOS.Active := false;
    DM.Sds_produtos.DataSet.CommandText:= 'select * from PRODUTOS where CODIGO_BARRAS like ' + #39 + '%' + Edit3.text + '%' + #39+'' + 'ORDER BY DESCRICAO';
    dm.SDS_PRODUTOS.Active := True;
    dm.SDS_PRODUTOS.Filtered := false;
