...
Begin
  ...
  begin
    ...
    EdVlrUnitario.Value := DM1.LavanderiaLAV_VALORUNITARIO.Value;
    EdQuantidade.Value  := DM1.LavanderiaLAV_QUANTIDADE.Value;
    EdVlrTotal.Value    := DM1.LavanderiaLAV_VALORTOTAL.Value;
