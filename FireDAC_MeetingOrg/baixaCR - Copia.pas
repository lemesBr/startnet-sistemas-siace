...
uses
  ...
  Buttons, Mask, DBXpress, ToolEdit, CurrEdit, SimpleDS, FMTBcd, SqlExpr,
  RXCtrls, Mylabel, SUIComboBox, SUIEdit, SUIDlg, IBCustomDataSet, IBQuery, Math,
...
uses Principal, Ubibli1, Z_RotinasGerais, ModulodeDadosBaixas, CRCrediario, ModulodeDados,
  Recibo, UDadosAdm, CRCrediarioconv;
...
begin
 if FileExists('C:\SIACE\Receb.xml') then
  begin
     DeleteFile('C:\SIACE\Receb.xml');
  end;
...
ClientDataSet1.edit;
DESCONTO := CurrencyEdit2.Value;
Total := (ClientDataSet1Valor_Pagar.AsFloat + ClientDataSet1Multa.AsFloat + ClientDataSet1Juros.AsFloat);
