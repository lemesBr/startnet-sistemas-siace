object FormGraficoVendas: TFormGraficoVendas
  Left = 195
  Top = 199
  Caption = 'Gr'#225'fico das Vendas Di'#225'rias'
  ClientHeight = 449
  ClientWidth = 793
  Color = clBtnFace
  ...
  object DBChart1: TDBChart
    ...
    object Series1: TBarSeries
      BarBrush.Color = clBtnText
      BarPen.Color = clBlue
      ColorEachPoint = True
      Marks.Style = smsXY
      Marks.BackColor = clWhite
      Marks.Color = clWhite
      DataSource = FormGraficos.qry_data
      SeriesColor = clBlue
      Title = 'Vendas Por Data'
      ValueFormat = 'R$ #,##0.00'
      XLabelsSource = 'DATA_PEDIDO'
      AutoBarSize = True
      MultiBar = mbNone
      XValues.DateTime = True
      XValues.Name = 'X'
      XValues.Order = loAscending
      XValues.ValueSource = 'DATA_PEDIDO'
      YValues.Name = 'Barra'
      YValues.Order = loNone
      YValues.ValueSource = 'SOMADEVALOR_TOTAL'
    end
  end
