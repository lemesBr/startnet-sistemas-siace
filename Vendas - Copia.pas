...
uses
  ...
  SUIImagePanel, SUIGroupBox, SUIRadioGroup, RXCtrls, SUIButton, Mylabel,
...
type
  TformVendas = class(TForm)
    ...
    CancelarOr: TsBitBtn;
    ConfirmarOr: TsBitBtn;
    PesquisarOR: TsBitBtn;
    RxLabel14: TsLabel;
    ...
    QBuscaItensPERC_LUCRO_ST: TIBBCDField;
    ...
    QBuscaItensPERC_ALIQUOTA_IPI: TBCDField;
    Qpromo: TFDQuery;
    ...
    QBuscaItens1PRECO_UNITARIO: TBCDField;
...
uses Acesso, ModulodeDadosConsultas, ModulodeDados, Principal,
  ...
  BoletosBanc, ConsProdutosVendas,Z_RotinasGerais, RelOrcamentos,
