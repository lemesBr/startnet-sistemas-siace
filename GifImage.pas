...
(*
  ...
  FIXHEADER_WIDTHHEIGHT_SILENT  Define this symbol to FDjust Width and Height
...
//
////////////////////////////////////////////////////////////////////////////////
//  FDapted from Earl F. Glynn's ColorQuantizationLibrary, March 1998
////////////////////////////////////////////////////////////////////////////////
type
...
//
////////////////////////////////////////////////////////////////////////////////
//	FDapted from Earl F. Glynn's PaletteLibrary, March 1998
////////////////////////////////////////////////////////////////////////////////
...
begin
  ...
  // Some old FDobe export filters mistakenly uses a value of 10
  if (Size = 10) then
  begin
    { TODO -oanme -cImprovement : replace with seek or read and check contents = 'FDobe' }
...
begin
  ...
  repeat
    if (Stream.Read(b, 1) <> 1) then
      exit;
  until (b <> 0); // Ignore 0 PFDding (non-compliant)
...
{$endif}
              ...
              begin
                ...
                try
                  ...
                  // ...FDjust for time already spent converting GIF to bitmap and...
                  // ...FDjust for Animation Speed factor.
              ...
              begin
                ...
                begin
                  ...
                  begin
                    // Don't use interframe delay feedback FDjustment if delay
...
// 2) Merge histograms
// 3) Sum equal colors and FDjust max # of colors
