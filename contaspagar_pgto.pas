    ...
    begin
       ...
       begin
          ...
          if (CheckBox2.Checked = false) then
            begin
                     cheque:= inttostr(prxcod('CHEQUES_EMITIDOS', 'cod_cheque', dm.IBTransaction, dm.QConsulta));
               ...
               {     if dm.IBTransaction.Active then
                    ...
                    qrcaixa_mov.sql.clear;
                    qrcaixa_mov.sql.add('insert into movimento_diario');
                    qrcaixa_mov.SQL.add('(codigo,usuario,cod_usuario,data,valor_saida,Valor_entrada,valor,cod_plano,tipo_mov,historico, tipo, origem,COD_CONTAS_PAGAR, CODIGO_CC, NUMERO_CC, cod_empresa)');
                    qrcaixa_mov.sql.add('values');
                    qrcaixa_mov.SQL.add('(:codigo,:usuario,:cod_usuario,:data,:valor_saida,:valor_entrada,:valor,:cod_plano,:tipo_mov,:historico,:tipo,:origem,:COD_CONTAS_PAGAR, :CODIGO_CC, :NUMERO_CC, :cod_emp)');
