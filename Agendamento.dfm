object FormAgendamento: TFormAgendamento
  Left = 319
  Top = 182
  Caption = 'Formul'#225'rio de Reservas'
  ClientHeight = 441
  ClientWidth = 622
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object GroupBox2: TGroupBox
      ...
      object EdCodHospede: TComboEdit
        ...
        OnDblClick = EdCodHospedeDblClick
    ...
    object GroupBox1: TGroupBox
      ...
      object EdCodApartamento: TComboEdit
        ...
        TabOrder = 1
        Text = ''
        OnButtonClick = EdCodApartamentoButtonClick
        OnExit = EdCodApartamentoExit
        OnKeyDown = EdCodApartamentoKeyDown
      end
    end
    object GroupBox3: TGroupBox
      ...
      object Label11: TLabel
        ...
        Width = 96
        Height = 13
        Caption = 'Previs'#227'o de Entrada'
      end
    ...
    object XDBGrid1: TXDBGrid
      ...
      Columns = <
        ...
        item
          Expanded = False
          FieldName = 'RES_CODHOSPEDE'
          Title.Caption = 'C'#243'd. Hosp.'
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'NOME_RS'
          Title.Caption = 'Hospede'
          Visible = True
          Width = 290
        end>
    end
