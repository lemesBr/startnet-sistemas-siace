object DMC2: TDMC2
  ...
  object SQLD_MOV_BANCO: TSQLDataSet
    CommandText = 
      'select * from SP_MOV_BANCO_DATA(:Datai,:Dataf) order by CODIGO A' +
      'SC'
    MaxBlobSize = -1
    Params = <
      item
  ...
  object Dts_saldo_ant: TDataSource
    AutoEdit = False
    DataSet = CDS_SALDO_ANT
    Left = 336
    Top = 560
  end
  object dsp_saldo_ant: TDataSetProvider
    DataSet = QRY_SALDO_ANT
    Left = 179
    Top = 562
  end
  object CDS_SALDO_ANT: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dsp_saldo_ant'
    Left = 256
    Top = 560
    object CDS_SALDO_ANTENTRADA: TFMTBCDField
      FieldName = 'ENTRADA'
      currency = True
      Precision = 15
      Size = 2
    end
    object CDS_SALDO_ANTSAIDA: TFMTBCDField
      FieldName = 'SAIDA'
      currency = True
      Precision = 15
      Size = 2
  ...
  object QRY_SALDO_ANT: TSQLDataSet
    CommandText = 'select * from sp_saldo_bancario(:Data)'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftUnknown
    ...
    Left = 88
    Top = 560
    object QRY_SALDO_ANTENTRADA: TFMTBCDField
      FieldName = 'ENTRADA'
      Precision = 15
      Size = 2
    end
    object QRY_SALDO_ANTSAIDA: TFMTBCDField
      FieldName = 'SAIDA'
      Precision = 15
      Size = 2
    end
  end
  object Dsp_saldo_ant_cc: TDataSetProvider
    DataSet = QRY_SALDO_ANT_CC
    Left = 555
    Top = 562
  end
  object Dts_saldo_ant_cc: TDataSource
    AutoEdit = False
    DataSet = cds_saldo_ant_cc
    Left = 728
    Top = 568
  end
  object QRY_SALDO_ANT_CC: TSQLDataSet
    CommandText = 
      'SELECT SUM(VALOR_ENTRADA) - SUM(VALOR_SAIDA) as SALDO  from V_MO' +
      'VIMENTO_BANCO  WHERE DATA < :DATA AND CODIGO_CC = :CONTA'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftUnknown
    ...
    Left = 472
    Top = 560
    object QRY_SALDO_ANT_CCSALDO: TFMTBCDField
      FieldName = 'SALDO'
      Precision = 15
      Size = 2
    end
  end
  object cds_saldo_ant_cc: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'Dsp_saldo_ant_cc'
    Left = 640
    Top = 568
    object cds_saldo_ant_ccSALDO: TFMTBCDField
      FieldName = 'SALDO'
      Precision = 15
      Size = 2
    end
  end
  object QRY_SALDO_ANT_CAIXA: TSQLDataSet
    CommandText = 'select * from SP_SALDO_ANT_CAIXA(:Data, :USU)'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftUnknown
    ...
    Left = 824
    Top = 376
    object QRY_SALDO_ANT_CAIXAENTRADA: TFMTBCDField
      FieldName = 'ENTRADA'
      Precision = 15
      Size = 2
    end
    object QRY_SALDO_ANT_CAIXASAIDA: TFMTBCDField
      FieldName = 'SAIDA'
      Precision = 15
      Size = 2
    end
  end
  object DSP_S_A_CAIXA: TDataSetProvider
    DataSet = QRY_SALDO_ANT_CAIXA
    Left = 827
    Top = 450
  end
  object CDS_SALDO_A_CAIXA: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'DSP_S_A_CAIXA'
    Left = 832
    Top = 496
    object CDS_SALDO_A_CAIXAENTRADA: TFMTBCDField
      FieldName = 'ENTRADA'
      Precision = 15
      Size = 2
    end
    object CDS_SALDO_A_CAIXASAIDA: TFMTBCDField
      FieldName = 'SAIDA'
      Precision = 15
      Size = 2
    end
  end
  object DTS_SALDO_A_CAIXA: TDataSource
    AutoEdit = False
    DataSet = CDS_SALDO_A_CAIXA
    Left = 832
    Top = 544
  end
  object QRY_SALDO_ANT_CX: TSQLDataSet
    CommandText = 'select * from SP_SALDO_ANT_CX(:Data)'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftUnknown
    ...
    Left = 872
    Top = 24
    object QRY_SALDO_ANT_CXENTRADA: TFMTBCDField
      FieldName = 'ENTRADA'
      Precision = 15
      Size = 2
    end
    object QRY_SALDO_ANT_CXSAIDA: TFMTBCDField
      FieldName = 'SAIDA'
      Precision = 15
      Size = 2
    end
  end
  object Dsp_saldo_ant_cx: TDataSetProvider
    DataSet = QRY_SALDO_ANT_CX
    Left = 875
    Top = 82
  end
  object cds_saldo_a_cx: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'Dsp_saldo_ant_cx'
    Left = 880
    Top = 136
    object cds_saldo_a_cxENTRADA: TFMTBCDField
      FieldName = 'ENTRADA'
      Precision = 15
      Size = 2
    end
    object cds_saldo_a_cxSAIDA: TFMTBCDField
      FieldName = 'SAIDA'
      Precision = 15
      Size = 2
    end
  end
  object DtS_saldo_a_cx: TDataSource
    AutoEdit = False
    DataSet = cds_saldo_a_cx
    Left = 880
    Top = 192
  end
end
