...
uses ModulodeDados, Agencias, Z_RotinasGerais, Principal, UCtrAdmRec;
                 ...
                 // Application.CreateForm(TFrmCancelaRecebimento, FrmCancelaRecebimento);
                  with FrmCtrAdmRec do
                     begin
                        ...
                        EdtNomeCentroCusto.Text := DM.SDS_Conta_BancariaCONTA.Text;
                        EditDigito.Text := DM.strngfldSDS_Conta_BancariaDIGITO.Text;
                       // showmodal;
                     end; 
               end;
Action:=CaFree;
