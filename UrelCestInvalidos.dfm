object FormCestInv: TFormCestInv
  Left = 306
  Top = 230
  Width = 924
  Height = 480
  ...
  object RLReport1: TRLReport
    ...
    object RLBand1: TRLBand
      ...
      object RLLabel1: TRLLabel
        ...
        Width = 379
        Height = 23
        Caption = 'Relatorio de Produtos com CEST inv'#225'lidos'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Height = -20
        Font.Name = 'Arial'
  ...
  object FDQuery1: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT CODIGO, CODIGO_BARRAS, DESCRICAO, PRECO_CUSTO, PRECO_VEND' +
        'A, ATIVO, CEST'
      'FROM PRODUTOS WHERE CEST Is Null;')
    Left = 816
    Top = 32
    ...
    object FDQuery1CEST: TStringField
      FieldName = 'CEST'
      Origin = 'CEST'
      Size = 7
    end
