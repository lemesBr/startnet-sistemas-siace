...
uses
  ...
  Dialogs, ComCtrls, ExtCtrls, Buttons, StdCtrls, AlignEdit, AdvGlowButton;
...
type
  TFrmAlterarSecao = class(TForm)
    ...
    BtnConsSec: TAdvGlowButton;
    EdtNomeSec: TEdit;
    BtnOK: TAdvGlowButton;
    BtnCancelar: TAdvGlowButton;
    Label1: TLabel;
    EdtCodGrupo: TAlignEdit;
    BtnConsGrupo: TAdvGlowButton;
    EdtNomeGrupo: TEdit;
    Label2: TLabel;
    Label3: TLabel;
    EdtCodSub: TAlignEdit;
    BtnConsSub: TAdvGlowButton;
    EdtNomeSub: TEdit;
    Label4: TLabel;
    Label6: TLabel;
    Label7: TLabel;
...
Uses ModulodeDados, Ubibli1, UAlteraPreco, ConsSeccao, ConsGrupos,
  ConsSubGrupos, UConsLocaisEstoque, Principal;
...
begin
   ...
   if Application.MessageBox('Confirma a Atualização da Seção?', 'Atenção', mb_applmodal+mb_iconquestion+mb_yesno+mb_defbutton1) = 6 then
      begin
         ...
         dm.QConsulta.sql.Text:= 'UPDATE PRODUTOS SET SECCAO = :1, CODIGO_GRUPO = :2, ' +
