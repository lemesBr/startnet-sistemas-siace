...
uses
  ...
  DBCtrls, XDBGrids, Buttons, sBitBtn, RxCurrEdit, RxToolEdit, sLabel;
...
uses ModulodeDados, ConsClientes, Udmcob, agrupamento_titulos, RelCobranca, Principal,
  ModulodeDadosBaixas, ConsUsuarios, CobrancaRazao, duplicatasp, Titulos;
...
ORDEM, CID : string;
  ...
  //  DMCOB.SDS_CLIENTES.Active :=False;
    ...
    if dtmovi > ' / /   ' then
     ...
     dmcob.QRYcobranca1.SQL.add('and cod_empresa ='+ inttostr(iemp)+ ' ORDER BY '+ORDEM +' ASC');
       ...
       ShowMessage('Erro ao Tentar Exibir a Tela de Boletos Bancarios!!');
                    ...
                    begin
                     ...
                     // n_nfe := formvendas.Sds_pedidosNUM_NOTA.TEXT;
                      COD_CRED :=  dmcob.CDS_COBRANCA1CODIGO.text;
