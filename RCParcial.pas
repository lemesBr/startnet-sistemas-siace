...
uses
  ...
  RxCurrEdit, RxToolEdit, FireDAC.Stan.Intf, FireDAC.Stan.Option,
...
TotPert:= (Tot * Pert);
       ...
       BEGIN
                   ...
                   with DM.fConsulta do
                    ...
                    commandtext.add('saldo_pagar, data_vencimento, VALOR_PAGO, DOC_REC_ADM, JUROS_POSTERGADOS) values (:CODIGO, :COD_CREDIAIRIO, :COD_EMPRESA,');
                    commandtext.add(':PARCELA, :VALOR_PARCELA, :JUROS, :MULTA, :DESCONTO, :VALOR_TOTAL, :DATA_BAIXA, :USUARIO,  :COD_cliente,');
                    commandtext.add(':nome_cliente, :cod_compra, :saldo_pagar, :data_vencimento, :VALOR_PAGO, :DOC_REC_ADM, :JUROS_P);');
