...
uses
  ...
  Dialogs, ExtCtrls,  SUIButton, StdCtrls, rxCurrEdit,
  SUIEdit, Mask, RXCtrls, FMTBcd, DB, SqlExpr, SUIDlg,
  IBCustomDataSet, IBQuery, RxToolEdit, FireDAC.Stan.Intf, FireDAC.Stan.Option,
  FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS, FireDAC.Phys.Intf,
  FireDAC.DApt.Intf, FireDAC.Stan.Async, FireDAC.DApt, FireDAC.Comp.DataSet,
  FireDAC.Comp.Client, sLabel;
