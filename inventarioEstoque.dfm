object FormInventarioEstoque: TFormInventarioEstoque
  ...
  object IBTRInv: TFDTransaction
    Connection = DM.Coneccao
    Left = 232
    Top = 104
  end
  object QUpdinv: TFDQuery
    Connection = DM.Coneccao
    Transaction = IBTRInv
    SQL.Strings = (
  ...
  object QBuscaItens: TFDQuery
    ...
    object QBuscaItensCOD_BARRAS: TStringField
      FieldName = 'COD_BARRAS'
      Origin = 'COD_BARRAS'
      Size = 13
    end
    object QBuscaItensREFERNCIA: TStringField
      FieldName = 'REFERNCIA'
      Origin = 'REFERNCIA'
    end
    object QBuscaItensDESCRICAO_NOVA: TStringField
      FieldName = 'DESCRICAO_NOVA'
      Origin = 'DESCRICAO_NOVA'
      Size = 50
    end
    object QBuscaItensQUANTIDADE: TFMTBCDField
      FieldName = 'QUANTIDADE'
      Origin = 'QUANTIDADE'
      Precision = 18
      Size = 3
    end
    object QBuscaItensQUANT_FRACIONADA: TFMTBCDField
      FieldName = 'QUANT_FRACIONADA'
    ...
    object QBuscaItensSTATUS: TStringField
      FieldName = 'STATUS'
      Origin = 'STATUS'
      Size = 1
    end
  end
  object QDelInv: TFDQuery
    Connection = DM.Coneccao
    SQL.Strings = (
