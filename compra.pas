...
type
  Tfrmcompra = class(TForm)
    ...
    qrproduto_gradePRECO_VENDA_GRADE: TFMTBCDField;
    qrproduto_gradeDEC_UNIDADE: TStringField;
    qrproduto_gradeESTOQUE: TFMTBCDField;
    ...
    qrnota_item_listaVALOR_DESC: TFMTBCDField;
    qrnota_item_listaTOTAL_ITEM: TFMTBCDField;
    qrnota_item_listaDATA: TDateField;
    qrnota_item_listaBASE_ICMS: TFMTBCDField;
    qrnota_item_listaVALOR_ICMS: TFMTBCDField;
    qrnota_item_listaVALOR_IPI: TFMTBCDField;
    qrnota_item_listaPERC_ICMS: TFMTBCDField;
    qrnota_item_listaPERC_IPI: TFMTBCDField;
    qrnota_item_listaPRECO_VENDA: TFMTBCDField;
    qrnota_item_listaPRECO_VENDA2: TFMTBCDField;
    ...
    qrnota_item_listaMARG_LUCRO: TFMTBCDField;
    qrnota_item_listaATIVO: TStringField;
    qrnota_item_listaBASE_ICMS_ST: TFMTBCDField;
    qrnota_item_listaALIC_ICMS_ST: TFMTBCDField;
    qrnota_item_listaVALOR_ICMS_ST: TFMTBCDField;
    qrnota_item_listaCOD_EMPRESA: TIntegerField;
    qrnota_item_listaIMOBILZ: TStringField;
    qrnota_item_listaBASE_PIS: TFMTBCDField;
    qrnota_item_listaPERC_PIS: TFMTBCDField;
    qrnota_item_listaVALOR_PIS: TFMTBCDField;
    qrnota_item_listaBASE_COFINS: TFMTBCDField;
    qrnota_item_listaPERC_COFINS: TFMTBCDField;
    qrnota_item_listaVALOR_COFINS: TFMTBCDField;
    qrnota_item_listaBASE_IPI: TFMTBCDField;
    ...
    qrnota_item_listaSUBTOTAL: TFMTBCDField;
    qrnota_item_listaDESCONTO_P: TFMTBCDField;
    qrnota_item_listaICMS_REDUCAO: TFMTBCDField;
    qrnota_item_listaICMS_VALORRETIDO: TFMTBCDField;
    qrnota_item_listaICMS_ISENTO: TFMTBCDField;
    qrnota_item_listaICMS_NAOTRIBUTADO: TFMTBCDField;
    qrnota_item_listaIPI_TIPO: TStringField;
    qrnota_item_listaTIPO: TIntegerField;
    qrnota_item_listaFRETE: TFMTBCDField;
    qrnota_item_listaOUTRAS: TFMTBCDField;
    qrnota_item_listaSEGURO: TFMTBCDField;
    qrnota_item_listaCLASSIFICACAO_FISCAL: TStringField;
    qrnota_item_listaSUB_PRODUTOS: TFMTBCDField;
    qrnota_item_listaITEM_ESPECIAL_VALOR: TFMTBCDField;
    qrnota_item_listaICMS_OUTRAS: TFMTBCDField;
    qrnota_item_listaALTERA_ITEM: TIntegerField;
    qrnota_item_listaCREDITO_ICMS: TFMTBCDField;
    qrnota_item_listaCREDITO_ICMS_BASE: TFMTBCDField;
    qrnota_item_listaPMARGEM: TSingleField;
    qrnota_item_listaPRECO_CUSTO: TFMTBCDField;
...
begin
  ...
  begin
    ...
    frmcompra_menu.qrempresa.sql.add('select * from empresa where codigo =:cod_emp');
    frmcompra_menu.qrempresa.params.ParamByName('cod_emp').AsInteger := iEmp;
...
begin
 ...
 // frmcompra_menu.qrnota.fieldbyname('VALOR_TOTAL_PRODUTOS').asfloat := edprodutos.Value;
  ...
  formprincipal.log(codigo_usuario,'NOTAFISCAL',frmcompra_menu.qrnotaNUM_NOTA.Text,'INCLUIU','INCLUSÃO DO NOTA FISCAL Nº '+frmcompra_menu.qrnotaNUM_NOTA.Text +' FORNECEDOR: '+ frmcompra_menu.qrnotaCOD_FORNECEDOR.Text + '-' + frmcompra_menu.qrnotaFORNECEDOR.Text);
             ...
             If DM.SDS_CONFIGURACOESUTILIZA_NFE.Text = 'S' then
              if Application.MESSAGEBOX('Confirma Geração e Emissão da NF-e?', 'Confirmar', MB_ICONQUESTION + MB_YESNO + MB_DEFBUTTON1) = ID_YES then
                 begin
                      ...
                      DM.SDS_NotasFiscaisItens.SQL.Clear;
                       DM.SDS_NotasFiscaisItens.SQL.add('select * from notasfiscais_itens where codigo_nota = '+frmcompra_menu.qrnotaCODIGO_NOTA.Text+'');
...
begin
  ...
  begin
    ...
    begin
      frmcompra_menu.qrempresa.close;
      frmcompra_menu.qrempresa.sql.clear;
      frmcompra_menu.qrempresa.sql.add('select * from empresa where codigo = ''' + ecodempresa.Text + '''');
      frmcompra_menu.qrempresa.open;
  ...
  begin
    ...
    begin
      ...
      frmcompra_menu.QRNOTA.FIELDBYNAME('fornecedor').ASSTRING := frmcompra_menu.qrfornecedorNOME.Text;
       ...
       frmcompra_menu.QRNOTACEP_CLIENTE_FORN.AsString     := Copy(frmcompra_menu.qrfornecedorCEP.AsString, 01,05) + Copy(frmcompra_menu.qrfornecedorCEP.AsString, 07,03);
       frmcompra_menu.qrnotaBAIRRO_CLIENTE_FORN.AsString  := frmcompra_menu.qrfornecedorBAIRRO.Text;
...
begin
  ...
  begin
    showmessage('CFOP Invalido para essa Operação com Empresa de fora do Estado!');
    ecfop.setfocus;
    exit;
  end;
end;
