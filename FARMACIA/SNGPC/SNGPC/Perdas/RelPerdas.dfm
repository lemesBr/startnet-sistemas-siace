object fRelPerdas: TfRelPerdas
  ...
  object QuickRep1: TQuickRep
    ...
    PrintIfEmpty = True
    ReportTitle = 'Relat'#243'rio Perdas Psicotropicos'
    SnapToGrid = True
    Units = MM
    Zoom = 100
  ...
  object qryPerdas: TMDOQuery
    ...
    SQL.Strings = (
      'select *   from PERDAS'
      'where DATA_PERDA >= :DATA1'
      'and DATA_PERDA <= :DATA2 '
      'order by DATA_PERDA, DESCRICAO')
    Left = 40
    Top = 8
    ParamData = <
      item
