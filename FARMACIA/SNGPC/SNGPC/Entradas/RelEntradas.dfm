object fRelEntradas: TfRelEntradas
  ...
  object QuickRep1: TQuickRep
    ...
    PrintIfEmpty = True
    ReportTitle = 'Relat'#243'rio Entradas Psicotropicos'
    SnapToGrid = True
    Units = MM
    Zoom = 100
    ...
    object QRBand1: TQRBand
      ...
      object QRLabel1: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Futura Ssytem Inform'#225'tica (0xx42) 8403-0313'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
  ...
  object qryEntradas: TMDOQuery
    ...
    SQL.Strings = (
      ...
      'where RECEBIDO >= :DATA1'
      'and RECEBIDO <= :DATA2 '
      'order by RECEBIDO, NOTA_FISCAL, DESCRICAO')
    Left = 40
    Top = 8
    ParamData = <
      item
