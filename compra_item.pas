...
type
  Tfrmcompra_item = class(TForm)
    ...
    qrgrade_entradaESTOQUE: TFMTBCDField;
    qrgrade_entradaPRECOCUSTO: TFMTBCDField;
    qrgrade_entradaPRECOVENDA: TFMTBCDField;
    QtributacaoFLAG_SUBSTITUICAO_TRIB: TStringField;
    QtributacaoPERC_SUBST_TRIBUTARIA: TFMTBCDField;
    QtributacaoFLAG_SERVICO: TStringField;
    QtributacaoPERC_ALIQUOTA_ISS: TFMTBCDField;
    QtributacaoFLAG_FABRICACAO_PROPRIA: TStringField;
    QtributacaoPERC_ALIQUOTA_IPI: TFMTBCDField;
    QtributacaoFLAG_PIS_COFINS: TStringField;
    QtributacaoPERC_ALIQUOTA_PIS: TFMTBCDField;
    QtributacaoPERC_ALIQUOTA_COFINS: TFMTBCDField;
    QtributacaoFLAG_ICMSGARANTIDO_INTEGRAL: TStringField;
    QtributacaoPERC_ICMS_GARANTIDO_INTEGRAL: TFMTBCDField;
    ...
    QtributacaoPERC_ICMS_ESTADUAL: TFMTBCDField;
    QtributacaoPERC_ICMS_INTER_ESTADUAL: TFMTBCDField;
    ...
    QtributacaoPERC_RED_ICMS: TFMTBCDField;
    ...
    QtributacaoPERC_LUCRO_ST: TFMTBCDField;
    QtributacaoCST_VENDA_NFCE: TStringField;
    QtributacaoCST_VENDA_INTER_NFCE: TSmallintField;
