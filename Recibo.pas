...
FormRelrecibo40.RLReport1.Preview();
end else
...
FormRelrecibo.RLReport1.Preview()
end else
if DM.SDS_CONFIGURACOESIMPRESSAO.Text ='M' then
BEGIN
FormRelrecibo := TFormRelrecibo.Create(self);
...
begin
 ...
 { frmmodulo.qrrelatorio.edit;
  ...
  fxrecibo.LoadFromFile('rel\RECIBO.fr3');
  fxrecibo.ShowReport;
...
begin
 if FileExists('C:\StartNet_Sistemas\RECIBO.xml') then
  begin
     DeleteFile('C:\StartNet_Sistemas\RECIBO.xml');
  end;
