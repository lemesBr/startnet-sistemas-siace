...
uses
  ...
  Dialogs, ExtCtrls, StdCtrls, Buttons, Mask, ComCtrls, DBCtrls,
  Grids, DBGrids, DB, FMTBcd, SqlExpr, IBCustomDataSet, IBQuery,
  ImgList, acAlphaImageList, IBDatabase, SHELLAPI,
  System.ImageList, RxCurrEdit, AdvGlowButton, RxToolEdit, FireDAC.Stan.Intf,
...
uses fR3, FrFNRH, ModuleDados1, ModulodeDados, Principal, UDadosAdm,
  LancCheques, venda_contasreceber,  gerNFce, Ubibli1,
  gerNFSe, FrmCadastroSNRHOS, Titulos;
...
//  Edit1.Text            := CodEntrada;
 ...
 // DM1.Conf.Open;
  ...
  if Application.MESSAGEBOX('Deseja enviar CheckinOut para snrhos hospedagem turismo?',
         ...
         begin
          Exit;
                     ...
                     { If FormBoletos=nil then
                      ...
                      frmTitulos.Tag := 2;
                      frmTitulos.sEdit1.Text := CodEntrada;
                     // venda := n_venda;
