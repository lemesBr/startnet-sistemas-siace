...
uses
  ...
  StdCtrls, gbCobranca, ExtCtrls, Buttons, jpeg, ExtDlgs;

type
  TFormRemessa = class(TForm)
    pnlBoleto: TPanel;
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
...
var
  FormRemessa: TFormRemessa;

implementation

{$R *.DFM}

procedure TFormRemessa.txtCodigoBancoExit(Sender: TObject);
begin
...
procedure TFormRemessa.txtNossoNumeroExit(Sender: TObject);
begin
   gbTitulo1.NossoNumero := txtNossoNumero.Text;
   txtDigitoNossoNumero.Text := gbTitulo1.DigitoNossoNumero;
end;

procedure TFormRemessa.butVisualizarClick(Sender: TObject);
begin
   gbTitulo1.Visualizar;
end;

procedure TFormRemessa.butImprimirClick(Sender: TObject);
begin
   gbTitulo1.Imprimir;
end;

procedure TFormRemessa.butProcurarRemessaClick(Sender: TObject);
begin
...
procedure TFormRemessa.butGerarRemessaClick(Sender: TObject);
begin
...
procedure TFormRemessa.butProcurarRetornoClick(Sender: TObject);
begin
...
procedure TFormRemessa.butLerRetornoClick(Sender: TObject);
begin
   gbCobranca1.Titulos.Clear;
...
procedure TFormRemessa.FormShow(Sender: TObject);
begin
