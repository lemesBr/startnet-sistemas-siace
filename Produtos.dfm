object FormProdutos: TFormProdutos
  ...
  object Pc: TRzPageControl
    ...
    object TabSheet9: TRzTabSheet
      ...
      object DBCheckBox9: TDBCheckBox
        ...
        Height = 19
        Hint = 'Marque se utilizar copa ou cozinha'
        Caption = 'Produto Mestre / Embalagem'
        DataField = 'TEM_MESTRE'
        DataSource = DM.DTS_PRODUTOS
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object db_mestre: TRxDBComboEdit
        Left = 22
        Top = 42
        Width = 103
        Height = 21
        Hint = 'C'#243'digo do Produto Mestre'
        CharCase = ecUpperCase
        ClickKey = 113
        Color = 15263976
        Ctl3D = True
        DataField = 'COD_MESTRE'
        DataSource = DM.DTS_PRODUTOS
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        ...
        ShowHint = True
        TabOrder = 1
        OnButtonClick = db_mestreButtonClick
        OnExit = db_mestreExit
      end
      object edt_mestre: TEdit
        Left = 131
        Top = 42
        Width = 768
        Height = 21
  ...
  object QRRENTABILIDADE: TFDQuery
    ...
    object QRRENTABILIDADERENDIMENTO: TFMTBCDField
      FieldName = 'RENDIMENTO'
      Origin = 'RENDIMENTO'
      Precision = 18
      Size = 2
    end
    object QRRENTABILIDADEVALOR: TFMTBCDField
      FieldName = 'VALOR'
      Origin = 'VALOR'
      Precision = 18
      Size = 2
    end
    object QRRENTABILIDADEQUANTIDADE: TFMTBCDField
  ...
  object qrProdutos_Imovel: TFDQuery
    ...
    object qrProdutos_ImovelVALOR_ALUGUEL: TFMTBCDField
      FieldName = 'VALOR_ALUGUEL'
      Origin = 'VALOR_ALUGUEL'
      Precision = 18
      Size = 2
    end
    object qrProdutos_ImovelVALOR_VENDA: TFMTBCDField
      FieldName = 'VALOR_VENDA'
      Origin = 'VALOR_VENDA'
      Precision = 18
      Size = 2
    end
    object qrProdutos_ImovelPERC_IMPOSTO: TFMTBCDField
