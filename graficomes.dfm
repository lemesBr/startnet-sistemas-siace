object FormGrafico_mes: TFormGrafico_mes
  Left = 188
  Top = 208
  Caption = 'Gr'#225'fico das vendas m'#234's a m'#234's'
  ClientHeight = 452
  ClientWidth = 793
  Color = clBtnFace
  ...
  object Chart1: TChart
    ...
    Height = 409
    Title.Text.Strings = (
      'Gr'#225'fico das Vendas M'#234's a M'#234's')
    RightAxis.Title.Caption = 'Grafico de Vendas M'#234's a M'#234's'
