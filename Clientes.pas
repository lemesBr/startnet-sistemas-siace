...
uses
  ...
  TFormClientes = class(TForm)
    ...
    qrvendaUSUARIO: TStringField;
    qrvendaDATA_PEDIDO: TDateField;
    qrvendaDATA_ENTREGA: TDateField;
    qrvendaCODIGO_CLIENTE: TIntegerField;
    qrvendaNOME_CLIENTE: TStringField;
    qrvendaPAGAMENTO: TStringField;
    qrvendaSTATUS: TStringField;
    qrvendaSITUACAO: TStringField;
    qrvendaUSUARIO_ENTREGA: TStringField;
    qrvendaTP: TStringField;
    qrvendaOBSERVACOES: TStringField;
    qrvendaCOD_VENDEDOR: TIntegerField;
    qrvendaCOD_PAGTO: TIntegerField;
    qrvendaN_CUPOM: TStringField;
    qrvendaN_ECF: TStringField;
    ...
    qrvendaSERIE_NOTA: TStringField;
    qrvendaENDERECO: TStringField;
    qrvendaCPF_CNPJ: TStringField;
    qrvendaRG_IE: TStringField;
    qrvendaFONE: TStringField;
    qrvendaCIDADE: TStringField;
    qrvendaBAIRRO: TStringField;
    qrvendaN_PARTIDA: TStringField;
    qrvendaPROPRIEDADE: TStringField;
    qrvendaQUANT_VENDIDA: TBCDField;
    qrvendaSALDO_VENDIDO: TBCDField;
    qrvendaMED_VETERINARIO: TStringField;
    qrvendaDATA_VACINA: TDateField;
    qrvendaUF: TStringField;
    qrvendaCOD_IBGE: TStringField;
    qrvendaCEP: TStringField;
    qrvendaNUMERO: TStringField;
    qrvendaTIPO: TStringField;
    qrvendaENTREGADOR: TStringField;
    qrvendaTIPO_PEDIDO: TStringField;
    qrvendaFECHADO: TStringField;
    qrvendaMESA: TStringField;
    qrvendaREFERENCIA: TStringField;
    qrvendaCELULAR: TStringField;
    qrvendaPROD_RURAL: TStringField;
    qrvendaIE_PRODUTOR: TStringField;
    qrvendaKM: TIntegerField;
    qrvendaCHAVE_FP: TStringField;
    qrvendaCHAVE_FP_CANCEL: TStringField;
    qrvendaCUPON_CANCELADO: TStringField;
    qrvendaCRZ: TIntegerField;
    qrvendaCHEK_BOX: TStringField;
    qrvendaANO: TIntegerField;
    qrvendaMODELO_NF: TStringField;
    qrvendaCFOP_NF: TStringField;
    qrvendaCOD_OS_AUTO: TIntegerField;
    ...
    qrprodutoCODIGO_PRODUTO: TStringField;
    qrprodutoDESCRICAO_PRODUTO: TStringField;
    ...
    qrcontasreceberUSUARIO_VENDA: TStringField;
    qrcontasreceberUSUARIO_BAIXA: TStringField;
    qrcontasreceberSITUACAO: TStringField;
    qrcontasreceberPARCELA: TStringField;
    qrcontasreceberNUMBOLETO: TStringField;
    qrcontasreceberBANCO_PORTADOR: TIntegerField;
    qrcontasreceberREMESSA: TStringField;
    qrcontasreceberDATACREDITO: TDateField;
    qrcontasreceberID_PORTADOR: TIntegerField;
    qrcontasreceberENVIADO: TStringField;
    qrcontasreceberCOD_EMPRESA: TIntegerField;
    qrcontasreceberNUMBOLETO1: TIntegerField;
    qrcontasreceberCODIGOCEDENTE: TStringField;
    qrcontasreceberTIPO: TStringField;
    qrcontasreceberCHEK_BOX: TStringField;
    qrcontasreceberNUM_NOTA: TIntegerField;
    qrcontasreceberSERIE_NOTA: TStringField;
    qrcontasreceberNOME_SACADO: TStringField;
    qrcontasreceberANO: TStringField;
    qrcontasreceberMES: TStringField;
    qrcontasreceberTP_BAIXA: TStringField;
    qrcontasreceberID_CONTRATO: TIntegerField;
    qrcontasreceberNOME_ARQ: TStringField;
    qrcontasreceberCOBRADOR: TIntegerField;
    qrcontasreceberDT_PREVISAO_PGTO: TDateField;
    qrcontasreceberDIAS_VENCIDO: TIntegerField;
    qrcontasreceberN_OS: TStringField;
    qrcontasreceberCOD_ENTRADA: TStringField;
    qrcontasreceberFILTRO: TIntegerField;
    qrcontasreceberCOD_AVALISTA: TIntegerField;
    qrcontasreceberCOD_FRETE: TIntegerField;
    qrcontasreceberCOD_CONV: TIntegerField;
    qrcontasreceberCOM_REGISTRO: TIntegerField;
    qrcontasreceberRECEBIVEL: TIntegerField;
    qrcontasreceberID_CT_PARCELA: TIntegerField;
    ...
    qrcontasreceberpgHISTORICO: TStringField;
    qrcontasreceberpgUSUARIO_VENDA: TStringField;
    qrcontasreceberpgUSUARIO_BAIXA: TStringField;
    qrcontasreceberpgSITUACAO: TStringField;
    qrFichaProfissaoRENDA_BRUTA: TFMTBCDField;
    qrFichaCliCONJUGE_RENDA: TFMTBCDField;
    qrvendaVALOR_ITENS: TFMTBCDField;
    qrvendaENC_FINANCEIRO: TFMTBCDField;
    qrvendaVALOR_DESCONTO: TFMTBCDField;
    qrvendaVALOR_TOTAL: TFMTBCDField;
    qrvendaVALOR_COMISSAO: TFMTBCDField;
    qrvendaVALOR_AVISTA: TFMTBCDField;
    qrvendaVALOR_PRAZO: TFMTBCDField;
    qrvendaVALOR_ACRESCIMOS: TFMTBCDField;
    qrvendaVALOR_PAGO: TFMTBCDField;
    qrvendaVALOR_TROCO: TFMTBCDField;
    qrvendaVLR_PIS: TFMTBCDField;
    qrvendaVLR_COFINS: TFMTBCDField;
    qrClientes_ProfissaoRENDA_BRUTA: TFMTBCDField;
    qrClientes_ProfissaoGASTOS_VEICULO: TFMTBCDField;
    qrClientes_ProfissaoOUTROS_GASTOS: TFMTBCDField;
    qrcontasreceberVALOR_COMPRA: TFMTBCDField;
    qrcontasreceberVALOR_JUROS: TFMTBCDField;
    qrcontasreceberVALOR_ACRESCIMO: TFMTBCDField;
    qrcontasreceberVALOR_DESCONTO: TFMTBCDField;
    qrcontasreceberVALOR_PAGAR: TFMTBCDField;
    qrcontasreceberVALOR_PAGO: TFMTBCDField;
    qrcontasreceberVALOR_TOTAL: TFMTBCDField;
    qrcontasreceberCODIGO_COMPRA: TIntegerField;
    qrcontasreceberCOMISSAO: TFMTBCDField;
    qrcontasreceberVALOR_COMISAO: TFMTBCDField;
    qrcontasreceberJUROS_POSTERGADOS: TFMTBCDField;
    qrcontasreceberVLR_GRAFICA: TFMTBCDField;
    qrcontasreceberpgVALOR_COMPRA: TFMTBCDField;
    qrcontasreceberpgVALOR_JUROS: TFMTBCDField;
    qrcontasreceberpgVALOR_ACRESCIMO: TFMTBCDField;
    qrcontasreceberpgVALOR_DESCONTO: TFMTBCDField;
    qrcontasreceberpgVALOR_PAGAR: TFMTBCDField;
    qrcontasreceberpgVALOR_PAGO: TFMTBCDField;
    qrcontasreceberpgVALOR_TOTAL: TFMTBCDField;
    qrcontasreceberpgCODIGO_COMPRA: TIntegerField;
    qrcontasreceberpgPARCELA: TStringField;
    qrcontasreceberpgNUMBOLETO: TStringField;
    qrcontasreceberpgBANCO_PORTADOR: TIntegerField;
    qrcontasreceberpgREMESSA: TStringField;
    qrcontasreceberpgDATACREDITO: TDateField;
    qrcontasreceberpgID_PORTADOR: TIntegerField;
    qrcontasreceberpgENVIADO: TStringField;
    qrcontasreceberpgCOD_EMPRESA: TIntegerField;
    qrcontasreceberpgNUMBOLETO1: TIntegerField;
    qrcontasreceberpgCODIGOCEDENTE: TStringField;
    qrcontasreceberpgTIPO: TStringField;
    qrcontasreceberpgCHEK_BOX: TStringField;
    qrcontasreceberpgNUM_NOTA: TIntegerField;
    qrcontasreceberpgSERIE_NOTA: TStringField;
    qrcontasreceberpgNOME_SACADO: TStringField;
    qrcontasreceberpgANO: TStringField;
    qrcontasreceberpgMES: TStringField;
    qrcontasreceberpgTP_BAIXA: TStringField;
    qrcontasreceberpgID_CONTRATO: TIntegerField;
    qrcontasreceberpgNOME_ARQ: TStringField;
    qrcontasreceberpgCOBRADOR: TIntegerField;
    qrcontasreceberpgCOMISSAO: TFMTBCDField;
    qrcontasreceberpgDT_PREVISAO_PGTO: TDateField;
    qrcontasreceberpgDIAS_VENCIDO: TIntegerField;
    qrcontasreceberpgN_OS: TStringField;
    qrcontasreceberpgVLR_GRAFICA: TFMTBCDField;
    qrcontasreceberpgVALOR_COMISAO: TFMTBCDField;
    qrcontasreceberpgCOD_ENTRADA: TStringField;
    qrcontasreceberpgFILTRO: TIntegerField;
    qrcontasreceberpgCOD_AVALISTA: TIntegerField;
    qrcontasreceberpgCOD_FRETE: TIntegerField;
    qrcontasreceberpgCOD_CONV: TIntegerField;
    qrcontasreceberpgCOM_REGISTRO: TIntegerField;
    qrcontasreceberpgRECEBIVEL: TIntegerField;
    qrcontasreceberpgID_CT_PARCELA: TIntegerField;
    qrcontasreceberpgJUROS_POSTERGADOS: TFMTBCDField;
    qrprodutoPRECO_UNITARIO: TFMTBCDField;
    qrprodutoDESCONTO: TFMTBCDField;
    qrprodutoQUANTIDADE: TBCDField;
    qrprodutoPRECO_TOTAL: TFMTBCDField;
    qrprodutoCOMISSAO: TFMTBCDField;
    qrprodutoDEV: TStringField;
    qrprodutoQNT_DEV: TBCDField;
    qrprodutoVAL_DEV: TFMTBCDField;
    qrprodutoENC_FINANCEIRO: TFMTBCDField;
    qrprodutoPERC_ISS: TFMTBCDField;
    qrprodutoBASE_ISS: TFMTBCDField;
    qrprodutoVL_ISS: TFMTBCDField;
    qrprodutoPERC_ICM: TFMTBCDField;
    qrprodutoBASE_ICMS: TFMTBCDField;
    qrprodutoVL_ICM: TFMTBCDField;
    qrprodutoPERC_IPI: TFMTBCDField;
    qrprodutoBASE_IPI: TFMTBCDField;
    qrprodutoVL_IPI: TFMTBCDField;
    qrprodutoPERC_COFINS: TFMTBCDField;
    qrprodutoBASE_COFINS: TFMTBCDField;
    qrprodutoVL_COFINS: TFMTBCDField;
    qrprodutoPERC_ICMS_SUBST: TFMTBCDField;
    qrprodutoBASE_ICMS_SUBST: TFMTBCDField;
    qrprodutoVL_ICMS_SUBST: TFMTBCDField;
    qrprodutoPERC_PIS: TFMTBCDField;
    qrprodutoBASE_PIS: TFMTBCDField;
    qrprodutoVL_PIS: TFMTBCDField;
    ...
    clientes_foto: TFDQuery;
    clientes_fotoCODIGO_CLIENTE: TIntegerField;
    clientes_fotoCAMINHO_FOTO: TStringField;
    QUERYTOTAL_GERAL: TFMTBCDField;
    qrvenda_mesSUM_0: TFMTBCDField;
    qrvenda_mesSUM: TFMTBCDField;
    qrvenda_mesSUM_1: TFMTBCDField;
    qrvenda_mesSUM_2: TFMTBCDField;
    qrvenda_mesSUM_3: TFMTBCDField;
    qrvenda_mesSUM_4: TFMTBCDField;
    qrvenda_mesSUM_5: TFMTBCDField;
    qrvenda_mesSUM_6: TFMTBCDField;
    qrvenda_mesSUM_7: TFMTBCDField;
    qrvenda_mesSUM_8: TFMTBCDField;
    qrvenda_mesSUM_9: TFMTBCDField;
    qrvenda_mesSUM_10: TFMTBCDField;
...
begin
  ...
  begin
    ...
    begin
      if (TAdvGlowButton(Components[i]).ModalResult = DefButton) then
      begin
...
if Portugues then
begin
  TAdvGlowButton(Mensagem.FindComponent('YES')).Caption := '&Física';
  TAdvGlowButton(Mensagem.FindComponent('NO')).Caption := '&Jurídica';
  TAdvGlowButton(Mensagem.FindComponent('CANCEL')).Caption := '&Cancelar';
  TAdvGlowButton(Mensagem.FindComponent('ABORT')).Caption := '&Abortar';
  TAdvGlowButton(Mensagem.FindComponent('RETRY')).Caption := '&Repetir';
  TAdvGlowButton(Mensagem.FindComponent('IGNORE')).Caption := '&Ignorar';
  TAdvGlowButton(Mensagem.FindComponent('ALL')).Caption := '&Todos';
  TAdvGlowButton(Mensagem.FindComponent('HELP')).Caption := 'A&juda';
  TAdvGlowButton(Mensagem.FindComponent('YES_P')).Caption := '&Entradas';
  TAdvGlowButton(Mensagem.FindComponent('NO_P')).Caption := '&Saidas';
end;
  ...
  begin
    ...
    begin
     ...
     { qrEmpresa:= TFDQuery.Create(nil);
      ...
      qrEmpresa.SQL.Add('SELECT CNPJ FROM EMPRESA WHERE CNPJ = ' + QuotedStr());
      qrEmpresa.Open;  }
...
begin
  Try
    if DM.SDS_Cli.State in [dsInsert, dsEdit] then
    begin
      DM.SDS_Cli.Cancel;
    end;
  // DM.SDS_Cli.edit;
...
//SetWindowPos(Handle,HWND_TOPMOST,0,0,0,0,SWP_NOMOVE+swp_nosize);
  ...
  DM.SDS_Cli.Active:= False;
  dm.SDS_Cli.SQL.Clear;
  DM.SDS_Cli.sql.add('select * from clientes where codigo ='+'0'+'order by NOME_RS ASC');
...
if FormConsClientes=nil   then
    begin
     ...
     DM.SDS_Cli.Active:= False;
     DM.SDS_Cli.sql.clear;
     DM.SDS_Cli.sql.add('select * from clientes where codigo ='+dm.SDS_ClientesCODIGO.Text+'order by NOME_RS ASC');
     DM.SDS_Cli.Active:= True;
...
//dm.Sds_cidades.locate('NOME',dbedit8.Text,[loCaseInsensitive]);
end;
...
TRY
  if FormConsBairros=nil   then
    begin
    FormConsbairros:=TFormConsBairros.Create(self);
     FormConsbairros.DBLookupComboBox1.Enabled :=false;
      FormConsBAIRROS.ShowModal;
      end;
      except
...
begin
 ...
 { frmwebcam2 := tfrmwebcam2.create(self);
  frmwebcam2.showmodal;   }
   ...
   Clientes_foto.Active := false;
   Clientes_foto.Active := true;
   with Clientes_foto do
    begin
      first;
      while not eof do
      begin
   ...
   Clientes_foto.insert;
   clientes_foto.Edit;
   clientes_fotoCODIGO_CLIENTE.Text := dbt_codigo.text;
   clientes_foto.Post;
   clientes_foto.ApplyUpdates(0) ;

  ExecAndWait('C:\StartNet_Sistemas\camera.exe', '', SW_SHOW);
  dm.SDS_CLI.edit;
  DBImage1.Picture.LoadFromFile(caminho_fotos_clientes+'\ft'+ dbt_codigo.text +'.BMP');
  dm.SDS_CLI.edit;
